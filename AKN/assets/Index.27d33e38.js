...
const As = "" + new URL("carousel_1.78859d4f.png", import.meta.url).href,
    ...
    Is = "" + new URL("carousel_14.8a66797f.png", import.meta.url).href,
    zs = "" + new URL("carousel_15.1e37810b.png", import.meta.url).href,
    ...
    Us = "" + new URL("carousel_4.91113d91.png", import.meta.url).href,
    js = "" + new URL("carousel_5.105ddefd.png", import.meta.url).href,
    qs = "" + new URL("carousel_6.74208897.png", import.meta.url).href,
...
const Ys = {
    ...
    Zs = {
        class: "media-main-pic"
    },
    Ks = {
        class: "media-current-info"
    },
    Js = {
        class: "media-info-wrapper"
    },
    Qs = {
        class: "media-info-detail",
        ref: "MediaInfoDetail",
        key: "3"
    },
    eo = {
        class: "media-detail-desc"
    },
    to = {
        class: "media-nav-wrapper"
    },
        ...
        setup(i, {
            ...
            for (let B = 0; B < r.length; B++) {
                let A = new URL(Object.assign({
                    ...
                    "../../assets/img/Five/carousel_14.png": Is,
                    "../../assets/img/Five/carousel_15.png": zs,
                    ...
                    "../../assets/img/Five/carousel_5.png": js,
                    "../../assets/img/Five/carousel_6.png": qs,
                    "../../assets/img/Five/carousel_7.png": Gs,
                    "../../assets/img/Five/carousel_8.png": Ws,
                    "../../assets/img/Five/carousel_9.png": Xs
                })[`../../assets/img/Five/carousel_${B+1}.png`], self.location).href;
                a.backgroundImage[B] = `url(${A})`
            }
            ...
            Be(() => {
                var B;
                l(), (B = T.value) == null || B.addEventListener("mousemove", G)
            });

            function u() {
                const B = t.value[0];
                let A = Math.floor(Number(getComputedStyle(B).width.replace("px", "")) + Number(getComputedStyle(B).paddingRight.replace("px", "")) * 2);
                for (let M = 0; M < r.length; M++) a.transform[M] = `translateX(${A*M}px)`, a.opacity[M] = 1, a.PointerEvent[M] = "auto", M > 3 && (a.transform[M] = `translateX(${A*3}px)`, a.opacity[M] = 0, a.PointerEvent[M] = "none")
            }
            let c = L(!0),
                d = L(0);
            const f = (B, A, M) => {
                    M.forEach(O => {
                        O.active = !1
                    }), A.active = !0, B > d.value && c.value ? (c.value = !1, v(B, "left")) : B < d.value && c.value && (c.value = !1, v(B, "right")), d.value = B
                },
                p = () => {
                    c.value && (c.value = !1, d.value > 0 ? d.value-- : d.value = r.length - 1, v(d.value, "left"), r.forEach(B => {
                        B.active = !1
                    }), r[d.value].active = !0)
                },
                h = () => {
                    c.value && (c.value = !1, d.value < r.length - 1 ? d.value++ : d.value = 0, v(d.value, "right"), r.forEach(B => {
                        B.active = !1
                    }), r[d.value].active = !0)
                },
                v = (B, A) => {
                    F(.45, A, B), b(A, .2, .45, B), E(B)
                };

            function y(B) {
                return new Promise(A => setTimeout(A, B))
            }
            const E = async B => {
                const A = t.value[0];
                let M = Math.floor(Number(getComputedStyle(A).width.replace("px", "")) + Number(getComputedStyle(A).paddingRight.replace("px", "")) * 2);
                for (let O = 0; O < r.length; O++) {
                    let W = M * O - M * (B - 1);
                    W <= -M ? (a.transform[O] = `translateX(${-M}px)`, a.opacity[O] = 0, a.PointerEvent[O] = "none") : W >= M * 4 ? (a.transform[O] = `translateX(${M*4}px)`, a.opacity[O] = 0, a.PointerEvent[O] = "none") : (a.transform[O] = `translateX(${M*O-M*(B-1)}px)`, a.opacity[O] = 1, a.PointerEvent[O] = "auto")
                }
                if (B === 0)
                    for (let O = 1; O < 2; O++) a.transform[r.length - O] = `translateX(${M*(O-1)}px)`, a.opacity[r.length - O] = 1, a.PointerEvent[r.length - O] = "auto";
                if (B === r.length - 3)
                    for (let O = 0; O < 2; O++) a.transform[O] = `translateX(${M*4}px)`, a.opacity[O] = 0, a.PointerEvent[O] = "none";
                if (B >= r.length - 2) {
                    let O = B % 3;
                    for (let W = 0; W < 2; W++) a.transform[W] = `translateX(${M*(4-O+W)}px)`, a.opacity[W] = 0, B === r.length - 2 && (a.opacity[0] = 1, a.PointerEvent[0] = "auto"), B === r.length - 1 && (a.opacity[W] = 1, a.PointerEvent[W] = "auto")
                }
            };
            let C = q({
                TextAnimate: [!0, !0, !0],
            ...
            const b = async (B, A, M, O) => {
                B == "left" ? C.TextDire = !0 : B == "right" && (C.TextDire = !1), C.TextAnimate[0] = !C.TextAnimate[0], await y(A * 100), C.TextAnimate[1] = !C.TextAnimate[1], await y(A * 300), C.TextAnimate[2] = !C.TextAnimate[2], await y(M * 1500), C.TextNum = O, await y(A * 100), C.TextAnimate[0] = !C.TextAnimate[0], await y(A * 300), C.TextAnimate[1] = !C.TextAnimate[1], await y(A * 500), C.TextAnimate[2] = !C.TextAnimate[2]
            };
            let x = q({
                    MediaImgStyle: {},
                    imgAnimate: !0
                ...
                S = L("");
            const F = async (B, A, M) => {
                x.imgAnimate = !x.imgAnimate, A == "left" ? (_.value = "left top", S.value = "right bottom") : A == "right" && (_.value = "right bottom", S.value = "left top"), x.MediaImgStyle = {
                    backgroundImage: a.backgroundImage[M]
                }, w.value = B + "s", await y(B * 1e3), c.value = !0
            }, T = L(), k = L(), D = L(), I = q({
                x: 0,
                y: 0
            }), V = q({
                ...
                I.x = B.clientX, I.y = B.clientY
            };
            return requestAnimationFrame(function B() {
                V.x += (I.x - V.x) / 10, V.y += (I.y - V.y) / 10;
                const O = V.x / window.innerWidth * 20 - 20 / 2,
                    W = V.y / window.innerHeight * 20 - 20 / 2;
                k.value.style.transform = `translate3d(${O}px,${W}px, 0) rotateX(${-W}deg) rotateY(${-O}deg)`, D.value.style.transform = `translate3d(${O*7.7}px,${W*3}px,50px) rotateX(${-W}deg) rotateY(${-O}deg)`, requestAnimationFrame(B)
            }), e({
                arrowBtnPrev: p,
                arrowBtnNext: h
            }), (B, A) => (P(), z("div", {
                ...
                ref: k
            }, [g("div", Ys, [g("div", Zs, [N(et, {
                name: "imgAnimate"
            }, {
                default: j(() => [m(x).imgAnimate ? (P(), z("div", {
                    class: "media-img1",
                    ref_key: "MediaImg1",
                    ref: s,
                    key: "1",
                    style: Oe(m(x).MediaImgStyle)
                }, null, 4)) : (P(), z("div", {
                    class: "media-img2",
                    ref_key: "MediaImg2",
                    ref: o,
                ...
                ref: D
            }, [g("div", Ks, [g("div", Js, [N(et, {
                name: "animate__animated animate__bounc animate__fast",
                "enter-active-class": m(C).TextDire ? "animate__fadeInRight" : "animate__fadeInLeft",
                "leave-active-class": m(C).TextDire ? "animate__fadeOutLeft" : "animate__fadeOutRight"
            }, {
                default: j(() => [fe(g("div", {
                    class: "media-info-serial",
                    ref: "MediaInfoSerial",
                    key: "1"
                }, Y(m(r)[m(C).TextNum].serial), 513), [
                    [he, m(C).TextAnimate[0]]
                ]), fe(g("div", {
                    class: "media-info-title",
                    ref: "MediaInfoTitle",
                    key: "2"
                }, Y(m(r)[m(C).TextNum].title), 513), [
                    [he, m(C).TextAnimate[1]]
                ]), fe(g("div", Qs, [g("div", eo, Y(m(r)[m(C).TextNum].desc), 1)], 512), [
                    [he, m(C).TextAnimate[2]]
                ])]),
                _: 1
            }, 8, ["enter-active-class", "leave-active-class"])]), g("div", to, [(P(!0), z(ce, null, we(m(r), (M, O) => (P(), z("div", {
                class: "media-nav-item",
                "data-index": O,
                onClick: W => f(O, M, m(r)),
                active: M.active,
                "data-cursor": "pointer"
            }, null, 8, io))), 256))])])], 512)]), g("div", no, [(P(!0), z(ce, null, we(m(r), (M, O) => (P(), z("div", {
                class: "media-list-item",
                "data-index": O,
                ref_for: !0,
                ref: m(n),
                style: Oe({
                    transform: m(a).transform[O],
                    opacity: m(a).opacity[O],
                    pointerEvents: m(a).PointerEvent[O]
                }),
                onClick: W => f(O, M, m(r))
            }, [g("div", {
                class: "media-list-item-img",
                style: Oe({
                    backgroundImage: m(a).backgroundImage[O]
                }),
                "data-title": M.title,
                "data-cursor": "pointer"
            }, null, 12, oo)], 12, so))), 256))])], 512)], 512))
        }
    });
const ao = Ce(ro, [
        ["__scopeId", "data-v-d5bbf8f8"]
    ]),
    lo = i => (je("data-v-1a707a3b"), i = i(), qe(), i),
    uo = lo(() => g("svg", {
        viewBox: "0 0 103 103",
...
const fn = Ce(fo, [
        ["__scopeId", "data-v-1a707a3b"]
    ]),
    ho = i => (je("data-v-9c3b3a5b"), i = i(), qe(), i),
    po = ho(() => g("svg", {
        viewBox: "0 0 103 103",
        xmlns: "http://www.w3.org/2000/svg",
        "xmlns:xlink": "http://www.w3.org/1999/xlink",
        ...
        setup(i, {
            ...
            class y {
                constructor(T, k, D, I) {
                    ...
                    Q(this, "color");
                    Q(this, "opacity");
                    this.x = Math.random() * c >> 0, this.y = Math.random() * d >> 0, this.totalX = T, this.totalY = k, this.time = D, this.r = 1.2, this.color = [...I], this.opacity = 0
                }
                draw() {
                    l.value.fillStyle = `rgba(${this.color.toString()})`, l.value.fillRect(this.x, this.y, this.r * 2, this.r * 2), l.value.fill()
                }
                update(T, k) {
                    if (this.mx = this.totalX - this.x, this.my = this.totalY - this.y, this.vx = this.mx / this.time, this.vy = this.my / this.time, T && k) {
                        let D = T - this.x,
                            I = k - this.y,
                            V = Math.sqrt(D ** 2 + I ** 2),
                            G = h / V;
                        G = G > 7 ? 7 : G;
                        let B = Math.atan2(I, D),
                            A = Math.cos(B),
                            M = Math.sin(B),
                            O = A * G * -v,
                            W = M * G * -v;
                    ...
                    this.x += this.vx, this.y += this.vy, this.opacity < 1 && (this.opacity += p)
                }
                change(T, k, D) {
                    this.totalX = T, this.totalY = k, this.color = [...D]
                }
            }
            class E {
                constructor(T, k) {
                    ...
                    Q(this, "name");
                    Q(this, "particleData");
                    this.src = T, this.name = k, this.particleData = [];
                    let D = new Image;
                    D.crossOrigin = "", D.src = T, D.onload = () => {
                        const I = document.createElement("canvas"),
                            V = I.getContext("2d"),
                            G = c,
                            B = ~~(c * (D.height / D.width));
                        I.width = G, I.height = B, V == null || V.drawImage(D, 0, 0, G, B);
                        const A = V == null ? void 0 : V.getImageData(0, 0, G, B).data;
                        ...
                        for (let M = 0; M < B; M += 5)
                            for (let O = 0; O < G; O += 5) {
                                const W = (O + M * G) * 4,
                                    ...
                                    ot = A[W + 3];
                                if (Ae + Ge + Me + ot >= 100) {
                                    const At = new y(O, M, f, [Ae, Ge, Me, ot]);
                                    this.particleData.push(At)
                                }
                            }
                        k === "rhodes" && w(u.value, this)
                    }
                }
            }
            class C {
                constructor(T) {
                    ...
                    Q(this, "mouseX");
                    Q(this, "mouseY");
                    this.canvasEle = T, this.ctx = T.getContext("2d"), this.width = T.width, this.height = T.height, this.ParticleArr = [], this.canvasEle.addEventListener("mousemove", k => {
                        const {
                            left: D,
                            top: I
                        ...
                        this.mouseX = V - D, this.mouseY = G - I
                ...
                changeImg(T) {
                    if (this.ParticleArr.length) {
                        ...
                        for (let B = 0; B < D; B++) {
                            ...
                            I[B] ? I[B].change(A, M, O) : I[B] = new y(A, M, f, O)
                        }
                        D < V && (this.ParticleArr = I.splice(0, D)), I = this.ParticleArr;
                        let G = I.length;
                        for (; G;) {
                            let B = ~~(Math.random() * G--),
                                A = I[B],
                            ...
                            A.totalX = I[G].totalX, A.totalY = I[G].totalY, A.color = I[G].color, I[G].totalX = M, I[G].totalY = O, I[G].color = W
                        }
                    } else this.ParticleArr = T.particleData.map(k => new y(k.totalX, k.totalY, f, k.color))
                }
                drawCanvas() {
            ...
            function w(F, T) {
                F.changeImg(T), x.value = F, t.ParticlesBoolean ? (clearInterval(b.value), b.value = setInterval(() => {
                    n.value++, F.changeImg(o[n.value]), n.value >= 3 && (n.value = -1)
                }, 5e3)) : F.changeImg(o[n.value]), r.value = T
            }
            for (let F of s) o.push(new E(F.url, F.label));
            const _ = F => {
                    x.value.changeImg(o[F])
                },
                S = () => {
                    x.value.ParticleArr = [], t.ParticlesBoolean && clearInterval(b.value)
                };
            return Be(async () => {
                a.value && (l.value = a.value.getContext("2d"), u.value = new C(a.value), u.value.drawCanvas())
            }), _e(() => t.logos, (F, T) => {
                for (let k of F) o.push(new E(k.url, k.label))
            }, {
                deep: !0
            }), Tt(() => {
...
const ci = Ce(wo, [
        ["__scopeId", "data-v-2fac201b"]
    ]),
    di = i => (je("data-v-9cfbcc6d"), i = i(), qe(), i),
    Eo = {
    ...
    Vo = ae({
        ...
        setup(i, {
            ...
            let a = +localStorage.getItem("ParticleId"),
                l = L(!0);
            const u = async () => {
                l.value && (l.value = !1, r.value = "StaffRight", o[0] = !1, await n(100), o[1] = !1, a == 0 ? a = s.length - 1 : a--, t.LiziChild.ChoiceImg(a), await n(1e3), o[0] = !0, await n(100), o[1] = !0, l.value = !0)
            }, c = async () => {
                l.value && (l.value = !1, r.value = "StaffBottom", o[0] = !1, await n(100), o[1] = !1, a == s.length - 1 ? a = 0 : a++, t.LiziChild.ChoiceImg(a), await n(1e3), o[0] = !0, await n(100), o[1] = !0, l.value = !0)
            };
            let d = q([!1, !1, !1, !1]);
            const f = async () => {
                d[3] = !0, await n(100), d[2] = !0, await n(100), d[1] = !0, await n(100), d[0] = !0
            }, p = async () => {
                d[3] = !1, await n(100), d[2] = !1, await n(100), d[1] = !1, await n(100), d[0] = !1
            };
            let h = L("KF_horizotal_show"),
                v = L("KF_vertical_show_2"),
                y = L("0.6s"),
                E = L(!1),
                C = L("storyInfoDis"),
                b = L(!1),
                ...
                S = L(!1);
            const F = async () => {
                localStorage.setItem("ListAppear", "true"), S.value && (E.value = !1, b.value = !1, x.value = !1, w.value = !1, h.value = "KF_horizotal_hide", v.value = "KF_vertical_hide", y.value = "0s", await n(500), C.value = "storyInfoHide", _.value = !1, await n(500), e("update:ListAppear", !0), await n(100), t.Top(), t.LiziChild.ChoiceImg(0))
            };
            return Be(async () => {
                e("update:ImgMove", "60%"), h.value = "KF_horizotal_show", v.value = "KF_vertical_show_2", await n(800), E.value = !0, y.value = "0.6s", C.value = "storyInfoDis", _.value = !0, await n(100), b.value = !0, x.value = !0, await n(400), w.value = !0, await n(500), S.value = !0
            }), (T, k) => {
                const D = fn,
                    I = hn;
                return P(), z("div", Eo, [xo, N(te, {
                    name: "Arrow"
                }, {
                    default: j(() => [m(_) ? (P(), Re(D, {
                        key: 0,
                        class: "leftBtn",
                        btnprev: u
                    })) : X("", !0)]),
                    _: 1
                }), g("div", Fo, [g("div", So, [To, Bo, N(te, {
                    name: "CloseBtn"
                }, {
                    default: j(() => [m(E) ? (P(), z("div", {
                        key: 0,
                        class: "storyCloseBtn",
                        onMousemove: f,
                        onMouseleave: p,
                        ...
                        class: le(m(d)[0] ? "usehover" : ""),
                        "xlink:href": "#close-br",
                        "data-cursor": "pointer"
                    }, null, 2), g("use", {
                        class: le(m(d)[1] ? "usehover" : ""),
                        "xlink:href": "#close-tr",
                        "data-cursor": "pointer"
                    }, null, 2), g("use", {
                        class: le(m(d)[2] ? "usehover" : ""),
                        "xlink:href": "#close-bl",
                        "data-cursor": "pointer"
                    }, null, 2), g("use", {
                        class: le(m(d)[3] ? "usehover" : ""),
                        "xlink:href": "#close-tl",
                        "data-cursor": "pointer"
                    }, null, 2)]))], 32)) : X("", !0)]),
                    _: 1
                    ...
                    default: j(() => [g("div", Do, [N(te, {
                        name: m(r)
                    }, {
                        default: j(() => [m(o)[0] ? (P(), z("div", Ao, [N(te, {
                            name: "InfoName"
                        }, {
                            default: j(() => [m(b) ? (P(), z("div", Mo, [g("div", Po, [(P(), z("svg", Oo, [g("text", Lo, Y(m(s)[m(a)].name), 1)]))])])) : X("", !0)]),
                            _: 1
                        }), N(te, {
                            name: "InfoNameEN"
                        }, {
                            default: j(() => [m(x) ? (P(), z("div", Io, [(P(), z("svg", zo, [g("text", Ro, Y(m(s)[0].en), 1)]))])) : X("", !0)]),
                            _: 1
                        })])) : X("", !0)]),
                        _: 1
                    }, 8, ["name"]), g("div", $o, [N(te, {
                        ...
                        default: j(() => [m(o)[1] ? (P(), z("div", No, [N(te, {
                            name: "DescHide"
                        }, {
                            default: j(() => [m(w) ? (P(), z("div", Ho, Y(m(s)[m(a)].desc), 1)) : X("", !0)]),
                            _: 1
                        })])) : X("", !0)]),
                        _: 1
                    }, 8, ["name"])])])]),
...
const Uo = Ce(Vo, [
        ["__scopeId", "data-v-9cfbcc6d"]
    ]),
    jo = "" + new URL("https://pic3.zhimg.com/80/v2-4947430e910af6440d6edbdd19874752_720w.webp", import.meta.url).href,
    qo = "" + new URL("https://pic1.zhimg.com/80/v2-1b953078f2e7ca3994328fb7a4fd9670_720w.webp", import.meta.url).href,
    ...
    tt = (i, e, t) => (e.length = 0, t ? [] : (i.forEach(n => {
        let s = new URL(Object.assign({
            "../assets/img/Two/lizi/logo_rhine.png": Zo,
            "../assets/img/Two/lizi/logo_rhodes.png": Ko,
            "../assets/img/Two/lizi/logo_yan.png": Jo
        })[`../assets/img/Two/lizi/logo_${n.label}.png`], self.location).href;
        n.label == "penguin" ? n.url = new URL(Object.assign({
            "../assets/img/Two/lizi/logo_penguin.webp": Qo
        })[`../assets/img/Two/lizi/logo_${n.label}.webp`], self.location).href : n.url = s
    }), i)),
    kt = Cs("Off", {
        state: () => ({
            TwoParticlesLogo: !0,
    ...
    ur = ae({
        ...
        setup(i) {
            ...
            let n = q([{
                ...
                s = q([]);
            s.push(...tt(n, s, e.FourParticlesLogo)), _e(() => e.FourParticlesLogo, (C, b) => {
                s.push(...tt(n, s, C)), e.FourParticlesLogo && r.value.clearCanvas()
            });
            const o = L("10%"),
                r = L(),
                a = q([{
            ...
            for (let C = 0; C < a.length; C++) {
                let b = new URL(Object.assign({
                    "../../assets/img/Four/list_1.png": jo,
                    "../../assets/img/Four/list_2.png": qo,
                    "../../assets/img/Four/list_3.png": Go,
                    "../../assets/img/Four/list_4.png": Wo,
                    "../../assets/img/Four/list_5.png": Xo,
                    "../../assets/img/Four/list_6.png": Yo
                })[`../../assets/img/Four/list_${C+1}.png`], self.location).href;
                a[C].imgURL = b
            }
            const l = L([]);
            let u = 50;
            const c = (C, b, x) => {
                    ...
                    window.requestAnimationFrame(() => {
                        l.value[b].style.left = w + "px", l.value[b].style.top = _ + "px", l.value[b].style.transform = `translate(-50%,-${u}%)`
                    })
                },
                d = C => {
                    C.forEach(b => {
                ...
                p = async C => {
                    f.throttle && (y(!1), localStorage.setItem("ListAppear", "false"), localStorage.setItem("ParticleId", C.toString())), r.value.ChoiceImg(C)
                }, h = L([]), v = () => {
                    let C = L(0);
                    h.value.forEach(b => {
                    ...
                    let b = setInterval(() => {
                        f.ListHide[f.num] = C, f.num++, f.num > a.length - 1 && (clearInterval(b), f.num = 0, setTimeout(() => {
                            f.ListAppear = C, f.throttle = !0
                        }, 500))
                    }, 100)
                }, E = () => {
                    localStorage.setItem("ListAppear", "true"), f.ListAppear = localStorage.getItem("ListAppear") == "true", f.ListAppear && v()
                };
            return Be(() => {
                E()
            }), (C, b) => {
                const x = Uo,
                    w = ci;
                return P(), z(ce, null, [m(f).ListAppear ? (P(), z("div", er, [g("ol", tr, [N(et, {
                    name: "storyitem",
                    appear: ""
                }, {
                    default: j(() => [(P(!0), z(ce, null, we(m(a), _ => fe((P(), z("li", {
                        key: _.id,
                        class: "storyItem",
                        ref_for: !0,
                        ref_key: "StoryLi",
                        ref: h,
                        onMousemove: S => c(S, _.id, m(a)),
                        onMouseout: b[0] || (b[0] = S => d(m(a))),
                        onClick: S => p(_.id)
                    }, [g("span", nr, Y(_.name), 1), g("span", sr, Y(_.en), 1), (P(), z("svg", or, [g("text", rr, Y(_.en), 1)])), g("div", {
                        ref_for: !0,
                        ref_key: "ImgDiv",
                        ref: l,
                        class: "imgdiv"
                        ...
                        key: 0,
                        src: _.imgURL
                    }, null, 8, ar)) : X("", !0)], 512)], 40, ir)), [
                        [he, m(f).ListHide[_.id]]
                    ])), 128))]),
                    _: 1
                })])])) : (P(), Re(x, {
                    key: 1,
                    ListAppear: m(f).ListAppear,
                    "onUpdate:ListAppear": b[1] || (b[1] = _ => m(f).ListAppear = _),
                    ImgMove: m(o),
                    "onUpdate:ImgMove": b[2] || (b[2] = _ => ys(o) ? o.value = _ : null),
                    Top: v,
                    Rights: m(f).Rights,
                    LiziChild: m(r)
                }, null, 8, ["ListAppear", "ImgMove", "Rights", "LiziChild"])), g("div", lr, [N(w, {
                    canvasRect: m(t),
                    logos: m(s),
                    ref_key: "LiziChild",
                    ref: r
                }, null, 8, ["canvasRect", "logos"])])], 64)
            }
        }
    });
const cr = Ce(ur, [
    ...
    vr = "" + new URL("https://pic2.zhimg.com/80/v2-c5f7f03b9a3ee839639923383ebd5a59_720w.webp", import.meta.url).href,
    mr = "" + new URL("https://pic4.zhimg.com/80/v2-e568f8e45850a81a73955ae5c8b7d9e3_720w.webp", import.meta.url).href,
    gr = "" + new URL("https://pic2.zhimg.com/80/v2-29776cb05e3de56622fbb48529abc2a1_720w.webp", import.meta.url).href,
    Cr = "" + new URL("https://pic2.zhimg.com/80/v2-e1840e58c4dc017f27948e72d64d10dd_720w.webp", import.meta.url).href,
    yr = "" + new URL("https://pic2.zhimg.com/80/v2-8394d938cb8961f950241117bcca470d_720w.webp", import.meta.url).href,
    br = "" + new URL("https://pic4.zhimg.com/80/v2-ab0faf345980f569604c17ec68b68f47_720w.webp", import.meta.url).href,
    _r = "" + new URL("https://pic1.zhimg.com/80/v2-19657ca9d0d9c48a56b1a7b89ef1802c_720w.webp", import.meta.url).href,
    wr = "" + new URL("https://pic3.zhimg.com/80/v2-0517c3306fa3e634a1a4e3df1dbd2972_720w.webp", import.meta.url).href,
    Er = "" + new URL("https://free-img.400040.xyz/4/2024/08/07/66b3740e26f4b.webp", import.meta.url).href;
...
function fi(i = {}, e = {}) {
    Object.keys(e).forEach(t => {
        typeof i[t] > "u" ? i[t] = e[t] : Si(e[t]) && Si(i[t]) && Object.keys(e[t]).length > 0 && fi(i[t], e[t])
    })
}
const pn = {
    body: {},
...
class He extends Array {
    constructor(e) {
        typeof e == "number" ? super(e) : (super(...e || []), Fr(this))
    }
}
...
function $(i, e) {
    const t = re(),
        n = ye();
    let s = [];
    if (!e && i instanceof He) return i;
    if (!i) return new He(s);
    if (typeof i == "string") {
        const o = i.trim();
        if (o.indexOf("<") >= 0 && o.indexOf(">") >= 0) {
            let r = "div";
            o.indexOf("<li") === 0 && (r = "ul"), o.indexOf("<tr") === 0 && (r = "tbody"), (o.indexOf("<td") === 0 || o.indexOf("<th") === 0) && (r = "tr"), o.indexOf("<tbody") === 0 && (r = "table"), o.indexOf("<option") === 0 && (r = "select");
            const a = n.createElement(r);
            a.innerHTML = o;
            for (let l = 0; l < a.childNodes.length; l += 1) s.push(a.childNodes[l])
        } else s = Tr(i.trim(), e || n)
...
function Ar(...i) {
    const e = pt(i.map(t => t.split(" ")));
    return vn(this, t => e.filter(n => t.classList.contains(n)).length > 0).length > 0
}
...
function Mr(i, e) {
    ...
    for (let t = 0; t < this.length; t += 1)
        if (arguments.length === 2) this[t].setAttribute(i, e);
            ...
            for (const n in i) this[t][n] = i[n], this[t].setAttribute(n, i[n]);
    return this
}
        ...
        for (let l = 0; l < this.length; l += 1) {
            ...
            if (!t && u.dom7Listeners ? c = u.dom7Listeners[a] : t && u.dom7LiveListeners && (c = u.dom7LiveListeners[a]), c && c.length)
                for (let d = c.length - 1; d >= 0; d -= 1) {
                    const f = c[d];
                    n && f.listener === n || n && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === n ? (u.removeEventListener(a, f.proxyListener, s), c.splice(d, 1)) : n || (u.removeEventListener(a, f.proxyListener, s), c.splice(d, 1))
                }
        }
    }
    return this
    ...
    for (let s = 0; s < t.length; s += 1) {
        ...
        for (let r = 0; r < this.length; r += 1) {
            ...
            if (e.CustomEvent) {
                ...
                a.dom7EventData = i.filter((u, c) => c > 0), a.dispatchEvent(l), a.dom7EventData = [], delete a.dom7EventData
            }
        }
    }
    return this
...
function Yr(i) {
    ...
    if (typeof i == "string") {
        ...
        for (s = $(i), o = 0; o < s.length; o += 1)
            if (s[o] === n) return !0;
        return !1
    }
    if (i === t) return n === t;
    if (i === e) return n === e;
    if (i.nodeType || i instanceof He) {
...
function Zr() {
    ...
    if (i) {
        for (e = 0;
            (i = i.previousSibling) !== null;) i.nodeType === 1 && (e += 1);
        return e
    }
}
...
function Qr(i) {
    ...
    for (t = 0; t < this.length; t += 1)
        if (typeof i == "string") {
            ...
            for (s.innerHTML = i, n = s.childNodes.length - 1; n >= 0; n -= 1) this[t].insertBefore(s.childNodes[n], this[t].childNodes[0])
        } else if (i instanceof He)
        for (n = 0; n < i.length; n += 1) this[t].insertBefore(i[n], this[t].childNodes[0]);
    else this[t].insertBefore(i, this[t].childNodes[0]);
    return this
}

function ea(i) {
    return this.length > 0 ? i ? this[0].nextElementSibling && $(this[0].nextElementSibling).is(i) ? $([this[0].nextElementSibling]) : $([]) : this[0].nextElementSibling ? $([this[0].nextElementSibling]) : $([]) : $([])
}
...
function ia(i) {
    if (this.length > 0) {
        const e = this[0];
        return i ? e.previousElementSibling && $(e.previousElementSibling).is(i) ? $([e.previousElementSibling]) : $([]) : e.previousElementSibling ? $([e.previousElementSibling]) : $([])
    }
    return $([])
}
...
function sa(i) {
    const e = [];
    for (let t = 0; t < this.length; t += 1) this[t].parentNode !== null && (i ? $(this[t].parentNode).is(i) && e.push(this[t].parentNode) : e.push(this[t].parentNode));
    return $(e)
}
...
function fa(i, e = "x") {
    ...
    let n, s, o;
    const r = da(i);
    return t.WebKitCSSMatrix ? (s = r.transform || r.webkitTransform, s.split(",").length > 6 && (s = s.split(", ").map(a => a.replace(",", ".")).join(", ")), o = new t.WebKitCSSMatrix(s === "none" ? "" : s)) : (o = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), n = o.toString().split(",")), e === "x" && (t.WebKitCSSMatrix ? s = o.m41 : n.length === 16 ? s = parseFloat(n[12]) : s = parseFloat(n[4])), e === "y" && (t.WebKitCSSMatrix ? s = o.m42 : n.length === 16 ? s = parseFloat(n[13]) : s = parseFloat(n[5])), s || 0
}
    ...
    for (let n = 1; n < i.length; n += 1) {
        ...
        if (s != null && !ha(s)) {
            ...
            for (let r = 0, a = o.length; r < a; r += 1) {
                ...
                u !== void 0 && u.enumerable && (Ct(e[l]) && Ct(s[l]) ? s[l].__swiper__ ? e[l] = s[l] : ge(e[l], s[l]) : !Ct(e[l]) && Ct(s[l]) ? (e[l] = {}, s[l].__swiper__ ? e[l] = s[l] : ge(e[l], s[l])) : e[l] = s[l])
            }
        }
    }
    return e
...
function mn({
    ...
    const l = e > s ? "next" : "prev",
        ...
        c = () => {
            ...
            let p = s + f * (e - s);
            if (u(p, e) && (p = e), i.wrapperEl.scrollTo({
                    [t]: p
                }), u(p, e)) {
...
function va({
    ...
    return !u && p && e.touch && h.indexOf(`${r}x${a}`) >= 0 && (u = s.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), p = !1), l && !f && (o.os = "android", o.android = !0), (u || d || c) && (o.os = "ios", o.ios = !0), o
}

function ma(i = {}) {
    return Ot || (Ot = va(i)), Ot
}
let Lt;
...
function ya({
    ...
    const o = () => {
        ...
        r = () => {
            !i || i.destroyed || !i.initialized || (s = new ResizeObserver(u => {
                const {
                    width: c,
                    height: d
                } = i;
                ...
                u.forEach(({
                    ...
                    y && y !== i.el || (f = v ? v.width : (h[0] || h).inlineSize, p = v ? v.height : (h[0] || h).blockSize)
                }), (f !== c || p !== d) && o()
            }), s.observe(i.el))
        },
        a = () => {
    ...
    e("init", () => {
        ...
        a(), n.removeEventListener("resize", o), n.removeEventListener("orientationchange", l)
    })
}
...
const _a = {
    on(i, e, t) {
        ...
        return i.split(" ").forEach(o => {
            n.eventsListeners[o] || (n.eventsListeners[o] = []), n.eventsListeners[o][s](e)
        }), n
    },
    once(i, e, t) {
        const n = this;
    ...
    off(i, e) {
        const t = this;
        return t.eventsListeners && i.split(" ").forEach(n => {
            typeof e > "u" ? t.eventsListeners[n] = [] : t.eventsListeners[n] && t.eventsListeners[n].forEach((s, o) => {
                (s === e || s.__emitterProxy && s.__emitterProxy === e) && t.eventsListeners[n].splice(o, 1)
            })
        }), t
    },
    emit(...i) {
        ...
        let t, n, s;
        return typeof i[0] == "string" || Array.isArray(i[0]) ? (t = i[0], n = i.slice(1, i.length), s = e) : (t = i[0].events, n = i[0].data, s = i[0].context || e), n.unshift(s), (Array.isArray(t) ? t : t.split(" ")).forEach(r => {
            e.eventsAnyListeners && e.eventsAnyListeners.length && e.eventsAnyListeners.forEach(a => {
                a.apply(s, [r, ...n])
            }), e.eventsListeners && e.eventsListeners[r] && e.eventsListeners[r].forEach(a => {
                a.apply(s, n)
            })
        }), e
    }
...
function Ea() {
    ...
    function t(k, D) {
        return parseFloat(k.getPropertyValue(e(D)) || 0)
    }
    const n = i.params,
        {
            $wrapperEl: s,
    ...
    typeof v == "function" && (v = n.slidesOffsetBefore.call(i));
    ...
    typeof b == "string" && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * o), i.virtualSize = -b, r ? c.css({
        marginLeft: "",
        marginBottom: "",
        marginTop: ""
    }) : c.css({
        ...
        marginBottom: "",
        marginTop: ""
    }), n.centeredSlides && n.cssMode && (yt(i.wrapperEl, "--swiper-centered-offset-before", ""), yt(i.wrapperEl, "--swiper-centered-offset-after", ""));
    const S = n.grid && n.grid.rows > 1 && i.grid;
    S && i.grid.initSlides(d);
    let F;
    const T = n.slidesPerView === "auto" && n.breakpoints && Object.keys(n.breakpoints).filter(k => typeof n.breakpoints[k].slidesPerView < "u").length > 0;
    for (let k = 0; k < d; k += 1) {
        F = 0;
        const D = c.eq(k);
        if (S && i.grid.updateSlide(k, D, d, e), D.css("display") !== "none") {
            if (n.slidesPerView === "auto") {
                T && (c[k].style[e("width")] = "");
                const I = getComputedStyle(D[0]),
                    V = D[0].style.transform,
                    G = D[0].style.webkitTransform;
                if (V && (D[0].style.transform = "none"), G && (D[0].style.webkitTransform = "none"), n.roundLengths) F = i.isHorizontal() ? D.outerWidth(!0) : D.outerHeight(!0);
                else {
                    const B = t(I, "width"),
                        A = t(I, "padding-left"),
                        M = t(I, "padding-right"),
                        O = t(I, "margin-left"),
                        W = t(I, "margin-right"),
                        Ae = I.getPropertyValue("box-sizing");
                    if (Ae && Ae === "border-box") F = B + O + W;
                    else {
                        const {
                            clientWidth: Ge,
                            offsetWidth: Me
                ...
                V && (D[0].style.transform = V), G && (D[0].style.webkitTransform = G), n.roundLengths && (F = Math.floor(F))
            } else F = (o - (n.slidesPerView - 1) * b) / n.slidesPerView, n.roundLengths && (F = Math.floor(F)), c[k] && (c[k].style[e("width")] = `${F}px`);
            c[k] && (c[k].swiperSlideSize = F), h.push(F), n.centeredSlides ? (x = x + F / 2 + w / 2 + b, w === 0 && k !== 0 && (x = x - o / 2 - b), k === 0 && (x = x - o / 2 - b), Math.abs(x) < 1 / 1e3 && (x = 0), n.roundLengths && (x = Math.floor(x)), _ % n.slidesPerGroup === 0 && f.push(x), p.push(x)) : (n.roundLengths && (x = Math.floor(x)), (_ - Math.min(i.params.slidesPerGroupSkip, _)) % i.params.slidesPerGroup === 0 && f.push(x), p.push(x), x = x + F + b), i.virtualSize += F + b, w = F, _ += 1
        }
    }
    if (i.virtualSize = Math.max(i.virtualSize, o) + y, r && a && (n.effect === "slide" || n.effect === "coverflow") && s.css({
            width: `${i.virtualSize+n.spaceBetween}px`
        }), n.setWrapperSize && s.css({
            [e("width")]: `${i.virtualSize+n.spaceBetween}px`
        }), S && i.grid.updateWrapperSize(F, f, e), !n.centeredSlides) {
        const k = [];
        for (let D = 0; D < f.length; D += 1) {
            let I = f[D];
            n.roundLengths && (I = Math.floor(I)), f[D] <= i.virtualSize - o && k.push(I)
        }
        f = k, Math.floor(i.virtualSize - o) - Math.floor(f[f.length - 1]) > 1 && f.push(i.virtualSize - o)
    }
    if (f.length === 0 && (f = [0]), n.spaceBetween !== 0) {
        const k = i.isHorizontal() && r ? "marginLeft" : e("marginRight");
        c.filter((D, I) => n.cssMode ? I !== c.length - 1 : !0).css({
            [k]: `${b}px`
        })
    }
    if (n.centeredSlides && n.centeredSlidesBounds) {
        let k = 0;
        h.forEach(I => {
            k += I + (n.spaceBetween ? n.spaceBetween : 0)
        }), k -= n.spaceBetween;
        const D = k - o;
        f = f.map(I => I < 0 ? -v : I > D ? D + y : I)
    }
    if (n.centerInsufficientSlides) {
        let k = 0;
        if (h.forEach(D => {
                k += D + (n.spaceBetween ? n.spaceBetween : 0)
            }), k -= n.spaceBetween, k < o) {
            const D = (o - k) / 2;
            f.forEach((I, V) => {
                f[V] = I - D
            }), p.forEach((I, V) => {
    ...
    if (Object.assign(i, {
        ...
        yt(i.wrapperEl, "--swiper-centered-offset-before", `${-f[0]}px`), yt(i.wrapperEl, "--swiper-centered-offset-after", `${i.size/2-h[h.length-1]/2}px`);
        const k = -i.snapGrid[0],
            D = -i.slidesGrid[0];
        i.snapGrid = i.snapGrid.map(I => I + k), i.slidesGrid = i.slidesGrid.map(I => I + D)
    }
    d !== u && i.emit("slidesLengthChange"), f.length !== E && (i.params.watchOverflow && i.checkOverflow(), i.emit("snapGridLengthChange")), p.length !== C && i.emit("slidesGridLengthChange"), n.watchSlidesProgress && i.updateSlidesOffset()
}
...
function xa(i) {
    ...
    const r = a => n ? e.slides.filter(l => parseInt(l.getAttribute("data-swiper-slide-index"), 10) === a)[0] : e.slides.eq(a)[0];
    if (e.params.slidesPerView !== "auto" && e.params.slidesPerView > 1)
        if (e.params.centeredSlides) e.visibleSlides.each(a => {
            t.push(a)
        });
        else
...
function Fa() {
    const i = this,
        e = i.slides;
    for (let t = 0; t < e.length; t += 1) e[t].swiperSlideOffset = i.isHorizontal() ? e[t].offsetLeft : e[t].offsetTop
}

function Sa(i = this && this.translate || 0) {
    const e = this,
        t = e.params,
        {
            slides: n,
    ...
    let r = -i;
    s && (r = i), n.removeClass(t.slideVisibleClass), e.visibleSlidesIndexes = [], e.visibleSlides = [];
    for (let a = 0; a < n.length; a += 1) {
        const l = n[a];
        let u = l.swiperSlideOffset;
        t.cssMode && t.centeredSlides && (u -= n[0].swiperSlideOffset);
        const c = (r + (t.centeredSlides ? e.minTranslate() : 0) - u) / (l.swiperSlideSize + t.spaceBetween),
            d = (r - o[0] + (t.centeredSlides ? e.minTranslate() : 0) - u) / (l.swiperSlideSize + t.spaceBetween),
            f = -(r - u),
            p = f + e.slidesSizesGrid[a];
        (f >= 0 && f < e.size - 1 || p > 1 && p <= e.size || f <= 0 && p >= e.size) && (e.visibleSlides.push(l), e.visibleSlidesIndexes.push(a), n.eq(a).addClass(t.slideVisibleClass)), l.progress = s ? -c : c, l.originalProgress = s ? -d : d
    }
...
function Ta(i) {
    ...
    const a = o,
        l = r;
    n === 0 ? (s = 0, o = !0, r = !0) : (s = (i - e.minTranslate()) / n, o = s <= 0, r = s >= 1), Object.assign(e, {
        progress: s,
        isBeginning: o,
        isEnd: r
    }), (t.watchSlidesProgress || t.centeredSlides && t.autoHeight) && e.updateSlidesProgress(i), o && !a && e.emit("reachBeginning toEdge"), r && !l && e.emit("reachEnd toEdge"), (a && !o || l && !r) && e.emit("fromEdge"), e.emit("progress", s)
}
...
function Ba() {
    ...
    let a;
    r ? a = i.$wrapperEl.find(`.${t.slideClass}[data-swiper-slide-index="${s}"]`) : a = e.eq(s), a.addClass(t.slideActiveClass), t.loop && (a.hasClass(t.slideDuplicateClass) ? n.children(`.${t.slideClass}:not(.${t.slideDuplicateClass})[data-swiper-slide-index="${o}"]`).addClass(t.slideDuplicateActiveClass) : n.children(`.${t.slideClass}.${t.slideDuplicateClass}[data-swiper-slide-index="${o}"]`).addClass(t.slideDuplicateActiveClass));
...
function ka(i) {
    ...
    let u = i,
        c;
    if (typeof u > "u") {
        for (let f = 0; f < n.length; f += 1) typeof n[f + 1] < "u" ? t >= n[f] && t < n[f + 1] - (n[f + 1] - n[f]) / 2 ? u = f : t >= n[f] && t < n[f + 1] && (u = f + 1) : t >= n[f] && (u = f);
...
function Da(i) {
    ...
    if (n && s) e.clickedSlide = n, e.virtual && e.params.virtual.enabled ? e.clickedIndex = parseInt($(n).attr("data-swiper-slide-index"), 10) : e.clickedIndex = o;
    else {
...
const Aa = {
    ...
    updateSlides: Ea,
    updateAutoHeight: xa,
    updateSlidesOffset: Fa,
    updateSlidesProgress: Sa,
    updateProgress: Ta,
    updateSlidesClasses: Ba,
    updateActiveIndex: ka,
    updateClickedSlide: Da
};

function Ma(i = this.isHorizontal() ? "x" : "y") {
    const e = this,
        {
            params: t,
            rtlTranslate: n,
...
function Pa(i, e) {
    ...
    let l = 0,
        u = 0;
    const c = 0;
    t.isHorizontal() ? l = n ? -i : i : u = i, s.roundLengths && (l = Math.floor(l), u = Math.floor(u)), s.cssMode ? r[t.isHorizontal() ? "scrollLeft" : "scrollTop"] = t.isHorizontal() ? -l : -u : s.virtualTranslate || o.transform(`translate3d(${l}px, ${u}px, ${c}px)`), t.previousTranslate = t.translate, t.translate = t.isHorizontal() ? l : u;
    let d;
    const f = t.maxTranslate() - t.minTranslate();
    f === 0 ? d = 0 : d = (i - t.minTranslate()) / f, d !== a && t.updateProgress(i), t.emit("setTranslate", t.translate, e)
}
...
function Ia(i = 0, e = this.params.speed, t = !0, n = !0, s) {
    const o = this,
        {
            params: r,
            wrapperEl: a
    ...
    const l = o.minTranslate(),
        u = o.maxTranslate();
    let c;
    if (n && i > l ? c = l : n && i < u ? c = u : c = i, o.updateProgress(c), r.cssMode) {
        const d = o.isHorizontal();
        if (e === 0) a[d ? "scrollLeft" : "scrollTop"] = -c;
        else {
            if (!o.support.smoothScroll) return mn({
                swiper: o,
                targetPosition: -c,
                side: d ? "left" : "top"
            }), !0;
    ...
    return e === 0 ? (o.setTransition(0), o.setTranslate(c), t && (o.emit("beforeTransitionStart", e, s), o.emit("transitionEnd"))) : (o.setTransition(e), o.setTranslate(c), t && (o.emit("beforeTransitionStart", e, s), o.emit("transitionStart")), o.animating || (o.animating = !0, o.onTranslateToWrapperTransitionEnd || (o.onTranslateToWrapperTransitionEnd = function(f) {
        !o || o.destroyed || f.target === this && (o.$wrapperEl[0].removeEventListener("transitionend", o.onTranslateToWrapperTransitionEnd), o.$wrapperEl[0].removeEventListener("webkitTransitionEnd", o.onTranslateToWrapperTransitionEnd), o.onTranslateToWrapperTransitionEnd = null, delete o.onTranslateToWrapperTransitionEnd, t && o.emit("transitionEnd"))
...
function Cn({
    ...
    let r = t;
    if (r || (s > o ? r = "next" : s < o ? r = "prev" : r = "reset"), i.emit(`transition${n}`), e && s !== o) {
        if (r === "reset") {
            i.emit(`slideResetTransition${n}`);
            return
        }
        i.emit(`slideChangeTransition${n}`), r === "next" ? i.emit(`slideNextTransition${n}`) : i.emit(`slidePrevTransition${n}`)
    }
}
...
function $a(i = !0, e) {
    ...
    n.cssMode || (n.autoHeight && t.updateAutoHeight(), Cn({
        swiper: t,
        runCallbacks: i,
        direction: e,
        step: "Start"
...
function Na(i = !0, e) {
    ...
    t.animating = !1, !n.cssMode && (t.setTransition(0), Cn({
        swiper: t,
        runCallbacks: i,
        direction: e,
        step: "End"
...
function Va(i = 0, e = this.params.speed, t = !0, n, s) {
    if (typeof i != "number" && typeof i != "string") throw new Error(`The 'index' argument cannot have type other than 'number' or 'string'. [${typeof i}] given.`);
    if (typeof i == "string") {
        const b = parseInt(i, 10);
        if (!isFinite(b)) throw new Error(`The passed-in 'index' (string) couldn't be converted to 'number'. [${i}] given.`);
        i = b
    }
    const o = this;
    let r = i;
    ...
    if (o.animating && a.preventInteractionOnTransition || !h && !n && !s) return !1;
    const v = Math.min(o.params.slidesPerGroupSkip, r);
    let y = v + Math.floor((r - v) / o.params.slidesPerGroup);
    y >= l.length && (y = l.length - 1), (d || a.initialSlide || 0) === (c || 0) && t && o.emit("beforeSlideChangeStart");
    const E = -l[y];
    if (o.updateProgress(E), a.normalizeSlideIndex)
        for (let b = 0; b < u.length; b += 1) {
            const x = -Math.floor(E * 100),
                w = Math.floor(u[b] * 100),
                _ = Math.floor(u[b + 1] * 100);
            typeof u[b + 1] < "u" ? x >= w && x < _ - (_ - w) / 2 ? r = b : x >= w && x < _ && (r = b + 1) : x >= w && (r = b)
        }
    if (o.initialized && r !== d && (!o.allowSlideNext && E < o.translate && E < o.minTranslate() || !o.allowSlidePrev && E > o.translate && E > o.maxTranslate() && (d || 0) !== r)) return !1;
    let C;
    if (r > d ? C = "next" : r < d ? C = "prev" : C = "reset", f && -E === o.translate || !f && E === o.translate) return o.updateActiveIndex(r), a.autoHeight && o.updateAutoHeight(), o.updateSlidesClasses(), a.effect !== "slide" && o.setTranslate(E), C !== "reset" && (o.transitionStart(t, C), o.transitionEnd(t, C)), !1;
    if (a.cssMode) {
        const b = o.isHorizontal(),
            x = f ? E : -E;
        if (e === 0) {
            const w = o.virtual && o.params.virtual.enabled;
            w && (o.wrapperEl.style.scrollSnapType = "none", o._immediateVirtual = !0), p[b ? "scrollLeft" : "scrollTop"] = x, w && requestAnimationFrame(() => {
    ...
    return o.setTransition(e), o.setTranslate(E), o.updateActiveIndex(r), o.updateSlidesClasses(), o.emit("beforeTransitionStart", e, n), o.transitionStart(t, C), e === 0 ? o.transitionEnd(t, C) : o.animating || (o.animating = !0, o.onSlideToWrapperTransitionEnd || (o.onSlideToWrapperTransitionEnd = function(x) {
        !o || o.destroyed || x.target === this && (o.$wrapperEl[0].removeEventListener("transitionend", o.onSlideToWrapperTransitionEnd), o.$wrapperEl[0].removeEventListener("webkitTransitionEnd", o.onSlideToWrapperTransitionEnd), o.onSlideToWrapperTransitionEnd = null, delete o.onSlideToWrapperTransitionEnd, o.transitionEnd(t, C))
    }), o.$wrapperEl[0].addEventListener("transitionend", o.onSlideToWrapperTransitionEnd), o.$wrapperEl[0].addEventListener("webkitTransitionEnd", o.onSlideToWrapperTransitionEnd)), !0
}

function Ua(i = 0, e = this.params.speed, t = !0, n) {
    const s = this;
    let o = i;
    return s.params.loop && (o += s.loopedSlides), s.slideTo(o, e, t, n)
}

function ja(i = this.params.speed, e = !0, t) {
    const n = this,
        {
            animating: s,
            enabled: o,
    ...
    return r.rewind && n.isEnd ? n.slideTo(0, i, e, t) : n.slideTo(n.activeIndex + l, i, e, t)
}

function qa(i = this.params.speed, e = !0, t) {
    const n = this,
        {
            params: s,
            animating: o,
    ...
    let v = 0;
    return typeof h < "u" && (v = a.indexOf(h), v < 0 && (v = n.activeIndex - 1), s.slidesPerView === "auto" && s.slidesPerGroup === 1 && s.slidesPerGroupAuto && (v = v - n.slidesPerViewDynamic("previous", !0) + 1, v = Math.max(v, 0))), s.rewind && n.isBeginning ? n.slideTo(n.slides.length - 1, i, e, t) : n.slideTo(v, i, e, t)
}

function Ga(i = this.params.speed, e = !0, t) {
    const n = this;
    return n.slideTo(n.activeIndex, i, e, t)
}

function Wa(i = this.params.speed, e = !0, t, n = .5) {
    const s = this;
    let o = s.activeIndex;
    ...
    return o = Math.max(o, 0), o = Math.min(o, s.slidesGrid.length - 1), s.slideTo(o, i, e, t)
}
...
function Xa() {
    ...
    if (e.loop) {
        ...
        o = parseInt($(i.clickedSlide).attr("data-swiper-slide-index"), 10), e.centeredSlides ? s < i.loopedSlides - n / 2 || s > i.slides.length - i.loopedSlides + n / 2 ? (i.loopFix(), s = t.children(`.${e.slideClass}[data-swiper-slide-index="${o}"]:not(.${e.slideDuplicateClass})`).eq(0).index(), dt(() => {
            i.slideTo(s)
        })) : i.slideTo(s) : s > i.slides.length - n ? (i.loopFix(), s = t.children(`.${e.slideClass}[data-swiper-slide-index="${o}"]:not(.${e.slideDuplicateClass})`).eq(0).index(), dt(() => {
            i.slideTo(s)
        })) : i.slideTo(s)
    } else i.slideTo(s)
}
...
function Za() {
    ...
    if (t.loopFillGroupWithBlank) {
        ...
        if (l !== t.slidesPerGroup) {
            for (let u = 0; u < l; u += 1) {
                const c = $(e.createElement("div")).addClass(`${t.slideClass} ${t.slideBlankClass}`);
                s.append(c)
            }
            o = s.children(`.${t.slideClass}`)
        }
    }
    t.slidesPerView === "auto" && !t.loopedSlides && (t.loopedSlides = o.length), i.loopedSlides = Math.ceil(parseFloat(t.loopedSlides || t.slidesPerView, 10)), i.loopedSlides += t.loopAdditionalSlides, i.loopedSlides > o.length && (i.loopedSlides = o.length);
    const r = [],
        a = [];
    o.each((l, u) => {
        const c = $(l);
        u < i.loopedSlides && a.push(l), u < o.length && u >= o.length - i.loopedSlides && r.push(l), c.attr("data-swiper-slide-index", u)
    });
    for (let l = 0; l < a.length; l += 1) s.append($(a[l].cloneNode(!0)).addClass(t.slideDuplicateClass));
    for (let l = r.length - 1; l >= 0; l -= 1) s.prepend($(r[l].cloneNode(!0)).addClass(t.slideDuplicateClass))
}
...
function Ka() {
    ...
    e < n ? (l = t.length - n * 3 + e, l += n, i.slideTo(l, 0, !1, !0) && c !== 0 && i.setTranslate((a ? -i.translate : i.translate) - c)) : e >= t.length - n && (l = -t.length + e + n, l += n, i.slideTo(l, 0, !1, !0) && c !== 0 && i.setTranslate((a ? -i.translate : i.translate) - c)), i.allowSlidePrev = s, i.allowSlideNext = o, i.emit("loopFix")
}
...
function tl() {
    const i = this;
    i.support.touch || i.params.watchOverflow && i.isLocked || i.params.cssMode || (i[i.params.touchEventsTarget === "container" ? "el" : "wrapperEl"].style.cursor = "")
}
const il = {
    setGrabCursor: el,
    unsetGrabCursor: tl
...
function nl(i, e = this) {
    function t(n) {
        return !n || n === ye() || n === re() ? null : (n.assignedSlot && (n = n.assignedSlot), n.closest(i) || t(n.getRootNode().host))
    }
    return t(e)
}
...
function sl(i) {
    ...
    let u = $(l.target);
    if (o.touchEventsTarget === "wrapper" && !u.closest(e.wrapperEl).length || (s.isTouchEvent = l.type === "touchstart", !s.isTouchEvent && "which" in l && l.which === 3) || !s.isTouchEvent && "button" in l && l.button > 0 || s.isTouched && s.isMoved) return;
    !!o.noSwipingClass && o.noSwipingClass !== "" && l.target && l.target.shadowRoot && i.path && i.path[0] && (u = $(i.path[0]));
    const d = o.noSwipingSelector ? o.noSwipingSelector : `.${o.noSwipingClass}`,
        f = !!(l.target && l.target.shadowRoot);
    if (o.noSwiping && (f ? nl(d, l.target) : u.closest(d)[0])) {
        e.allowClick = !0;
        return
    }
    ...
    if (v && (p <= y || p >= n.innerWidth - y))
        if (v === "prevent") i.preventDefault();
        else return;
    if (Object.assign(s, {
            isTouched: !0,
            isMoved: !1,
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), r.startX = p, r.startY = h, s.touchStartTime = Pe(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, o.threshold > 0 && (s.allowThresholdMove = !1), l.type !== "touchstart") {
        let E = !0;
        u.is(s.focusableElements) && (E = !1), t.activeElement && $(t.activeElement).is(s.focusableElements) && t.activeElement !== u[0] && t.activeElement.blur();
        const C = E && e.allowTouchMove && o.touchStartPreventDefault;
        (o.touchStartForcePreventDefault || C) && !u[0].isContentEditable && l.preventDefault()
    }
    e.emit("touchStart", l)
}
...
function ol(i) {
    ...
    if (!t.allowTouchMove) {
        t.allowClick = !1, n.isTouched && (Object.assign(o, {
            startX: c,
            startY: d,
            currentX: c,
            currentY: d
    ...
    if (n.isTouchEvent && e.activeElement && l.target === e.activeElement && $(l.target).is(n.focusableElements)) {
    ...
    if (typeof n.isScrolling > "u") {
        let E;
        t.isHorizontal() && o.currentY === o.startY || t.isVertical() && o.currentX === o.startX ? n.isScrolling = !1 : f * f + p * p >= 25 && (E = Math.atan2(Math.abs(p), Math.abs(f)) * 180 / Math.PI, n.isScrolling = t.isHorizontal() ? E > s.touchAngle : 90 - E > s.touchAngle)
    }
    if (n.isScrolling && t.emit("touchMoveOpposite", l), typeof n.startMoving > "u" && (o.currentX !== o.startX || o.currentY !== o.startY) && (n.startMoving = !0), n.isScrolling) {
        n.isTouched = !1;
        return
    }
    ...
    o.diff = h, h *= s.touchRatio, r && (h = -h), t.swipeDirection = h > 0 ? "prev" : "next", n.currentTranslate = h + n.startTranslate;
    let v = !0,
        y = s.resistanceRatio;
    if (s.touchReleaseOnEdges && (y = 0), h > 0 && n.currentTranslate > t.minTranslate() ? (v = !1, s.resistance && (n.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + n.startTranslate + h) ** y)) : h < 0 && n.currentTranslate < t.maxTranslate() && (v = !1, s.resistance && (n.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - n.startTranslate - h) ** y)), v && (l.preventedByNestedSwiper = !0), !t.allowSlideNext && t.swipeDirection === "next" && n.currentTranslate < n.startTranslate && (n.currentTranslate = n.startTranslate), !t.allowSlidePrev && t.swipeDirection === "prev" && n.currentTranslate > n.startTranslate && (n.currentTranslate = n.startTranslate), !t.allowSlidePrev && !t.allowSlideNext && (n.currentTranslate = n.startTranslate), s.threshold > 0)
...
function rl(i) {
    ...
    if (e.allowClick) {
        ...
        e.updateClickedSlide(y && y[0] || l.target), e.emit("tap click", l), c < 300 && u - t.lastClickTime < 300 && e.emit("doubleTap doubleClick", l)
    }
    if (t.lastClickTime = Pe(), dt(() => {
    ...
    t.isTouched = !1, t.isMoved = !1, t.startMoving = !1;
    let d;
    if (n.followFinger ? d = o ? e.translate : -e.translate : d = -t.currentTranslate, n.cssMode) return;
    ...
    for (let y = 0; y < r.length; y += y < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
        const E = y < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
        typeof r[y + E] < "u" ? d >= r[y] && d < r[y + E] && (f = y, p = r[y + E] - r[y]) : d >= r[y] && (f = y, p = r[r.length - 1] - r[r.length - 2])
    }
    const h = (d - r[f]) / p,
    ...
    if (c > n.longSwipesMs) {
        ...
        e.swipeDirection === "next" && (h >= n.longSwipesRatio ? e.slideTo(f + v) : e.slideTo(f)), e.swipeDirection === "prev" && (h > 1 - n.longSwipesRatio ? e.slideTo(f + v) : e.slideTo(f))
    } else {
        if (!n.shortSwipes) {
            e.slideTo(e.activeIndex);
            return
        }
        e.navigation && (l.target === e.navigation.nextEl || l.target === e.navigation.prevEl) ? l.target === e.navigation.nextEl ? e.slideTo(f + v) : e.slideTo(f) : (e.swipeDirection === "next" && e.slideTo(f + v), e.swipeDirection === "prev" && e.slideTo(f))
    }
}
...
function ll() {
    ...
    o === 0 ? s = 0 : s = (i.translate - i.minTranslate()) / o, s !== i.progress && i.updateProgress(t ? -i.translate : i.translate), i.emit("setTranslate", i.translate, !1)
}
let ki = !1;
...
const yn = (i, e) => {
    const t = ye(),
        ...
        d = e;
    if (!l.touch) o[c](s.start, i.onTouchStart, !1), t[c](s.move, i.onTouchMove, u), t[c](s.end, i.onTouchEnd, !1);
    else {
        const f = s.start === "touchstart" && l.passiveListener && n.passiveListeners ? {
            passive: !0,
            capture: !1
        } : !1;
        o[c](s.start, i.onTouchStart, f), o[c](s.move, i.onTouchMove, l.passiveListener ? {
            passive: !1,
            capture: u
        } : u), o[c](s.end, i.onTouchEnd, f), s.cancel && o[c](s.cancel, i.onTouchEnd, f)
    }(n.preventClicks || n.preventClicksPropagation) && o[c]("click", i.onClick, !0), n.cssMode && r[c]("scroll", i.onScroll), n.updateOnWindowResize ? i[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Bi, !0) : i[d]("observerUpdate", Bi, !0)
};
...
function cl() {
    ...
    i.onTouchStart = sl.bind(i), i.onTouchMove = ol.bind(i), i.onTouchEnd = rl.bind(i), t.cssMode && (i.onScroll = ll.bind(i)), i.onClick = al.bind(i), n.touch && !ki && (e.addEventListener("touchstart", ul), ki = !0), yn(i, "on")
}
...
function hl() {
    ...
    const u = (a in r ? r[a] : void 0) || i.originalParams,
        ...
        d = Di(i, u),
        f = s.enabled;
    c && !d ? (o.removeClass(`${s.containerModifierClass}grid ${s.containerModifierClass}grid-column`), i.emitContainerClasses()) : !c && d && (o.addClass(`${s.containerModifierClass}grid`), (u.grid.fill && u.grid.fill === "column" || !u.grid.fill && s.grid.fill === "column") && o.addClass(`${s.containerModifierClass}grid-column`), i.emitContainerClasses());
    const p = u.direction && u.direction !== s.direction,
        h = s.loop && (u.slidesPerView !== s.slidesPerView || p);
    p && t && i.changeDirection(), ge(i.params, u);
    const v = i.params.enabled;
    Object.assign(i, {
        allowTouchMove: i.params.allowTouchMove,
        allowSlideNext: i.params.allowSlideNext,
        allowSlidePrev: i.params.allowSlidePrev
    }), f && !v ? i.disable() : !f && v && i.enable(), i.currentBreakpoint = a, i.emit("_beforeBreakpoint", u), h && t && (i.loopDestroy(), i.loopCreate(), i.updateSlides(), i.slideTo(e - n + i.loopedSlides, 0, !1)), i.emit("breakpoint", u)
}

function pl(i, e = "window", t) {
    ...
    for (let a = 0; a < r.length; a += 1) {
        ...
        e === "window" ? s.matchMedia(`(min-width: ${u}px)`).matches && (n = l) : u <= t.clientWidth && (n = l)
    }
    return n || "max"
}
const vl = {
...
function bl(i, e, t, n, s, o) {
    const r = re();
    let a;

    function l() {
        o && o()
    }!$(i).parent("picture")[0] && (!i.complete || !s) && e ? (a = new r.Image, a.onload = l, a.onerror = l, n && (a.sizes = n), t && (a.srcset = t), e && (a.src = e)) : l()
}
...
function _l() {
    ...
    for (let t = 0; t < i.imagesToLoad.length; t += 1) {
        ...
        i.loadImage(n, n.currentSrc || n.getAttribute("src"), n.srcset || n.getAttribute("srcset"), n.sizes || n.getAttribute("sizes"), !0, e)
    }
}
const wl = {
    loadImage: bl,
...
function Fl(i, e) {
    return function(n = {}) {
        ...
        if (["navigation", "pagination", "scrollbar"].indexOf(s) >= 0 && i[s] === !0 && (i[s] = {
                auto: !0
            }), !(s in i && "enabled" in o)) {
            ge(e, n);
            return
...
class ue {
    constructor(...e) {
        let t, n;
        if (e.length === 1 && e[0].constructor && Object.prototype.toString.call(e[0]).slice(8, -1) === "Object" ? n = e[0] : [t, n] = e, n || (n = {}), n = ge({}, n), t && !n.el && (n.el = t), n.el && $(n.el).length > 1) {
            const a = [];
            return $(n.el).each(l => {
                const u = ge({}, n, {
                    el: l
        ...
        const s = this;
        s.__swiper__ = !0, s.support = gn(), s.device = ma({
            userAgent: n.userAgent
        }), s.browser = Ca(), s.eventsListeners = {}, s.eventsAnyListeners = [], s.modules = [...s.__modules__], n.modules && Array.isArray(n.modules) && s.modules.push(...n.modules);
        const o = {};
        s.modules.forEach(a => {
            a({
                swiper: s,
        ...
        const r = ge({}, Ai, o);
        return s.params = ge({}, r, zt, n), s.originalParams = ge({}, s.params), s.passedParams = ge({}, n), s.params && s.params.on && Object.keys(s.params.on).forEach(a => {
            s.on(a, s.params.on[a])
        }), s.params && s.params.onAny && s.onAny(s.params.onAny), s.$ = $, Object.assign(s, {
    ...
    setProgress(e, t) {
        ...
        n.translateTo(r, typeof t > "u" ? 0 : t), n.updateActiveIndex(), n.updateSlidesClasses()
    }
    ...
    getSlideClasses(e) {
        const t = this;
        return e.className.split(" ").filter(n => n.indexOf("swiper-slide") === 0 || n.indexOf(t.params.slideClass) === 0).join(" ")
    }
    emitSlidesClasses() {
        const e = this;
        if (!e.params._emitClasses || !e.el) return;
    ...
    slidesPerViewDynamic(e = "current", t = !1) {
        ...
        if (s.centeredSlides) {
            let d = o[u].swiperSlideSize,
                f;
            for (let p = u + 1; p < o.length; p += 1) o[p] && !f && (d += o[p].swiperSlideSize, c += 1, d > l && (f = !0));
            for (let p = u - 1; p >= 0; p -= 1) o[p] && !f && (d += o[p].swiperSlideSize, c += 1, d > l && (f = !0))
        } else if (e === "current")
            for (let d = u + 1; d < o.length; d += 1)(t ? r[d] + a[d] - r[u] < l : r[d] - r[u] < l) && (c += 1);
        else
            for (let d = u - 1; d >= 0; d -= 1) r[u] - r[d] < l && (c += 1);
        return c
    }
    update() {
        const e = this;
        ...
        let o;
        e.params.freeMode && e.params.freeMode.enabled ? (s(), e.params.autoHeight && e.updateAutoHeight()) : ((e.params.slidesPerView === "auto" || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? o = e.slideTo(e.slides.length - 1, 0, !1, !0) : o = e.slideTo(e.activeIndex, 0, !1, !0), o || s()), n.watchOverflow && t !== e.snapGrid && e.checkOverflow(), e.emit("update")
    }
    changeDirection(e, t = !0) {
        const n = this,
            s = n.params.direction;
        return e || (e = s === "horizontal" ? "vertical" : "horizontal"), e === s || e !== "horizontal" && e !== "vertical" || (n.$el.removeClass(`${n.params.containerModifierClass}${s}`).addClass(`${n.params.containerModifierClass}${e}`), n.emitContainerClasses(), n.params.direction = e, n.slides.each(o => {
    ...
    mount(e) {
        ...
        if (r.length === 0 && t.params.createElements) {
            ...
            r = $(l), l.className = t.params.wrapperClass, n.append(l), n.children(`.${t.params.slideClass}`).each(u => {
                r.append(u)
            })
        }
    ...
    destroy(e = !0, t = !0) {
        ...
        return typeof n.params > "u" || n.destroyed || (n.emit("beforeDestroy"), n.initialized = !1, n.detachEvents(), s.loop && n.loopDestroy(), t && (n.removeClasses(), o.removeAttr("style"), r.removeAttr("style"), a && a.length && a.removeClass([s.slideVisibleClass, s.slideActiveClass, s.slideNextClass, s.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")), n.emit("destroy"), Object.keys(n.eventsListeners).forEach(l => {
            n.off(l)
        }), e !== !1 && (n.$el[0].swiper = null, ca(n)), n.destroyed = !0), null
    }
...
Object.keys(It).forEach(i => {
    Object.keys(It[i]).forEach(e => {
        ue.prototype[e] = It[i][e]
    })
});
ue.use([ya, ba]);
...
function bn({
    ...
    function u(C) {
        let _ = 0,
            ...
            F = 0,
            T = 0;
        return "detail" in C && (S = C.detail), "wheelDelta" in C && (S = -C.wheelDelta / 120), "wheelDeltaY" in C && (S = -C.wheelDeltaY / 120), "wheelDeltaX" in C && (_ = -C.wheelDeltaX / 120), "axis" in C && C.axis === C.HORIZONTAL_AXIS && (_ = S, S = 0), F = _ * 10, T = S * 10, "deltaY" in C && (T = C.deltaY), "deltaX" in C && (F = C.deltaX), C.shiftKey && !F && (F = T, T = 0), (F || T) && C.deltaMode && (C.deltaMode === 1 ? (F *= 40, T *= 40) : (F *= 800, T *= 800)), F && !_ && (_ = F < 1 ? -1 : 1), T && !S && (S = T < 1 ? -1 : 1), {
            spinX: _,
            spinY: S,
            pixelX: F,
            pixelY: T
    ...
    function f(C) {
        return i.params.mousewheel.thresholdDelta && C.delta < i.params.mousewheel.thresholdDelta || i.params.mousewheel.thresholdTime && Pe() - r < i.params.mousewheel.thresholdTime ? !1 : C.delta >= 6 && Pe() - r < 60 ? !0 : (C.direction < 0 ? (!i.isEnd || i.params.loop) && !i.animating && (i.slideNext(), n("scroll", C.raw)) : (!i.isBeginning || i.params.loop) && !i.animating && (i.slidePrev(), n("scroll", C.raw)), r = new s.Date().getTime(), !1)
    }
    ...
    function h(C) {
        ...
        let _ = i.$el;
        if (i.params.mousewheel.eventsTarget !== "container" && (_ = $(i.params.mousewheel.eventsTarget)), !i.mouseEntered && !_[0].contains(b.target) && !w.releaseOnEdges) return !0;
        ...
        if (w.forceToAxis)
            if (i.isHorizontal())
                if (Math.abs(T.pixelX) > Math.abs(T.pixelY)) S = -T.pixelX * F;
                else return !0;
        else if (Math.abs(T.pixelY) > Math.abs(T.pixelX)) S = -T.pixelY;
        else return !0;
        else S = Math.abs(T.pixelX) > Math.abs(T.pixelY) ? -T.pixelX * F : -T.pixelY;
        if (S === 0) return !0;
        w.invert && (S = -S);
        let k = i.getTranslate() + S * w.sensitivity;
        if (k >= i.minTranslate() && (k = i.minTranslate()), k <= i.maxTranslate() && (k = i.maxTranslate()), x = i.params.loop ? !0 : !(k === i.minTranslate() || k === i.maxTranslate()), x && i.params.nested && b.stopPropagation(), !i.params.freeMode || !i.params.freeMode.enabled) {
            const D = {
                time: Pe(),
                delta: Math.abs(S),
            ...
            if (l.push(D), I ? (D.direction !== I.direction || D.delta > I.delta || D.time > I.time + 150) && f(D) : f(D), p(D)) return !0
        } else {
            const D = {
                    time: Pe(),
                    delta: Math.abs(S),
                ...
                I = a && D.time < a.time + 500 && D.delta <= a.delta && D.direction === a.direction;
            if (!I) {
                a = void 0, i.params.loop && i.loopFix();
                let V = i.getTranslate() + S * w.sensitivity;
                const G = i.isBeginning,
                    B = i.isEnd;
                if (V >= i.minTranslate() && (V = i.minTranslate()), V <= i.maxTranslate() && (V = i.maxTranslate()), i.setTransition(0), i.setTranslate(V), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!G && i.isBeginning || !B && i.isEnd) && i.updateSlidesClasses(), i.params.freeMode.sticky) {
                    clearTimeout(o), o = void 0, l.length >= 15 && l.shift();
                    const A = l.length ? l[l.length - 1] : void 0,
                        M = l[0];
                    if (l.push(D), A && (D.delta > A.delta || D.direction !== A.direction)) l.splice(0);
                    else if (l.length >= 15 && D.time - M.time < 500 && M.delta - D.delta >= 1 && D.delta <= 6) {
                        const O = S > 0 ? .8 : .2;
                        a = D, l.splice(0), o = dt(() => {
                    ...
                    o || (o = dt(() => {
                        a = D, l.splice(0), i.slideToClosest(i.params.speed, !0, void 0, .5)
                    }, 500))
                }
                if (I || n("scroll", b), i.params.autoplay && i.params.autoplayDisableOnInteraction && i.autoplay.stop(), V === i.minTranslate() || V === i.maxTranslate()) return !0
            }
        }
    ...
    function v(C) {
        let b = i.$el;
        i.params.mousewheel.eventsTarget !== "container" && (b = $(i.params.mousewheel.eventsTarget)), b[C]("mouseenter", c), b[C]("mouseleave", d), b[C]("wheel", h)
    }

    function y() {
        return i.params.cssMode ? (i.wrapperEl.removeEventListener("wheel", h), !0) : i.mousewheel.enabled ? !1 : (v("on"), i.mousewheel.enabled = !0, !0)
    }

    function E() {
        return i.params.cssMode ? (i.wrapperEl.addEventListener(event, h), !0) : i.mousewheel.enabled ? (v("off"), i.mousewheel.enabled = !1, !0) : !1
    }
    t("init", () => {
        !i.params.mousewheel.enabled && i.params.cssMode && E(), i.params.mousewheel.enabled && y()
    }), t("destroy", () => {
...
function Ve(i, e) {
    ...
    Object.keys(e).filter(n => t.indexOf(n) < 0).forEach(n => {
        typeof i[n] > "u" ? i[n] = e[n] : Ye(e[n]) && Ye(i[n]) && Object.keys(e[n]).length > 0 ? e[n].__swiper__ ? i[n] = e[n] : Ve(i[n], e[n]) : i[n] = e[n]
    })
}
...
function Mi(i = {}) {
    const e = {
        ...
        t = {};
    Ve(e, ue.defaults), Ve(e, ue.extendedDefaults), e._emitClasses = !0, e.init = !1;
    const n = {},
        s = Fn.map(r => r.replace(/_/, "")),
        o = Object.assign({}, i);
    return Object.keys(o).forEach(r => {
        typeof i[r] > "u" || (s.indexOf(r) >= 0 ? Ye(i[r]) ? (e[r] = {}, t[r] = {}, Ve(e[r], i[r]), Ve(t[r], i[r])) : (e[r] = i[r], t[r] = i[r]) : r.search(/on[A-Z]/) === 0 && typeof i[r] == "function" ? e.on[`${r[2].toLowerCase()}${r.substr(3)}`] = i[r] : n[r] = i[r])
...
function Tl({
    ...
    _n(r) && e && t && (o.params.navigation.nextEl = e, o.originalParams.navigation.nextEl = e, o.params.navigation.prevEl = t, o.originalParams.navigation.prevEl = t), wn(r) && n && (o.params.pagination.el = n, o.originalParams.pagination.el = n), En(r) && s && (o.params.scrollbar.el = s, o.originalParams.scrollbar.el = s), o.init(i)
}
...
function Bl(i, e, t) {
    const n = e.map((l, u) => (l.props || (l.props = {}), l.props.swiperRef = i, l.props["data-swiper-slide-index"] = u, l));

    function s(l, u, c) {
        return l.props || (l.props = {}), Se(l.type, {
            ...l.props,
    ...
    return n.forEach((l, u) => {
        u < o && a.push(s(l, u, "prepend")), u < n.length && u >= n.length - o && r.push(s(l, u, "append"))
    }), i.value && (i.value.loopedSlides = o), [...r, ...n, ...a]
}
...
function kl(i, e, t, n) {
    ...
    return r.join("") !== a.join("") && s.push("children"), n.length !== t.length && s.push("children"), Fn.filter(u => u[0] === "_").map(u => u.replace(/_/, "")).forEach(u => {
        if (u in i && u in e)
            if (Ye(i[u]) && Ye(e[u])) {
                const c = Object.keys(i[u]),
                    d = Object.keys(e[u]);
                c.length !== d.length ? o(u) : (c.forEach(f => {
                    i[u][f] !== e[u][f] && o(u)
                }), d.forEach(f => {
                    i[u][f] !== e[u][f] && o(u)
                }))
    ...
    const n = [],
        ...
        o = (r, a) => {
            !Array.isArray(r) || r.forEach(l => {
                ...
                a === "default" && (a = "container-end"), u && l.children ? o(l.children, "default") : l.type && (l.type.name === "SwiperSlide" || l.type.name === "AsyncComponentWrapper") ? n.push(l) : s[a] && s[a].push(l)
            })
        };
...
function Dl({
    ...
    const l = n.filter(w => w !== "children" && w !== "direction"),
        {
            params: u,
            pagination: c,
            navigation: d,
    ...
    let v, y, E, C, b;
    n.includes("thumbs") && t.thumbs && t.thumbs.swiper && u.thumbs && !u.thumbs.swiper && (v = !0), n.includes("controller") && t.controller && t.controller.control && u.controller && !u.controller.control && (y = !0), n.includes("pagination") && t.pagination && (t.pagination.el || r) && (u.pagination || u.pagination === !1) && c && !c.el && (E = !0), n.includes("scrollbar") && t.scrollbar && (t.scrollbar.el || a) && (u.scrollbar || u.scrollbar === !1) && f && !f.el && (C = !0), n.includes("navigation") && t.navigation && (t.navigation.prevEl || o) && (t.navigation.nextEl || s) && (u.navigation || u.navigation === !1) && d && !d.prevEl && !d.nextEl && (b = !0);
    const x = w => {
        !i[w] || (i[w].destroy(), w === "navigation" ? (u[w].prevEl = void 0, u[w].nextEl = void 0, i[w].prevEl = void 0, i[w].nextEl = void 0) : (u[w].el = void 0, i[w].el = void 0))
    };
    l.forEach(w => {
        if (Ye(u[w]) && Ye(t[w])) Ve(u[w], t[w]);
        else {
            const _ = t[w];
            (_ === !0 || _ === !1) && (w === "navigation" || w === "pagination" || w === "scrollbar") ? _ === !1 && x(w): u[w] = t[w]
        }
    }), n.includes("children") && p && u.virtual.enabled ? (p.slides = e, p.update(!0)) : n.includes("children") && i.lazy && i.params.lazy.enabled && i.lazy.load(), v && h.init() && h.update(!0), y && (i.controller.control = u.controller.control), E && (r && (u.pagination.el = r), c.init(), c.render(), c.update()), C && (a && (u.scrollbar.el = a), f.init(), f.updateSize(), f.setTranslate()), b && (s && (u.navigation.nextEl = s), o && (u.navigation.prevEl = o), d.init(), d.update()), n.includes("allowSlideNext") && (i.allowSlideNext = t.allowSlideNext), n.includes("allowSlidePrev") && (i.allowSlidePrev = t.allowSlidePrev), n.includes("direction") && i.changeDirection(t.direction, !1), i.update()
}
...
function Ml(i, e, t) {
    ...
    return e.filter((s, o) => o >= t.from && o <= t.to).map(s => (s.props || (s.props = {}), s.props.style || (s.props.style = {}), s.props.swiperRef = i, s.props.style = n, Se(s.type, {
        ...s.props
    }, s.children)))
}
const Tn = {
        ...
        setup(i, {
            ...
            const {
                tag: n,
                wrapperTag: s
            } = i, o = L("swiper"), r = L(null), a = L(!1), l = L(!1), u = L(null), c = L(null), d = L(null), f = {
                value: []
            }, p = {
                value: []
            }, h = L(null), v = L(null), y = L(null), E = L(null), {
                params: C,
                passedParams: b
            } = Mi(i);
            ...
            if (C.onAny = (_, ...S) => {
                ...
                }), c.value = Sl(C), c.value.loopCreate = () => {}, c.value.loopDestroy = () => {}, C.loop && (c.value.loopedSlides = Sn(f.value, C)), c.value.virtual && c.value.params.virtual.enabled) {
                ...
                Ve(c.value.params.virtual, _), Ve(c.value.originalParams.virtual, _)
            }
            an(() => {
                !l.value && c.value && (c.value.emitSlidesClasses(), l.value = !0);
                const {
                    passedParams: _
                } = Mi(i), S = kl(_, d.value, f.value, p.value);
                d.value = _, (S.length || a.value) && c.value && !c.value.destroyed && Dl({
                    swiper: c.value,
                    slides: f.value,
                    passedParams: _,
                    changedParams: S,
            ...
            function w(_) {
                return C.virtual ? Ml(c, _, r.value) : !C.loop || c.value && c.value.destroyed ? (_.forEach(S => {
            ...
            return () => {
                ...
                }, [S["wrapper-start"], w(_), S["wrapper-end"]]), S["container-end"]])
            }
        }
    },
    Qe = {
        ...
        setup(i, {
            ...
            Be(() => {
                ...
                !s.value || !n || !n.value || n.value.destroyed && o.value !== "swiper-slide" && (o.value = "swiper-slide")
            }), Tt(() => {
            ...
            }, e.default && e.default(a.value)) : e.default && e.default(a.value))
        }
    };
const hi = i => (je("data-v-0ea798e3"), i = i(), qe(), i),
    Pl = {
        class: "sctionDisplay"
    },
    Ol = {
    ...
    jl = {
        class: "staffDetailRights"
    },
    ql = {
        class: "particle"
    },
    Gl = {
        class: "staffDetailWrapper"
    },
    Wl = {
        class: "staffContent"
    },
    ...
    uu = ae({
        ...
        setup(i) {
            ...
            let s = q([{
                ...
                o = q([]);
            o.push(...tt(s, o, e.ThreeParticlesLogo)), _e(() => e.ThreeParticlesLogo, (w, _) => {
                o.push(...tt(s, o, w)), e.ThreeParticlesLogo && n.value.clearCanvas()
            });
            const r = q([{
                    id: 0,
                    name: "\u963F\u7C73\u5A05",
    ...
    \u73B0\u4F5C\u4E3A\u91CD\u88C5\u5E72\u5458\u534F\u52A9\u7F57\u5FB7\u5C9B\u884C\u52A8\uFF0C\u5E76\u4E3A\u73B0\u573A\u63D0\u4F9B\u6218\u672F\u6267\u884C\u4E0E\u6307\u6325\u652F\u63F4\u3002`
            ...
            for (let w = 0; w < r.length; w++) {
                let _ = new URL(Object.assign({
                    "../../assets/img/Three/0.webp": dr,
                    "../../assets/img/Three/1.webp": fr,
                    "../../assets/img/Three/10.webp": hr,
                    "../../assets/img/Three/11.webp": pr,
                    "../../assets/img/Three/12.webp": vr,
                    "../../assets/img/Three/2.webp": mr,
                    "../../assets/img/Three/3.webp": gr,
                    "../../assets/img/Three/4.webp": Cr,
                    "../../assets/img/Three/5.webp": yr,
                    "../../assets/img/Three/6.webp": br,
                    "../../assets/img/Three/7.webp": _r,
                    "../../assets/img/Three/8.webp": wr,
                    "../../assets/img/Three/9.webp": Er
                })[`../../assets/img/Three/${w}.webp`], self.location).href;
                d.backgroundImage[w] = `url(${_})`
            }

            function f(w) {
                return new Promise(_ => setTimeout(_, w))
            }
            let p = q([{
                    name: "staffTop",
                    state: !0
                ...
                h = q({
                    backgroundImage: d.backgroundImage[0]
                }),
                v = L(0),
                y = L("100%"),
                E = L(!0),
                C = L(""),
                b = L(!0);
            const x = async (w, _, S, F) => {
                if (E.value && !S.active) {
                    switch (E.value = !1, _.forEach(T => {
                            T.active = !1
                        }), _[w].active = !0, u.slideToLoop(w, 500), console.log(C.value, F, F === C.value), F) {
                        case (F = "rhodes"):
                            n.value.ChoiceImg(0), C.value = F;
                            break;
                        case (F = "rhine"):
                            n.value.ChoiceImg(1), C.value = F;
                            break;
                        case (F = "yan"):
                            n.value.ChoiceImg(2), C.value = F;
                            break;
                        case (F = "penguin"):
                            n.value.ChoiceImg(3), C.value = F;
                            break
                    }
                    await f(50), p[0].state = !1, b.value = !1, y.value = "0%", await f(100), p[2].state = !1, await f(50), p[1].state = !1, await f(500), y.value = "100%", await f(100), v.value = w, p[0].state = !0, h.backgroundImage = d.backgroundImage[w], b.value = !0, await f(100), p[2].state = !0, await f(50), p[1].state = !0, E.value = !0
                }
            };
            return (w, _) => {
                const S = ci;
                return P(), z(ce, null, [g("div", Pl, [g("div", Ol, [g("div", Ll, [Il, g("div", zl, [N(m(Tn), {
                    modules: t,
                    "slides-per-view": 7,
                    direction: "vertical",
                    "centered-slides": !0,
                    ...
                    default: j(() => [(P(!0), z(ce, null, we(m(r), F => (P(), Re(m(Qe), {
                        key: F.id,
                        onClick: T => x(F.id, m(r), F, F.camp),
                        class: le(F.active ? "slideAcive" : ""),
                        "data-cursor": "pointer"
                    }, {
                        default: j(() => [g("span", Rl, Y(F.idex), 1), g("span", $l, [(P(), z("svg", Nl, [g("use", {
                            "xlink:href": F.career
                        }, null, 8, Hl)]))]), g("span", Vl, Y(F.name), 1)]),
                        _: 2
                    }, 1032, ["onClick", "class"]))), 128))]),
                    _: 1
                })]), g("div", Ul, Y(m(r)[m(v)].footer), 1)]), g("div", jl, [g("div", ql, [N(S, {
                    canvasRect: m(l),
                    logos: m(o),
                    ref_key: "LiziChild",
                    ref: n
                }, null, 8, ["canvasRect", "logos"])]), g("div", Gl, [g("div", Wl, [g("div", Xl, [N(te, {
                    name: "StaffBottom"
                }, {
                    default: j(() => [fe(g("div", Yl, [(P(), z("svg", Zl, [g("text", Kl, Y(m(a)[m(v)].EN), 1)]))], 512), [
                        [he, m(p)[0].state]
                    ])]),
                    _: 1
                }), g("div", Jl, [N(te, {
                    ...
                    default: j(() => [fe(g("div", Ql, [g("span", null, Y(m(a)[m(v)].name), 1)], 512), [
                        [he, m(p)[0].state]
                    ])]),
                    _: 1
                })]), N(te, {
                    ...
                    default: j(() => [fe(g("div", eu, [g("div", tu, [g("span", null, Y(m(a)[m(v)].EN), 1)]), g("div", iu, [nu, g("span", su, Y(m(a)[m(v)].CV), 1), ou])], 512), [
                        [he, m(p)[1].state]
                    ])]),
                    _: 1
                })]), N(te, {
                    ...
                    default: j(() => [fe(g("div", ru, [g("span", null, Y(m(a)[m(v)].desc), 1)], 512), [
                        [he, m(p)[2].state]
                    ])]),
                    _: 1
                })])])]), g("div", au, [N(te, {
...
const cu = Ce(uu, [
    ["__scopeId", "data-v-0ea798e3"]
]);
var du = typeof global == "object" && global && global.Object === Object && global;
const fu = du;
var hu = typeof self == "object" && self && self.Object === Object && self,
    pu = fu || hu || Function("return this")();
const Bn = pu;
var vu = Bn.Symbol;
const Et = vu;
var kn = Object.prototype,
    mu = kn.hasOwnProperty,
    gu = kn.toString,
...
function xu(i) {
    return i == null ? i === void 0 ? Eu : wu : Pi && Pi in Object(i) ? Cu(i) : _u(i)
}
...
function Tu(i) {
    return typeof i == "symbol" || Fu(i) && xu(i) == Su
}
var Bu = /\s/;

function ku(i) {
    for (var e = i.length; e-- && Bu.test(i.charAt(e)););
    return e
}
var Du = /^\s+/;

function Au(i) {
    return i && i.slice(0, ku(i) + 1).replace(Du, "")
}
...
function Li(i) {
    ...
    i = Au(i);
    var t = Pu.test(i);
    return t || Ou.test(i) ? Lu(i.slice(2), t ? 2 : 8) : Mu.test(i) ? Oi : +i
}
var Iu = function() {
    return Bn.Date.now()
};
...
function Nu(i, e, t) {
    ...
    e = Li(e) || 0, xt(t) && (c = !!t.leading, d = "maxWait" in t, o = d ? Ru(Li(t.maxWait) || 0, e) : o, f = "trailing" in t ? !!t.trailing : f);

    function p(_) {
        var S = n,
            F = s;
        return n = s = void 0, u = _, r = i.apply(F, S), r
    }

    function h(_) {
        return u = _, a = setTimeout(E, e), c ? p(_) : r
    }
    ...
    function C(_) {
        return a = void 0, f && n ? p(_) : (n = s = void 0, r)
    }
...
function Ii(i, e, t) {
    ...
    return xt(t) && (n = "leading" in t ? !!t.leading : n, s = "trailing" in t ? !!t.trailing : s), Nu(i, e, {
        leading: n,
        maxWait: e,
        trailing: s
    })
...
Dn && ((zi = window == null ? void 0 : window.navigator) == null ? void 0 : zi.userAgent) && /iP(ad|hone|od)/.test(window.navigator.userAgent);
...
const ii = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {},
...
var Ri = Object.getOwnPropertySymbols,
    ...
    Ju = (i, e) => {
        var t = {};
        for (var n in i) Zu.call(i, n) && e.indexOf(n) < 0 && (t[n] = i[n]);
        if (i != null && Ri)
            for (var n of Ri(i)) e.indexOf(n) < 0 && Ku.call(i, n) && (t[n] = i[n]);
        return t
    };
...
function Qu(i, e, t = {}) {
    const n = t,
        ...
        o = Ju(n, ["window"]);
    let r;
    const a = Yu(() => s && "ResizeObserver" in s),
        l = () => {
            r && (r.disconnect(), r = void 0)
        },
        u = _e(() => Wu(i), d => {
            l(), a.value && s && d && (r = new ResizeObserver(e), r.observe(d, o))
        }, {
            immediate: !0,
            flush: "post"
        }),
...
var ec = Object.defineProperty,
    ...
    nc = (i, e) => {
        for (var t in e || (e = {})) tc.call(e, t) && Hi(i, t, e[t]);
        if (Ni)
            for (var t of Ni(e)) ic.call(e, t) && Hi(i, t, e[t]);
        return i
    };
const sc = {
...
const Mn = i => i === void 0,
    oc = i => li(i) ? !Number.isNaN(Number(i)) : !1;

function rc(i, e = "px") {
    if (!i) return "";
    if (An(i) || oc(i)) return `${i}${e}`;
    if (li(i)) return i
...
function dc(i, e, t, n, s, o) {
    return P(), z("svg", lc, cc)
}
var fc = Pn(ac, [
        ["render", dc],
...
function gc(i, e, t, n, s, o) {
    return P(), z("svg", pc, mc)
}
var Cc = Pn(hc, [
    ["render", gc],
...
const On = "__epPropKey",
    ...
    _c = (i, e) => {
        ...
        const {
            ...
            validator: t || r ? u => {
                let c = !1,
                    d = [];
                if (t && (d = Array.from(t), Fi(i, "default") && d.push(s), c || (c = d.includes(u))), r && (c || (c = r(u))), !c && d.length > 0) {
                    const f = [...new Set(d)].map(p => JSON.stringify(p)).join(", ");
                    xs(`Invalid prop: validation failed${e?` for prop "${e}"`:""}. Expected one of [${f}], got value ${JSON.stringify(u)}.`)
                }
                return c
            } : void 0,
            [On]: !0
    ...
    pi = i => Hu(Object.entries(i).map(([e, t]) => [e, _c(t, e)])),
    Ln = (i, e) => {
        if (i.install = t => {
                for (const n of [i, ...Object.values(e != null ? e : {})]) t.component(n.name, n)
            }, e)
    ...
    _t = i => {
        ...
        return e.forEach(n => {
            var s;
            Mt(n) ? t.push(..._t(n)) : ti(n) && Mt(n.children) ? t.push(..._t(n.children)) : (t.push(n), ti(n) && ((s = n.component) == null ? void 0 : s.subTree) && t.push(..._t(n.component.subTree)))
        }), t
    },
    In = Symbol("carouselContextKey"),
    Ec = Symbol(),
    Vi = L();

function xc(i, e = void 0) {
    const t = Bt() ? cn(Ec, Vi) : Vi;
    return i ? Le(() => {
        var n, s;
...
const Fc = "el",
    ...
    vi = i => {
        const e = xc("namespace", Fc);
        return {
            namespace: e,
            b: (h = "") => We(e.value, i, h, "", ""),
            e: h => h ? We(e.value, i, "", h, "") : "",
            m: h => h ? We(e.value, i, "", "", h) : "",
            be: (h, v) => h && v ? We(e.value, i, h, v, "") : "",
            em: (h, v) => h && v ? We(e.value, i, "", h, v) : "",
            bm: (h, v) => h && v ? We(e.value, i, h, "", v) : "",
            bem: (h, v, y) => h && v && y ? We(e.value, i, h, v, y) : "",
            is: (h, ...v) => {
            ...
            cssVar: h => {
                const v = {};
                for (const y in h) h[y] && (v[`--${e.value}-${y}`] = h[y]);
                return v
            },
            cssVarName: h => `--${e.value}-${h}`,
            cssVarBlock: h => {
                const v = {};
                for (const y in h) h[y] && (v[`--${e.value}-${i}-${y}`] = h[y]);
                return v
            },
            cssVarBlockName: h => `--${e.value}-${i}-${h}`
        }
    },
    Tc = (i, e, t) => _t(i.subTree).filter(o => {
        var r;
        return ti(o) && ((r = o.type) == null ? void 0 : r.name) === e && !!o.component
    }).map(o => o.component.uid).map(o => t[o]).filter(o => !!o),
    Bc = (i, e) => {
        const t = {},
            n = dn([]);
        return {
...
const Ui = Ln(Mc),
    ...
    Lc = (i, e, t) => {
        const {
            ...
            addChild: s,
            removeChild: o
        } = Bc(Bt(), "ElCarouselItem"), r = L(-1), a = L(null), l = L(!1), u = L(), c = Le(() => i.arrow !== "never" && !m(p)), d = Le(() => n.value.some(A => A.props.label.toString().length > 0)), f = Le(() => i.type === "card"), p = Le(() => i.direction === "vertical"), h = Ii(A => {
            b(A)
        }, ji, {
            trailing: !0
        }), v = Ii(A => {
        ...
        function E() {
            i.interval <= 0 || !i.autoplay || a.value || (a.value = setInterval(() => C(), i.interval))
        }
        const C = () => {
            r.value < n.value.length - 1 ? r.value = r.value + 1 : i.loop && (r.value = 0)
        };

        function b(A) {
            if (li(A)) {
                const W = n.value.filter(Ae => Ae.props.name === A);
                W.length > 0 && (A = n.value.indexOf(W[0]))
            }
            if (A = Number(A), Number.isNaN(A) || A !== Math.floor(A)) return;
            const M = n.value.length,
                O = r.value;
            A < 0 ? r.value = i.loop ? M - 1 : 0 : A >= M ? r.value = i.loop ? 0 : M - 1 : r.value = A, O === r.value && x(O), G()
        }
        ...
        function w(A, M) {
            ...
            const Ei = M + 1,
                At = M - 1,
                xi = ot - 1,
                fs = Me[xi].states.active,
                hs = Me[0].states.active,
                ps = (W = (O = Me[Ei]) == null ? void 0 : O.states) == null ? void 0 : W.active,
                vs = (Ge = (Ae = Me[At]) == null ? void 0 : Ae.states) == null ? void 0 : Ge.active;
            return M === xi && hs || ps ? "left" : M === 0 && fs || vs ? "right" : !1
        }
        ...
        function F(A) {
            m(p) || n.value.forEach((M, O) => {
                A === w(M, O) && (M.states.hover = !0)
            })
        }

        function T() {
            m(p) || n.value.forEach(A => {
                A.states.hover = !1
            })
        }
        ...
        return Be(() => {
            ...
            y(), u.value && B.value && B.value.stop()
        }), Ts(In, {
            root: u,
            isCardType: f,
            isVertical: p,
    ...
    Nc = ae({
        ...
        setup(i, {
            ...
            const n = i,
                ...
                w = vi("carousel"),
                _ = Le(() => {
                    const F = [w.b(), w.m(n.direction)];
                    return m(u) && F.push(w.m("card")), F
                }),
                S = Le(() => {
                    const F = [w.e("indicators"), w.em("indicators", n.direction)];
                    return m(a) && F.push(w.em("indicators", "labels")), (n.indicatorPosition === "outside" || m(u)) && F.push(w.em("indicators", "outside")), F
                });
            return e({
                setActiveItem: y,
                prev: E,
                ...
                ref: s,
                class: le(m(_)),
                onMouseenter: T[6] || (T[6] = rt((...k) => m(h) && m(h)(...k), ["stop"])),
                onMouseleave: T[7] || (T[7] = rt((...k) => m(v) && m(v)(...k), ["stop"]))
            }, [g("div", {
                class: le(m(w).e("container")),
                style: Oe({
                    height: F.height
                })
            }, [m(r) ? (P(), Re(te, {
                ...
                default: j(() => [fe(g("button", {
                    type: "button",
                    class: le([m(w).e("arrow"), m(w).em("arrow", "left")]),
                    onMouseenter: T[0] || (T[0] = k => m(d)("left")),
                    onMouseleave: T[1] || (T[1] = (...k) => m(f) && m(f)(...k)),
                    onClick: T[2] || (T[2] = rt(k => m(b)(m(o) - 1), ["stop"]))
                }, [N(m(Ui), null, {
                    default: j(() => [N(m(fc))]),
                    _: 1
                })], 34), [
                    [he, (F.arrow === "always" || m(l)) && (n.loop || m(o) > 0)]
                ])]),
                _: 1
            })) : X("v-if", !0), m(r) ? (P(), Re(te, {
                key: 1,
                ...
                default: j(() => [fe(g("button", {
                    type: "button",
                    class: le([m(w).e("arrow"), m(w).em("arrow", "right")]),
                    onMouseenter: T[3] || (T[3] = k => m(d)("right")),
                    onMouseleave: T[4] || (T[4] = (...k) => m(f) && m(f)(...k)),
                    onClick: T[5] || (T[5] = rt(k => m(b)(m(o) + 1), ["stop"]))
                }, [N(m(Ui), null, {
                    default: j(() => [N(m(Cc))]),
                    _: 1
                })], 34), [
                    [he, (F.arrow === "always" || m(l)) && (n.loop || m(o) < m(c).length - 1)]
                ])]),
                _: 1
            })) : X("v-if", !0), ui(F.$slots, "default")], 6), F.indicatorPosition !== "none" ? (P(), z("ul", {
                key: 0,
                class: le(m(S))
            }, [(P(!0), z(ce, null, we(m(c), (k, D) => (P(), z("li", {
                key: D,
                class: le([m(w).e("indicator"), m(w).em("indicator", F.direction), m(w).is("active", D === m(o))]),
                onMouseenter: I => m(x)(D),
                onClick: rt(I => m(p)(D), ["stop"])
            }, [g("button", {
                class: le(m(w).e("button"))
            }, [m(a) ? (P(), z("span", zc, Y(k.props.label), 1)) : X("v-if", !0)], 2)], 42, Ic))), 128))], 2)) : X("v-if", !0)], 34))
        }
    });
var Hc = mi(Nc, [
    ...
    Uc = (i, e) => {
        ...
        function h(b, x, w) {
            const _ = w - 1,
                ...
                F = x + 1,
                T = w / 2;
            return x === 0 && b === _ ? -1 : x === _ && b === 0 ? w : b < S && x - b >= T ? w + 1 : b > F && b - x >= T ? -2 : b
        }

        function v(b, x) {
            var w;
            const _ = ((w = t.root.value) == null ? void 0 : w.offsetWidth) || 0;
            return c.value ? _ * ((2 - s) * (b - x) + 1) / 4 : b < x ? -(1 + s) * _ / 4 : (3 + s) * _ / 4
        }

        function y(b, x, w) {
            const _ = t.root.value;
            return _ ? ((w ? _.offsetHeight : _.offsetWidth) || 0) * (b - x) : 0
        }
        const E = (b, x, w) => {
            var _;
            const S = m(f),
                F = (_ = t.items.value.length) != null ? _ : Number.NaN,
                T = b === x;
            !S && !Mn(w) && (d.value = T || b === w), !T && F > 2 && t.loop && (b = h(b, x, F));
            const k = m(p);
            l.value = T, S ? (c.value = Math.round(Math.abs(b - x)) <= 1, r.value = v(b, x), a.value = m(l) ? 1 : s) : r.value = y(b, x, k), u.value = !0
        };

        function C() {
            if (t && m(f)) {
                const b = t.items.value.findIndex(({
                    uid: x
                }) => x === n.uid);
                t.setActiveItem(b)
            }
    ...
    qc = ae({
        ...
        setup(i) {
            const e = i,
                ...
                p = Le(() => {
                    const v = `${`translate${m(a)?"Y":"X"}`}(${m(l)}px)`,
                        y = `scale(${m(c)})`;
                    return {
                        transform: [v, y].join(" ")
                    }
                });
            return (h, v) => fe((P(), z("div", {
                class: le([m(t).e("item"), m(t).is("active", m(n)), m(t).is("in-stage", m(r)), m(t).is("hover", m(o)), m(t).is("animating", m(s)), {
                    [m(t).em("item", "card")]: m(u)
                }]),
                style: Oe(m(p)),
                onClick: v[0] || (v[0] = (...y) => m(f) && m(f)(...y))
            }, [m(u) ? fe((P(), z("div", {
                key: 0,
                class: le(m(t).e("mask"))
            }, null, 2)), [
                [he, !m(n)]
            ]) : X("v-if", !0), ui(h.$slots, "default")], 6)), [
                [he, m(d)]
            ])
        }
    });
    ...
    m1 = ae({
        ...
        setup(i) {
            ...
            let n = q([{
                ...
                s = q([]);
            s.push(...tt(n, s, e.TwoParticlesLogo)), _e(() => e.TwoParticlesLogo, (p, h) => {
                s.push(...tt(n, s, p)), e.TwoParticlesLogo && t.value.clearCanvas()
            });
            const o = q([{
                imgURL: ""
            }, {
            ...
            for (let p = 0; p < o.length; p++) {
                let h = new URL(Object.assign({
                    "../../assets/img/Two/banner_1.jpg": Xc,
                    "../../assets/img/Two/banner_2.jpg": Yc,
                    "../../assets/img/Two/banner_3.jpg": Zc,
                    "../../assets/img/Two/banner_4.jpg": Kc,
                    "../../assets/img/Two/banner_5.jpg": Jc
                })[`../../assets/img/Two/banner_${p+1}.jpg`], self.location).href;
                o[p].imgURL = h
            }
            const r = q({
                    width: 400,
                ...
                a = q([{
                    ...
                    Date: "2022 - 12 - 17",
                    Cate: "\u6D3B\u52A8",
                    Title: "[\u6D3B\u52A8\u9884\u544A]\u8DE8\u5E74\u7EAA\u5FF5\u9650\u65F6\u6D3B\u52A8\u5373\u5C06\u5F00\u542F"
                }, {
                    id: 2,
                    Date: "2022 - 12 - 17",
                    Cate: "\u6D3B\u52A8",
                    Title: "[\u8DE8\u5E74\u6B22\u5E86\u5BFB\u8BBF]\u3010\u8DE8\u5E74\u6B22\u5E86\u76F8\u9022\u3011\u9650\u65F6\u5BFB\u8BBF\u5373\u5C06\u5F00\u542F"
                }, {
                    id: 3,
                    Date: "2022 - 12 - 15",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]\u5173\u4E8E\u5E72\u5458\u3010\u7130\u5F71\u82C7\u8349\u3011\u6280\u80FD\u5F02\u5E38\u8BF4\u660E"
                }, {
                    id: 4,
                    Date: "2022 - 12 - 08",
                    Cate: "\u6D3B\u52A8",
                    Title: "[\u6D3B\u52A8\u9884\u544A]SideStory\u3010\u7167\u6211\u4EE5\u706B\u3011\u9650\u65F6\u6D3B\u52A8\u5373\u5C06\u5F00\u542F"
                }, {
                    id: 5,
                    Date: "2022 - 12 - 14",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]12\u670815\u65E510:00\u7248\u672C\u66F4\u65B0\u505C\u670D\u7EF4\u62A4\u516C\u544A"
                }, {
                    id: 6,
                    Date: "2022 - 12 - 14",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]12\u670814\u65E5\u5C01\u7981\u5904\u7406\u516C\u793A"
                }]),
                l = q([{
                    id: 1,
                    Date: "2022 - 12 - 15",
                    ...
                    Date: "2022 - 12 - 14",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]12\u670815\u65E510:00\u7248\u672C\u66F4\u65B0\u505C\u673A\u7EF4\u62A4\u516C\u544A"
                }, {
                    id: 3,
                    Date: "2022 - 12 - 14",
                    Cate: "\u516C\u544A",
                    ...
                    Date: "2022 - 12 - 07",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]12\u670807\u65E5\u5C01\u7981\u5904\u7406\u516C\u793A"
                }, {
                    id: 5,
                    Date: "2022 - 12 - 05",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]12\u670806\u65E5\u505C\u670D\u516C\u544A"
                }, {
                    id: 6,
                    Date: "2022 - 12 - 01",
                    Cate: "\u516C\u544A",
                    Title: "[\u660E\u65E5\u65B9\u821F]12\u670801\u65E516:00\u95EA\u65AD\u66F4\u65B0\u516C\u544A"
                }]),
                u = q([{
                    id: 1,
                    Date: "2022 - 12 - 17",
                    ...
                    Date: "2022 - 11 - 25",
                    Cate: "\u6D3B\u52A8",
                    Title: "[\u6D3B\u52A8\u9884\u544A]SideStory\u3010\u98CE\u96EA\u8FC7\u5883\u3011\u590D\u523B\u5373\u5C06\u5F00\u542F"
                }, {
                    id: 5,
                    Date: "2022 - 10 - 23",
                    Cate: "\u6D3B\u52A8",
                    Title: "[\u6D3B\u52A8\u9884\u544A]\u4E3B\u7EBF\u52A8\u753B\u300A\u660E\u65E5\u65B9\u821F\uFF1A\u9ECE\u660E\u524D\u594F\u300B\u5F00\u64AD\u7EAA\u5FF5\u6D3B\u52A8\u5373\u5C06\u5F00\u542F"
                }, {
                    id: 6,
                    Date: "2022 - 10 - 23",
                    Cate: "\u6D3B\u52A8",
                    Title: "[\u9650\u5B9A\u5BFB\u8BBF-\u5E86\u5178]\u3010\u65A9\u8346\u8F9F\u8DEF\u3011\u9650\u65F6\u5BFB\u8BBF\u5373\u5C06\u5F00\u542F"
                }]),
                c = q([{
                    id: 1,
                    Date: "2022 - 12 - 01",
                    Cate: "\u65B0\u95FB",
                    Title: "\u300A\u660E\u65E5\u65B9\u821F\u300B\u5236\u4F5C\u7EC4\u901A\u8BAF#25\u671F"
                }, {
                    id: 2,
                    Date: "2022 - 10 - 05",
                    Cate: "\u65B0\u95FB",
                    Title: "\u300A\u660E\u65E5\u65B9\u821F\u300B\u5236\u4F5C\u7EC4\u901A\u8BAF#24\u671F"
                }, {
                    id: 3,
                    Date: "2022 - 09 - 13",
                    Cate: "\u65B0\u95FB",
                    Title: "\u300A\u660E\u65E5\u65B9\u821F\u300B\u5236\u4F5C\u7EC4\u901A\u8BAF#23\u671F"
                }, {
                    id: 4,
                    Date: "2022 - 08 - 26",
                    Cate: "\u65B0\u95FB",
                    Title: "\u300A\u660E\u65E5\u65B9\u821F\u300B\u5236\u4F5C\u7EC4\u901A\u8BAF#22\u671F"
                }, {
                    id: 5,
                    Date: "2022 - 07 - 28",
                    Cate: "\u65B0\u95FB",
                    Title: "\u300A\u660E\u65E5\u65B9\u821F\u300B\u5236\u4F5C\u7EC4\u901A\u8BAF#21\u671F"
                }, {
                    id: 6,
                    Date: "2022 - 06 - 22",
                    Cate: "\u65B0\u95FB",
                    Title: "\u300A\u660E\u65E5\u65B9\u821F\u300B\u5236\u4F5C\u7EC4\u901A\u8BAF#20\u671F"
                }]),
                d = q([{
                    id: 0,
                    name: "\u6700\u65B0",
            ...
            return (p, h) => {
                const v = Wc,
                    y = Gc,
                    E = ci;
                return P(), z("div", e1, [g("div", t1, [g("div", i1, [(P(!0), z(ce, null, we(m(d), C => (P(), z("ol", {
                    class: "articleList",
                    key: C.id,
                    "data-cursor": "pointer"
                }, [g("li", {
                    class: le(["acticleItem", C.active ? "active" : ""]),
                    onClick: b => f(C, m(d)),
                    "data-cursor": "pointer",
                    ref_for: !0,
                    ref: "articleOl"
                }, Y(C.name), 11, n1)]))), 128))]), g("div", s1, [g("div", o1, [N(y, {
                    trigger: "click",
                    height: "16rem",
                    loop: "",
                    interval: 4e3,
                    ...
                    default: j(() => [(P(!0), z(ce, null, we(m(o), C => (P(), Re(v, {
                        key: C
                    }, {
                        default: j(() => [g("img", {
                            src: C.imgURL
                    ...
                    _: 1
                })])]), g("div", a1, [g("div", l1, [(P(!0), z(ce, null, we(m(d), C => (P(), z(ce, {
                    key: C.id
                }, [C.active ? (P(), z("ol", u1, [(P(!0), z(ce, null, we(C.articleobj, b => (P(), z("li", {
                    class: le(["articleItem", b.id === 6 ? "articleItemNo" : ""]),
                    key: b.id,
                    "data-cursor": "pointer"
                }, [g("a", c1, [g("span", d1, Y(b.Date), 1), g("span", f1, Y(b.Cate), 1), g("h1", h1, Y(b.Title), 1)])], 2))), 128))])) : X("", !0)], 64))), 128))]), p1])]), g("div", v1, [N(E, {
                    canvasRect: m(r),
                    logos: m(s),
                    ParticlesBoolean: !0,
                    ref_key: "LiziChild",
                    ref: t
                }, null, 8, ["canvasRect", "logos"])])])
            }
        }
    });
const g1 = Ce(m1, [
    ["__scopeId", "data-v-7238e6f3"]
]);
...
const y1 = C1(),
    Rn = y1,
    Je = i => new Promise(e => setTimeout(e, i)),
    ke = i => (je("data-v-563ab70f"), i = i(), qe(), i),
    b1 = {
        id: "section-home"
    },
    _1 = {
    ...
    S1 = {
        key: 0,
        class: "homeGridWapper"
    },
    T1 = ke(() => g("span", {
        class: "homeSpan"
    }, [g("span", null, "A"), g("span", null, "R"), g("span", null, "K")], -1)),
    B1 = ke(() => g("span", {
        class: "homeSpan"
    }, [g("span", null, "N"), g("span", null, "I"), g("span", null, "G")], -1)),
    k1 = ke(() => g("span", {
        class: "homeSpan"
    }, [g("span", null, "H"), g("span", null, "T"), g("span", null, "S")], -1)),
    D1 = [T1, B1, k1],
    A1 = {
        class: "homeDesc"
    },
    M1 = {
        class: "homeTitleWapper"
    },
    P1 = {
        key: 0,
        class: "homeTitle"
    ...
    z1 = {
        class: "homeWapperContainer"
    },
    R1 = {
        class: "homePV"
    },
    $1 = ["data-active", "onClick"],
    N1 = {
        class: "homePVInfo"
    },
    H1 = ke(() => g("svg", {
    ...
    od = ae({
        ...
        setup(i) {
            ...
            let e = new URL("" + new URL("https://pic3.zhimg.com/80/v2-877d3f1d4b679305ba4c5974187fdb3a_720w.webp", import.meta.url).href, self.location).href,
                t = new URL("" + new URL("https://pic1.zhimg.com/80/v2-88d2ec402c1018cec57110c295e85a30_720w.webp", import.meta.url).href, self.location).href,
                n = new URL("" + new URL("https://pic4.zhimg.com/80/v2-d9884f32711e19e80979eac58e943897_720w.webp", import.meta.url).href, self.location).href,
                s = new URL("" + new URL("https://pic3.zhimg.com/80/v2-d25c4f0b472b19779783fcb6312b6ebe_720w.webp", import.meta.url).href, self.location).href,
                o = q({
                    throttle: !0,
                    Down: !0,
                    DownBtn: !0,
            ...
            const r = async () => {
                o.throttle && (o.throttle = !1, o.DownBtn ? (o.DownBtn = !o.DownBtn, await Je(300), o.DownBtn2 = !o.DownBtn2, o.throttle = !0, o.Down = !o.Down) : (o.DownBtn2 = !o.DownBtn2, await await Je(300), o.DownBtn = !o.DownBtn, o.throttle = !0, o.Down = !o.Down))
            }, a = q([{
                id: "001",
                isActive: !0,
            ...
            let v = L("none"),
                y = L(0);
            const E = async (C, b, x) => {
                await Je(x), C.value = b
            };
            return Be(async () => {
                E(f, !0, 0), E(p, !0, 1e3), await Je(1500), Rn.emit("Nav", !0), await Je(500), v.value = "block", await Je(10), y.value = .15, E(h, !0, 200)
            }), (C, b) => (P(), z("div", b1, [g("div", _1, [g("div", w1, [N(te, {
                name: "homeDown"
            }, {
                default: j(() => [m(p) ? (P(), z("img", {
                    key: 0,
                    src: m(e)
                }, null, 8, E1)) : X("", !0)]),
                _: 1
            })]), g("div", x1, [g("div", F1, [N(te, {
                name: "homeDown"
            }, {
                default: j(() => [m(h) ? (P(), z("div", S1, D1)) : X("", !0)]),
                _: 1
            })]), g("div", A1, [g("div", M1, [N(te, {
                name: "homeTitle"
            }, {
                default: j(() => [m(f) ? (P(), z("div", P1, L1)) : X("", !0)]),
                _: 1
            })]), N(te, {
                name: "homeWapperLi"
            }, {
                default: j(() => [m(f) ? (P(), z("div", I1, [g("div", z1, [g("div", R1, [(P(!0), z(ce, null, we(m(a), (x, w) => (P(), z("ul", {
                    class: "homePVList",
                    key: x.id
                }, [g("li", {
                    "data-active": x.isActive,
                    onClick: _ => c(w),
                    "data-cursor": "pointer"
                }, Y(x.id), 9, $1)]))), 128)), g("div", N1, [g("span", null, Y(m(l).name), 1), g("span", null, Y(m(l).bgm), 1)])]), g("div", {
                    class: "PVBtn"
                }, [g("a", {
                    href: "javascript:void(0)",
                    onClick: d
                ...
                default: j(() => [m(p) ? (P(), z("div", j1, [N(et, {
                    name: "DownBtnHide"
                }, {
                    default: j(() => [m(o).DownBtn ? (P(), z("a", {
                        key: 0,
                        class: "DownBtnLoad1",
                        onClick: r,
                        "data-cursor": "pointer"
                        ...
                        class: "ImageDiv",
                        style: Oe({
                            backgroundImage: `url(${m(t)})`
                        }),
                        "data-cursor": "pointer"
                    }, null, 4), q1])) : X("", !0), m(o).DownBtn2 ? (P(), z("a", {
                        key: 1,
                        class: "DownBtnLoad2",
                        onClick: r,
                        "data-cursor": "pointer"
                    ...
                    default: j(() => [m(o).Down ? (P(), z("a", X1, Z1)) : X("", !0), m(o).Down ? (P(), z("a", K1, Q1)) : X("", !0), m(o).Down ? (P(), z("a", ed, nd)) : X("", !0)]),
                    _: 1
                })]), N(te, {
                    name: "DownHide"
                }, {
                    default: j(() => [m(o).Down ? (P(), z("div", sd, [g("a", {
                        href: "https://ak.hypergryph.com/news/2021059770.html",
                        style: Oe({
                            backgroundImage: `url(${m(n)})`
                        })
                    }, null, 4)])) : X("", !0)]),
                    _: 1
                })])) : X("", !0)]),
...
const rd = Ce(od, [
        ["__scopeId", "data-v-563ab70f"]
    ]),
    $n = i => (je("data-v-606e3b0f"), i = i(), qe(), i),
    ad = {
        id: "nav"
    },
    ld = {
    ...
    md = ae({
        ...
        setup(i, {
            ...
            const t = i,
                ...
                s = L(t.PagintionNum);
            _e(() => t.PagintionNum, (r, a) => {
                s.value = r
            });
            const o = (r, a) => {
                a.forEach(l => {
                    l.actions = !1
                }), a[r].actions = !0, s.value = r, t.swiper.slideTo(r, 500)
            };
            return e({
                NavList: n
            }), (r, a) => (P(), z("nav", ad, [g("div", ld, [g("ol", ud, [(P(!0), z(ce, null, we(m(n), l => (P(), z("li", {
                key: l.id,
                class: "navMenuItem",
                onClick: u => o(l.id, m(n)),
                "data-cursor": "pointer"
            }, [g("a", dd, [g("span", {
                class: le(l.actions ? "navItemTitle" : ""),
                "data-cursor": "pointer"
            }, Y(l.name), 3)])], 8, cd))), 128))])]), g("div", fd, [(P(!0), z(ce, null, we(m(n), l => (P(), Re(te, {
                key: l.id,
                name: "sectiontext"
            }, {
                default: j(() => [l.id == m(s) ? (P(), z("span", hd, [g("span", null, Y(l.sectiontext), 1)])) : X("", !0)]),
                _: 2
            }, 1024))), 128)), pd, vd])]))
        }
    });
const gd = Ce(md, [
    ["__scopeId", "data-v-606e3b0f"]
]);
const Cd = {},
    Nn = i => (je("data-v-5c9052ec"), i = i(), qe(), i),
    yd = {
        class: "mainHeader"
    },
    bd = Nn(() => g("div", {
...
class Fd {
    ...
    addEventListener(e, t) {
        var n;
        this.removeEventListener(e, t), this._listeners.get(e) || this._listeners.set(e, []), (n = this._listeners.get(e)) === null || n === void 0 || n.push(t)
    }
    dispatchEvent(e, t) {
        var n;
        (n = this._listeners.get(e)) === null || n === void 0 || n.forEach(s => s(t))
    }
    hasEventListener(e) {
...
class me {
    constructor(e, t, n) {
        if (typeof e != "number" && e) {
            ...
            const s = e;
            this.z = s.z ? s.z : 0
        } else if (e !== void 0 && t !== void 0) this.x = e, this.y = t, this.z = n != null ? n : 0;
    ...
    rotate(e) {
        return me.create(this.x * Math.cos(e) - this.y * Math.sin(e), this.x * Math.sin(e) + this.y * Math.cos(e), 0)
    }
    setTo(e) {
        this.x = e.x, this.y = e.y;
        const t = e;
...
function Hn(i) {
    var e;
    const t = n => n;
    return (e = Td.get(i)) !== null && e !== void 0 ? e : t
}

function U() {
    return Te(Sd(), 0, 1 - 1e-16)
}
...
function Vn(i) {
    var e, t, n, s;
    return {
        x: ((t = (e = i.position) === null || e === void 0 ? void 0 : e.x) !== null && t !== void 0 ? t : U() * 100) * i.size.width / 100,
        y: ((s = (n = i.position) === null || n === void 0 ? void 0 : n.y) !== null && s !== void 0 ? s : U() * 100) * i.size.height / 100
    }
}
...
function Un(i) {
    var e, t;
    const n = {
        x: ((e = i.position) === null || e === void 0 ? void 0 : e.x) !== void 0 ? R(i.position.x) : void 0,
        y: ((t = i.position) === null || t === void 0 ? void 0 : t.y) !== void 0 ? R(i.position.y) : void 0
    };
    return Vn({
        size: i.size,
        position: n
...
function Ad(i) {
    var e, t, n, s;
    return {
        x: (t = (e = i.position) === null || e === void 0 ? void 0 : e.x) !== null && t !== void 0 ? t : U() * i.size.width,
        y: (s = (n = i.position) === null || n === void 0 ? void 0 : n.y) !== null && s !== void 0 ? s : U() * i.size.height
    }
}
...
function Gi(i, e, t, n, s, o) {
    ...
    return e.min < n.min || e.min > n.max || e.max < n.min || e.max > n.max || (i.max >= t.min && i.max <= (t.max + t.min) / 2 && s > 0 || i.min <= t.max && i.min > (t.max + t.min) / 2 && s < 0) && (r.velocity = s * -o, r.bounced = !0), r
}
...
function Pd() {
    return !Ze() && typeof matchMedia < "u"
}

function qn(i) {
    if (!!Pd()) return matchMedia(i)
}

function Od() {
    return Ze() ? i => setTimeout(i) : i => (requestAnimationFrame || setTimeout)(i)
}

function Ld() {
    return Ze() ? i => clearTimeout(i) : i => (cancelAnimationFrame || clearTimeout)(i)
}
...
async function Id(i, e) {
    try {
        await document.fonts.load(`${e!=null?e:"400"} 36px '${i!=null?i:"Verdana"}'`)
    } catch {}
}

function Gn(i) {
    return Math.floor(U() * i.length)
}
...
function mt(i, e, t, n, s) {
    return zd(gt(i, n != null ? n : 0), e, t, s)
}

function zd(i, e, t, n) {
    let s = !0;
    return (!n || n === "bottom") && (s = i.top < e.height + t.x), s && (!n || n === "left") && (s = i.right > t.x), s && (!n || n === "right") && (s = i.left < e.width + t.y), s && (!n || n === "top") && (s = i.bottom > t.y), s
}
...
function ne(i, ...e) {
    for (const t of e) {
        ...
        n && (typeof i != "object" || !i || !Array.isArray(i)) ? i = [] : !n && (typeof i != "object" || !i || Array.isArray(i)) && (i = {});
        for (const s in t) {
...
function Wn(i, e) {
    if (!(!e || !i)) return Yn(i, t => Md(e, t.selectors))
}
...
function si(i) {
    return {
        ...
        mass: i.getMass(),
        velocity: i.velocity,
        factor: Z.create($e(i.options.bounce.horizontal), $e(i.options.bounce.vertical))
    }
}
...
function Xn(i, e) {
    const {
        x: t,
        y: n
    } = i.velocity.sub(e.velocity), [s, o] = [i.position, e.position], {
        dx: r,
        dy: a
    } = de(o, s);
    if (t * r + n * a < 0) return;
    const l = -Math.atan2(a, r),
        ...
        v = p.rotate(-l),
        y = h.rotate(-l);
    i.velocity.x = v.x * i.factor.x, i.velocity.y = v.y * i.factor.y, e.velocity.x = y.x * e.factor.x, e.velocity.y = y.y * e.factor.y
}
...
function $d(i, e) {
    const t = i.getPosition(),
        ...
        o = Gi({
            ...
            min: e.top,
            max: e.bottom
        }, i.velocity.x, $e(i.options.bounce.horizontal));
    o.bounced && (o.velocity !== void 0 && (i.velocity.x = o.velocity), o.position !== void 0 && (i.position.x = o.position));
    const r = Gi({
        min: s.top,
        max: s.bottom
    }, {
        ...
        min: e.left,
        max: e.right
    }, i.velocity.y, $e(i.options.bounce.vertical));
    r.bounced && (r.velocity !== void 0 && (i.velocity.y = r.velocity), r.position !== void 0 && (i.position.y = r.position))
}
...
function Nd(i) {
    ...
    const e = /^#?([a-f\d])([a-f\d])([a-f\d])([a-f\d])?$/i,
        t = i.replace(e, (o, r, a, l, u) => r + r + a + a + l + l + (u !== void 0 ? u + u : "")),
...
function xe(i, e, t = !0) {
    if (!i) return;
    const n = typeof i == "string" ? {
        value: i
    } : i;
    if (typeof n.value == "string") return Kn(n.value, e, t);
    if (n.value instanceof Array) return xe({
        value: vt(n.value, e, t)
    });
    for (const [, s] of Dt) {
...
function Kn(i, e, t = !0) {
    ...
    if (typeof n.value == "string") return n.value === Ft ? Qn() : Hd(n.value);
    if (n.value instanceof Array) return Kn({
        value: vt(n.value, e, t)
    });
    for (const [, s] of Dt) {
...
function Jn(i) {
    ...
    return s !== o && (r.s = r.l < .5 ? (s - o) / (s + o) : (s - o) / (2 - s - o), r.h = e === s ? (t - n) / (s - o) : r.h = t === s ? 2 + (n - e) / (s - o) : 4 + (e - t) / (s - o)), r.l *= 100, r.s *= 100, r.h *= 60, r.h < 0 && (r.h += 360), r.h >= 360 && (r.h -= 360), r
}
...
function it(i) {
    ...
    if (!t.s) e.b = t.l, e.g = t.l, e.r = t.l;
        ...
        const n = t.l < .5 ? t.l * (1 + t.s) : t.l + t.s - t.l * t.s,
            s = 2 * t.l - n;
        e.r = Ht(s, n, t.h + 1 / 3), e.g = Ht(s, n, t.h), e.b = Ht(s, n, t.h - 1 / 3)
    }
...
function yi(i, e, t, n) {
    let s = i,
        o = e;
    return s.r === void 0 && (s = it(i)), o.r === void 0 && (o = it(e)), {
        b: Nt(s.b, o.b, t, n),
        g: Nt(s.g, o.g, t, n),
        r: Nt(s.r, o.r, t, n)
    }
...
function oi(i, e, t) {
    ...
    if (t === Ft) return Qn();
    if (t === wt) {
        const o = (n = i.getFillColor()) !== null && n !== void 0 ? n : i.getStrokeColor(),
            r = (s = e == null ? void 0 : e.getFillColor()) !== null && s !== void 0 ? s : e == null ? void 0 : e.getStrokeColor();
        if (o && r && e) return yi(o, r, i.getRadius(), e.getRadius()); {
            const a = o != null ? o : r;
            if (a) return it(a)
        }
    } else return t
...
function Vt(i, e, t) {
    i.enable = e.enable, i.enable ? (i.velocity = R(e.speed) / 100 * t, i.decay = 1 - R(e.decay), i.status = 0, e.sync || (i.velocity *= U(), i.value *= U())) : i.velocity = 0
}
...
function Ud(i, e, t, n) {
    i.beginPath(), i.moveTo(e.x, e.y), i.lineTo(t.x, t.y), i.lineTo(n.x, n.y), i.closePath()
}

function jd(i, e, t) {
    i.fillStyle = t != null ? t : "rgba(0,0,0,0)", i.fillRect(0, 0, e.width, e.height)
}
...
function qd(i) {
    ...
    const {
        ...
        shadow: y,
        transform: E
    } = i, C = u.getPosition(), b = u.rotation + (u.pathRotation ? u.velocity.angle : 0), x = {
        sin: Math.sin(b),
        cos: Math.cos(b)
    }, w = {
        a: x.cos * ((e = E.a) !== null && e !== void 0 ? e : 1),
        b: x.sin * ((t = E.b) !== null && t !== void 0 ? t : 1),
        c: -x.sin * ((n = E.c) !== null && n !== void 0 ? n : 1),
        d: x.cos * ((s = E.d) !== null && s !== void 0 ? s : 1)
    };
    l.setTransform(w.a, w.b, w.c, w.d, C.x, C.y), l.beginPath(), f && (l.globalCompositeOperation = p);
    const _ = u.shadowColor;
    y.enable && _ && (l.shadowBlur = y.blur, l.shadowColor = ze(_), l.shadowOffsetX = y.offset.x, l.shadowOffsetY = y.offset.y), d.fill && (l.fillStyle = d.fill);
    const S = u.stroke;
    l.lineWidth = (o = u.strokeWidth) !== null && o !== void 0 ? o : 0, d.stroke && (l.strokeStyle = d.stroke), Gd(a, l, u, h, v, c), ((r = S == null ? void 0 : S.width) !== null && r !== void 0 ? r : 0) > 0 && l.stroke(), u.close && l.closePath(), u.fill && l.fill(), Wd(a, l, u, h, v, c), l.globalCompositeOperation = "source-over", l.setTransform(1, 0, 0, 1, 0, 0)
}

function Gd(i, e, t, n, s, o) {
    if (!t.shape) return;
    const r = i.drawers.get(t.shape);
    !r || r.draw(e, t, n, s, o, i.retina.pixelRatio)
}

function Wd(i, e, t, n, s, o) {
    if (!t.shape) return;
    const r = i.drawers.get(t.shape);
    !(r != null && r.afterEffect) || r.afterEffect(e, t, n, s, o, i.retina.pixelRatio)
}
...
class r0 {
    constructor(e) {
        this.container = e, this.size = {
            height: 0,
            width: 0
        }, this._context = null, this._generated = !1, this._preDrawUpdaters = [], this._postDrawUpdaters = [], this._resizePlugins = [], this._colorPlugins = [], this._mutationObserver = !Ze() && typeof MutationObserver < "u" ? new MutationObserver(t => {
            for (const n of t) n.type === "attributes" && n.attributeName === "style" && this._repairStyle()
        }) : void 0
    }
    get _fullScreen() {
    ...
    clear() {
        ...
        e.backgroundMask.enable ? this.paint() : t.enable && t.length > 0 && this._trailFillColor ? this._paintBase(ze(this._trailFillColor, 1 / t.length)) : this.draw(n => {
            Ut(n, this.size)
        })
    }
    destroy() {
        var e, t;
        (e = this._mutationObserver) === null || e === void 0 || e.disconnect(), this._generated ? (t = this.element) === null || t === void 0 || t.remove() : this._resetOriginalStyle(), this.draw(n => {
            Ut(n, this.size)
    ...
    drawParticle(e, t) {
        ...
        a || (a = o), l || (l = r), !(!a && !l) && this.draw(u => {
            var c, d, f, p, h;
            const v = this.container.actualOptions,
                y = e.options.zIndex,
                E = (1 - e.zIndexFactor) ** y.opacityRate,
                C = (f = (c = e.bubble.opacity) !== null && c !== void 0 ? c : (d = e.opacity) === null || d === void 0 ? void 0 : d.value) !== null && f !== void 0 ? f : 1,
                b = (h = (p = e.stroke) === null || p === void 0 ? void 0 : p.opacity) !== null && h !== void 0 ? h : C,
                x = C * E,
                w = b * E,
                _ = {},
                S = {
                    fill: a ? nt(a, x) : void 0
                };
            S.stroke = l ? nt(l, w) : S.fill, this._applyPreDrawUpdaters(u, e, s, x, S, _), qd({
    ...
    init() {
        var e;
        this.resize(), this._initStyle(), this._initCover(), this._initTrail(), this.initBackground(), this.element && ((e = this._mutationObserver) === null || e === void 0 || e.observe(this.element, {
            attributes: !0
    ...
    initBackground() {
        ...
        if (!!s) {
            if (t.color) {
                const o = xe(t.color);
                s.backgroundColor = o ? ze(o, t.opacity) : ""
    ...
    loadCanvas(e) {
        var t, n;
        this._generated && ((t = this.element) === null || t === void 0 || t.remove()), this._generated = e.dataset && ct in e.dataset ? e.dataset[ct] === "true" : this._generated, this.element = e, this.element.ariaHidden = "true", this._originalStyle = ne({}, this.element.style), this.size.height = e.offsetHeight, this.size.width = e.offsetWidth, this._context = this.element.getContext("2d"), (n = this._mutationObserver) === null || n === void 0 || n.observe(this.element, {
            attributes: !0
    ...
    paint() {
        const e = this.container.actualOptions;
        this.draw(t => {
            e.backgroundMask.enable && e.backgroundMask.cover ? (Ut(t, this.size), this._paintBase(this._coverColorStyle)) : this._paintBase()
        })
    }
    resize() {
        ...
        this.element.width = n.width = this.element.offsetWidth * t, this.element.height = n.height = this.element.offsetHeight * t, this.container.started && (this.resizeFactor = {
    ...
    _applyPostDrawUpdaters(e) {
        var t;
        for (const n of this._postDrawUpdaters)(t = n.afterDraw) === null || t === void 0 || t.call(n, e)
    }
    ...
    _getPluginParticleColors(e) {
        ...
        for (const s of this._colorPlugins)
            if (!t && s.particleFillColor && (t = Ue(s.particleFillColor(e))), !n && s.particleStrokeColor && (n = Ue(s.particleStrokeColor(e))), t && n) break;
        return [t, n]
    }
    _initCover() {
        const e = this.container.actualOptions,
        ...
        if (s) {
            ...
            this._coverColorStyle = ze(o, o.a)
        }
    }
    _initStyle() {
        ...
        if (!!e) {
            this._fullScreen ? (this._originalStyle = ne({}, e.style), this._setFullScreenStyle()) : this._resetOriginalStyle();
    ...
    _repairStyle() {
        ...
        !n || ((e = this._mutationObserver) === null || e === void 0 || e.disconnect(), this._initStyle(), this.initBackground(), (t = this._mutationObserver) === null || t === void 0 || t.observe(n, {
            attributes: !0
        }))
    }
    _resetOriginalStyle() {
...
function be(i, e, t, n, s) {
    if (n) {
        ...
        typeof s == "boolean" ? o.capture = s : s !== void 0 && (o = s), i.addEventListener(e, t, o)
    } else {
        const o = s;
...
class a0 {
    ...
    handleThemeChange(e) {
        const t = e,
            n = t.matches ? this.container.options.defaultThemes.dark : this.container.options.defaultThemes.light,
    ...
    manageListeners(e) {
        ...
        let r = ri;
        if (o === "window") n.interactivity.element = window, r = t0;
        else if (o === "parent" && n.canvas.element) {
            const c = n.canvas.element;
            n.interactivity.element = (t = c.parentElement) !== null && t !== void 0 ? t : c.parentNode
        } else n.interactivity.element = n.canvas.element;
        const a = qn("(prefers-color-scheme: dark)");
        a && (a.addEventListener !== void 0 ? be(a, "change", this.themeChangeHandler, e) : a.addListener !== void 0 && (e ? a.addListener(this.oldThemeChangeHandler) : a.removeListener(this.oldThemeChangeHandler)));
        const l = n.interactivity.element;
        if (!l) return;
        const u = l;
        (s.interactivity.events.onHover.enable || s.interactivity.events.onClick.enable) && (be(l, Ke, this.mouseMoveHandler, e), be(l, Qd, this.touchStartHandler, e), be(l, e0, this.touchMoveHandler, e), s.interactivity.events.onClick.enable ? (be(l, Xi, this.touchEndClickHandler, e), be(l, Jd, this.mouseUpHandler, e), be(l, Kd, this.mouseDownHandler, e)) : be(l, Xi, this.touchEndHandler, e), be(l, r, this.mouseLeaveHandler, e), be(l, i0, this.touchCancelHandler, e)), n.canvas.element && (n.canvas.element.style.pointerEvents = u === n.canvas.element ? "initial" : "none"), s.interactivity.events.resize && (typeof ResizeObserver < "u" ? this.resizeObserver && !e ? (n.canvas.element && this.resizeObserver.unobserve(n.canvas.element), this.resizeObserver.disconnect(), delete this.resizeObserver) : !this.resizeObserver && e && n.canvas.element && (this.resizeObserver = new ResizeObserver(c => {
            !c.find(f => f.target === n.canvas.element) || this.handleWindowResize()
        }), this.resizeObserver.observe(n.canvas.element)) : be(window, n0, this.resizeHandler, e)), document && be(document, s0, this.visibilityChangeHandler, e, !1)
    }
    mouseDown() {
    ...
    mouseTouchFinish() {
        ...
        if (!e) return;
        const t = e.mouse;
        delete t.position, delete t.clickPosition, delete t.downPosition, e.status = ri, t.inside = !1, t.clicking = !1
    }
    mouseTouchMove(e) {
        var t, n, s, o, r, a, l;
        const u = this.container,
            c = u.actualOptions;
        if (!(!((t = u.interactivity) === null || t === void 0) && t.element)) return;
        ...
        if (e.type.startsWith("pointer")) {
            ...
            if (u.interactivity.element === window) {
                ...
                if (v && y && E) {
                    ...
                    d = {
                        x: h.offsetX + 2 * C.left - (b.left + x.left),
                        y: h.offsetY + 2 * C.top - (b.top + x.top)
                    }
                } else d = {
                    x: (n = h.offsetX) !== null && n !== void 0 ? n : h.clientX,
                    y: (s = h.offsetY) !== null && s !== void 0 ? s : h.clientY
                }
            } else h.target === u.canvas.element && (d = {
            ...
            const h = e,
                v = h.touches[h.touches.length - 1],
                y = f == null ? void 0 : f.getBoundingClientRect();
            d = {
                x: v.clientX - ((a = y == null ? void 0 : y.left) !== null && a !== void 0 ? a : 0),
                y: v.clientY - ((l = y == null ? void 0 : y.top) !== null && l !== void 0 ? l : 0)
            }
        }
        const p = u.retina.pixelRatio;
        d && (d.x *= p, d.y *= p), u.interactivity.mouse.position = d, u.interactivity.status = Ke
    }
}

function l0(i, e = 60, t = !1) {
    return {
        value: i,
        factor: t ? 60 / e : 60 * i / 1e3
    }
}
class u0 {
    constructor(e) {
    ...
    async nextFrame(e) {
        ...
        try {
            const n = this.container;
            if (!n.smooth && n.lastFrameTime !== void 0 && e < n.lastFrameTime + 1e3 / n.fpsLimit) {
                n.draw(!1);
                return
            }(t = n.lastFrameTime) !== null && t !== void 0 || (n.lastFrameTime = e);
            const s = l0(e - n.lastFrameTime, n.fpsLimit, n.smooth);
            if (n.lifeTime += s.value, n.lastFrameTime = e, s.value > 1e3) {
                n.draw(!1);
                return
            }
            if (await n.particles.draw(s), n.duration > 0 && n.lifeTime > n.duration) {
                n.destroy();
                return
            }
...
class ie {
    ...
    static create(e, t) {
        const n = new ie;
        return n.load(e), t !== void 0 && (typeof t == "string" || t instanceof Array ? n.load({
            value: t
        }) : n.load(t)), n
    }
    load(e) {
...
class c0 {
    constructor() {
        this.color = new ie, this.color.value = "", this.image = "", this.position = "", this.repeat = "", this.size = "", this.opacity = 1
    }
    load(e) {
        !e || (e.color !== void 0 && (this.color = ie.create(this.color, e.color)), e.image !== void 0 && (this.image = e.image), e.position !== void 0 && (this.position = e.position), e.repeat !== void 0 && (this.repeat = e.repeat), e.size !== void 0 && (this.size = e.size), e.opacity !== void 0 && (this.opacity = e.opacity))
    }
}
class d0 {
    constructor() {
    ...
    load(e) {
        !e || (e.color !== void 0 && (this.color = ie.create(this.color, e.color)), e.opacity !== void 0 && (this.opacity = e.opacity))
    }
}
class f0 {
    constructor() {
        this.composite = "destination-out", this.cover = new d0, this.enable = !1
    }
    load(e) {
        if (!!e) {
            if (e.composite !== void 0 && (this.composite = e.composite), e.cover !== void 0) {
                ...
                this.cover.load(t.color !== void 0 ? t : {
                    color: n
                })
            }
...
class Yi {
    ...
    load(e) {
        var t, n;
        if (!e) return;
        const s = (n = (t = e.ids) !== null && t !== void 0 ? t : e.elementId) !== null && n !== void 0 ? n : e.el;
...
class m0 {
    constructor() {
        this.enable = !1, this.mode = [], this.parallax = new v0
    }
    load(e) {
...
class g0 {
    constructor() {
        this.onClick = new p0, this.onDiv = new Yi, this.onHover = new m0, this.resize = !0
    }
    get onclick() {
        return this.onClick
    }
...
class C0 {
    ...
    load(e) {
        if (!!e && this._container) {
            ...
            if (t)
                for (const n of t) n.loadModeOptions && n.loadModeOptions(this, e)
        }
    }
}
class is {
    constructor(e, t) {
        this.detectsOn = "window", this.events = new g0, this.modes = new C0(e, t)
    }
    get detect_on() {
...
class b0 {
    ...
    load(e) {
        !e || (e.maxWidth !== void 0 && (this.maxWidth = e.maxWidth), e.mode !== void 0 && (e.mode === "screen" ? this.mode = "screen" : this.mode = "canvas"), e.options !== void 0 && (this.options = ne({}, e.options)))
    }
}
class _0 {
    constructor() {
...
class w0 {
    constructor() {
        this.name = "", this.default = new _0
    }
    load(e) {
        !e || (e.name !== void 0 && (this.name = e.name), this.default.load(e.default), e.options !== void 0 && (this.options = ne({}, e.options)))
    }
}
class jt {
    constructor() {
    ...
    load(e) {
        !e || (e.count !== void 0 && (this.count = H(e.count)), e.enable !== void 0 && (this.enable = e.enable), e.offset !== void 0 && (this.offset = H(e.offset)), e.speed !== void 0 && (this.speed = H(e.speed)), e.decay !== void 0 && (this.decay = H(e.decay)), e.sync !== void 0 && (this.sync = e.sync))
    }
}
class E0 {
    constructor() {
        this.h = new jt, this.s = new jt, this.l = new jt
    }
    load(e) {
...
class Fe {
    constructor() {
        this.random = new S0, this.value = 0
    }
    load(e) {
        !e || (typeof e.random == "boolean" ? this.random.enable = e.random : this.random.load(e.random), e.value !== void 0 && (this.value = H(e.value, this.random.enable ? this.random.minimumValue : void 0)))
    }
}
class Zi extends Fe {
    constructor() {
...
class T0 {
    constructor() {
        this.absorb = new x0, this.bounce = new ns, this.enable = !1, this.mode = "bounce", this.overlap = new F0
    }
    load(e) {
...
class B0 {
    ...
    load(e) {
        !e || (e.offset !== void 0 && (this.offset = H(e.offset)), e.value !== void 0 && (this.value = H(e.value)))
    }
}
class k0 {
    constructor() {
    ...
    load(e) {
        var t, n, s, o;
        if (!e) return;
        e.distance !== void 0 && (this.distance = H(e.distance)), e.enable !== void 0 && (this.enable = e.enable);
        const r = (n = (t = e.rotate) === null || t === void 0 ? void 0 : t.x) !== null && n !== void 0 ? n : e.rotateX;
...
class A0 {
    ...
    load(e) {
        !e || (e.acceleration !== void 0 && (this.acceleration = H(e.acceleration)), e.enable !== void 0 && (this.enable = e.enable), e.inverse !== void 0 && (this.inverse = e.inverse), e.maxSpeed !== void 0 && (this.maxSpeed = H(e.maxSpeed)))
    }
}
class M0 {
    constructor() {
        this.clamp = !0, this.delay = new Fe, this.enable = !1, this.options = {}
    }
    load(e) {
        !e || (e.clamp !== void 0 && (this.clamp = e.clamp), this.delay.load(e.delay), e.enable !== void 0 && (this.enable = e.enable), this.generator = e.generator, e.options && (this.options = ne(this.options, e.options)))
    }
}
class P0 {
    constructor() {
        this.enable = !1, this.length = 10, this.fillColor = new ie, this.fillColor.value = "#000000"
    }
    load(e) {
        !e || (e.enable !== void 0 && (this.enable = e.enable), this.fillColor = ie.create(this.fillColor, e.fillColor), e.length !== void 0 && (this.length = e.length))
    }
}
class O0 {
    constructor() {
    ...
    load(e) {
        var t, n, s, o;
        !e || (e.default !== void 0 && (this.default = e.default), this.bottom = (t = e.bottom) !== null && t !== void 0 ? t : e.default, this.left = (n = e.left) !== null && n !== void 0 ? n : e.default, this.right = (s = e.right) !== null && s !== void 0 ? s : e.default, this.top = (o = e.top) !== null && o !== void 0 ? o : e.default)
    }
}
class L0 {
    constructor() {
    ...
    load(e) {
        !e || (e.acceleration !== void 0 && (this.acceleration = H(e.acceleration)), e.enable !== void 0 && (this.enable = e.enable), this.position = e.position ? ne({}, e.position) : void 0)
    }
}
class I0 {
    constructor() {
        this.angle = new B0, this.attract = new k0, this.center = new D0, this.decay = 0, this.distance = {}, this.direction = "none", this.drift = 0, this.enable = !1, this.gravity = new A0, this.path = new M0, this.outModes = new O0, this.random = !1, this.size = !1, this.speed = 2, this.spin = new L0, this.straight = !1, this.trail = new P0, this.vibrate = !1, this.warp = !1
    }
    get bounce() {
    ...
    load(e) {
        var t, n, s;
        if (!e) return;
        this.angle.load(typeof e.angle == "number" ? {
            value: e.angle
        } : e.angle), this.attract.load(e.attract), this.center.load(e.center), e.decay !== void 0 && (this.decay = e.decay), e.direction !== void 0 && (this.direction = e.direction), e.distance !== void 0 && (this.distance = typeof e.distance == "number" ? {
            horizontal: e.distance,
            vertical: e.distance
        } : Object.assign({}, e.distance)), e.drift !== void 0 && (this.drift = H(e.drift)), e.enable !== void 0 && (this.enable = e.enable), this.gravity.load(e.gravity);
        const o = (n = (t = e.outModes) !== null && t !== void 0 ? t : e.outMode) !== null && n !== void 0 ? n : e.out_mode;
        o !== void 0 && (typeof o == "object" ? this.outModes.load(o) : this.outModes.load({
            default: o
        })), this.path.load((s = e.path) !== null && s !== void 0 ? s : e.noise), e.random !== void 0 && (this.random = e.random), e.size !== void 0 && (this.size = e.size), e.speed !== void 0 && (this.speed = H(e.speed)), this.spin.load(e.spin), e.straight !== void 0 && (this.straight = e.straight), this.trail.load(e.trail), e.vibrate !== void 0 && (this.vibrate = e.vibrate), e.warp !== void 0 && (this.warp = e.warp)
    }
}
class ss {
    constructor() {
    ...
    load(e) {
        !e || (e.count !== void 0 && (this.count = H(e.count)), e.enable !== void 0 && (this.enable = e.enable), e.speed !== void 0 && (this.speed = H(e.speed)), e.decay !== void 0 && (this.decay = H(e.decay)), e.sync !== void 0 && (this.sync = e.sync))
    }
}
class z0 extends ss {
    constructor() {
...
class R0 extends Fe {
    constructor() {
        super(), this.animation = new z0, this.random.minimumValue = .1, this.value = 1
    }
    get anim() {
    ...
    load(e) {
        ...
        n !== void 0 && (this.animation.load(n), this.value = H(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
    }
}
class $0 {
    constructor() {
...
class N0 {
    constructor() {
        this.density = new $0, this.limit = 0, this.value = 100
    }
    get max() {
        return this.limit
    }
...
class H0 {
    constructor() {
        this.blur = 0, this.color = new ie, this.enable = !1, this.offset = {
            x: 0,
            y: 0
        }, this.color.value = "#000"
    }
    load(e) {
        !e || (e.blur !== void 0 && (this.blur = e.blur), this.color = ie.create(this.color, e.color), e.enable !== void 0 && (this.enable = e.enable), e.offset !== void 0 && (e.offset.x !== void 0 && (this.offset.x = e.offset.x), e.offset.y !== void 0 && (this.offset.y = e.offset.y)))
    }
}
const qt = "character",
    Gt = "char",
...
class V0 {
    ...
    get character() {
        var e;
        return (e = this.options[qt]) !== null && e !== void 0 ? e : this.options[Gt]
    }
    set character(e) {
        this.options[Gt] = this.options[qt] = e
    }
    get custom() {
        return this.options
    }
    ...
    get image() {
        var e;
        return (e = this.options[Wt]) !== null && e !== void 0 ? e : this.options[Xt]
    }
    set image(e) {
    ...
    get polygon() {
        var e;
        return (e = this.options[Yt]) !== null && e !== void 0 ? e : this.options[Zt]
    }
    set polygon(e) {
    ...
    load(e) {
        ...
        if (o !== void 0)
            for (const r in o) {
                const a = o[r];
                a && (this.options[r] = ne((n = this.options[r]) !== null && n !== void 0 ? n : {}, a))
            }
        this.loadShape(e.character, qt, Gt, !0), this.loadShape(e.polygon, Yt, Zt, !1), this.loadShape((s = e.image) !== null && s !== void 0 ? s : e.images, Wt, Xt, !0), e.type !== void 0 && (this.type = e.type)
    }
    loadShape(e, t, n, s) {
        var o, r;
        if (!e) return;
        ...
        u && (this.options[t] = l), c && s && (this.options[n] = l), this.options[t] = ne((o = this.options[t]) !== null && o !== void 0 ? o : l, e), (!this.options[n] || s) && (this.options[n] = ne((r = this.options[n]) !== null && r !== void 0 ? r : l, e))
    }
}
class U0 extends ss {
    constructor() {
...
class j0 extends Fe {
    constructor() {
        super(), this.animation = new U0, this.random.minimumValue = 1, this.value = 3
    }
    get anim() {
        return this.animation
    }
...
class Ki {
    ...
    load(e) {
        !e || (e.color !== void 0 && (this.color = st.create(this.color, e.color)), e.width !== void 0 && (this.width = e.width), e.opacity !== void 0 && (this.opacity = e.opacity))
    }
}
class q0 extends Fe {
    constructor() {
...
class G0 {
    constructor(e, t) {
        this._engine = e, this._container = t, this.bounce = new ns, this.collisions = new T0, this.color = new st, this.color.value = "#fff", this.groups = {}, this.move = new I0, this.number = new N0, this.opacity = new R0, this.reduceDuplicates = !1, this.shadow = new H0, this.shape = new V0, this.size = new j0, this.stroke = new Ki, this.zIndex = new q0
    }
    load(e) {
        var t, n, s, o, r, a;
        if (!e) return;
        if (this.bounce.load(e.bounce), this.color.load(st.create(this.color, e.color)), e.groups !== void 0)
            for (const c in e.groups) {
                const d = e.groups[c];
                d !== void 0 && (this.groups[c] = ne((t = this.groups[c]) !== null && t !== void 0 ? t : {}, d))
            }
        ...
        const l = (s = (n = e.move) === null || n === void 0 ? void 0 : n.collisions) !== null && s !== void 0 ? s : (o = e.move) === null || o === void 0 ? void 0 : o.bounce;
        l !== void 0 && (this.collisions.enable = l), this.collisions.load(e.collisions), e.interactivity !== void 0 && (this.interactivity = ne({}, e.interactivity));
        const u = (r = e.stroke) !== null && r !== void 0 ? r : (a = e.shape) === null || a === void 0 ? void 0 : a.stroke;
        if (u && (this.stroke = J(u, c => {
                const d = new Ki;
                return d.load(c), d
            })), this._container) {
            const c = this._engine.plugins.updaters.get(this._container);
            if (c)
                for (const f of c) f.loadOptions && f.loadOptions(this, e);
            const d = this._engine.plugins.interactors.get(this._container);
            if (d)
                for (const f of d) f.loadParticlesOptions && f.loadParticlesOptions(this, e)
        }
    }
}
...
class W0 {
    constructor(e, t) {
        this._engine = e, this._container = t, this.autoPlay = !0, this.background = new c0, this.backgroundMask = new f0, this.defaultThemes = {}, this.delay = 0, this.fullScreen = new h0, this.detectRetina = !0, this.duration = 0, this.fpsLimit = 120, this.interactivity = new is(e, t), this.manualParticles = [], this.particles = bi(this._engine, this._container), this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !0, this.responsive = [], this.smooth = !1, this.style = {}, this.themes = [], this.zLayers = 100
    }
    get backgroundMode() {
    ...
    load(e) {
        var t, n, s, o, r;
        if (!e) return;
        e.preset !== void 0 && J(e.preset, d => this._importPreset(d)), e.autoPlay !== void 0 && (this.autoPlay = e.autoPlay), e.delay !== void 0 && (this.delay = H(e.delay));
        const a = (t = e.detectRetina) !== null && t !== void 0 ? t : e.retina_detect;
        a !== void 0 && (this.detectRetina = a), e.duration !== void 0 && (this.duration = H(e.duration));
        ...
        const u = (s = e.fullScreen) !== null && s !== void 0 ? s : e.backgroundMode;
        typeof u == "boolean" ? this.fullScreen.enable = u : this.fullScreen.load(u), this.backgroundMask.load(e.backgroundMask), this.interactivity.load(e.interactivity), e.manualParticles !== void 0 && (this.manualParticles = e.manualParticles.map(d => {
            const f = new y0;
            return f.load(d), f
        })), this.particles.load(e.particles), this.style = ne(this.style, e.style), this._engine.plugins.loadOptions(this, e), e.smooth !== void 0 && (this.smooth = e.smooth);
        const c = this._engine.plugins.interactors.get(this._container);
        if (c)
            for (const d of c) d.loadOptions && d.loadOptions(this, e);
        if (e.responsive !== void 0)
            for (const d of e.responsive) {
                const f = new b0;
                f.load(d), this.responsive.push(f)
            }
        if (this.responsive.sort((d, f) => d.maxWidth - f.maxWidth), e.themes !== void 0)
    ...
    setTheme(e) {
        if (e) {
            ...
            const t = qn("(prefers-color-scheme: dark)"),
                n = t && t.matches,
    ...
    _findDefaultTheme(e) {
        var t;
        return (t = this.themes.find(n => n.default.value && n.default.mode === e)) !== null && t !== void 0 ? t : this.themes.find(n => n.default.value && n.default.mode === "any")
    }
    _importPreset(e) {
...
class X0 {
    ...
    async externalInteract(e) {
        for (const t of this._externalInteractors) t.isEnabled() && await t.interact(e)
    }
    handleClickMode(e) {
        for (const t of this._externalInteractors) t.handleClickMode && t.handleClickMode(e)
    }
    init() {
    ...
    async particlesInteract(e, t) {
        ...
        for (const n of this._particleInteractors) n.isEnabled(e) && await n.interact(e, t)
    }
    async reset(e) {
        for (const t of this._externalInteractors) t.isEnabled() && await t.reset(e);
        for (const t of this._particleInteractors) t.isEnabled(e) && await t.reset(e)
    }
}
const Ji = i => {
    !K(i.outMode, i.checkModes) || (i.coord > i.maxCoord - i.radius * 2 ? i.setCb(-i.radius) : i.coord < i.radius * 2 && i.setCb(i.radius))
};
class Y0 {
    ...
    destroy(e) {
        if (!(this.unbreakable || this.destroyed)) {
            ...
            for (const [, t] of this.container.plugins) t.particleDestroyed && t.particleDestroyed(this, e);
            for (const t of this.container.particles.updaters) t.particleDestroyed && t.particleDestroyed(this, e)
        }
    }
    draw(e) {
        const t = this.container;
    ...
    getFillColor() {
        var e, t;
        const n = (e = this.bubble.color) !== null && e !== void 0 ? e : Wi(this.color);
        if (n && this.roll && (this.backColor || this.roll.alter)) {
            ...
            if (Math.floor((((t = this.roll.angle) !== null && t !== void 0 ? t : 0) + o) / (Math.PI / s)) % 2) {
                ...
                if (this.roll.alter) return Zd(n, this.roll.alter.type, this.roll.alter.value)
            }
        }
        return n
    }
    ...
    getStrokeColor() {
        var e, t;
        return (t = (e = this.bubble.color) !== null && e !== void 0 ? e : Wi(this.strokeColor)) !== null && t !== void 0 ? t : this.getFillColor()
    }
    init(e, t, n, s) {
        ...
        this.shape = Ee(b, this.id, x);
        const w = C.shape;
        if (n && n.shape && n.shape.type) {
            const M = n.shape.type,
                O = Ee(M, this.id, x);
            O && (this.shape = O, w.load(n.shape))
        }
        this.shapeData = this._loadShapeData(w, x), C.load(n), C.load((o = this.shapeData) === null || o === void 0 ? void 0 : o.particles), this.interactivity = new is(v, h), this.interactivity.load(h.actualOptions.interactivity), this.interactivity.load(C.interactivity), this.fill = (a = (r = this.shapeData) === null || r === void 0 ? void 0 : r.fill) !== null && a !== void 0 ? a : this.fill, this.close = (u = (l = this.shapeData) === null || l === void 0 ? void 0 : l.close) !== null && u !== void 0 ? u : this.close, this.options = C;
        const _ = this.options.move.path;
        this.pathDelay = $e(_.delay) * 1e3, _.generator && (this.pathGenerator = this._engine.plugins.getPathGenerator(_.generator), this.pathGenerator && h.addPath(_.generator, this.pathGenerator) && this.pathGenerator.init(h));
        const S = R(this.options.zIndex.value);
        h.retina.initParticle(this);
        const F = this.options.size,
            T = F.value,
            k = F.animation;
        if (this.size = {
                enable: F.animation.enable,
                value: R(F.value) * h.retina.pixelRatio,
                max: Ie(T) * y,
                min: ft(T) * y,
                loops: 0,
                maxLoops: R(F.animation.count)
            }, k.enable) switch (this.size.status = 0, this.size.decay = 1 - R(k.decay), k.startValue) {
            case "min":
                this.size.value = this.size.min, this.size.status = 0;
                break;
            case "random":
                this.size.value = se(this.size) * y, this.size.status = U() >= .5 ? 0 : 1;
                break;
            case "max":
            default:
        ...
        this.bubble = {
            ...
            inRange: !1,
            factor: 1
        }, this.position = this._calcPosition(h, t, Te(S, 0, h.zLayers)), this.initialPosition = this.position.copy();
        const D = h.canvas.size,
            I = Object.assign({}, this.options.move.center),
            V = I.mode === "percent";
        switch (this.moveCenter = {
                x: I.x * (V ? D.width / 100 : 1),
                y: I.y * (V ? D.height / 100 : 1),
                radius: (c = this.options.move.center.radius) !== null && c !== void 0 ? c : 0,
                mode: (d = this.options.move.center.mode) !== null && d !== void 0 ? d : "percent"
            }, this.direction = Bd(this.options.move.direction, this.position, this.moveCenter), this.options.move.direction) {
            case "inside":
                this.outType = "inside";
                break;
            case "outside":
        ...
        this.initialVelocity = this._calculateVelocity(), this.velocity = this.initialVelocity.copy(), this.moveDecay = 1 - R(this.options.move.decay), this.offset = Z.origin;
        const G = h.particles;
        G.needsSort = G.needsSort || G.lastZIndex < this.position.z, G.lastZIndex = this.position.z, this.zIndexFactor = this.position.z / h.zLayers, this.sides = 24;
        let B = h.drawers.get(this.shape);
        B || (B = this._engine.plugins.getShapeDrawer(this.shape), B && h.drawers.set(this.shape, B)), B != null && B.loadShape && (B == null || B.loadShape(this));
        const A = B == null ? void 0 : B.getSidesCount;
        A && (this.sides = A(this)), this.spawning = !1, this.shadowColor = xe(this.options.shadow.color);
        for (const M of h.particles.updaters) M.init(this);
        for (const M of h.particles.movers)(f = M.init) === null || f === void 0 || f.call(M, this);
        B != null && B.particleInit && B.particleInit(h, this);
        for (const [, M] of h.plugins)(p = M.particleCreated) === null || p === void 0 || p.call(M, this)
    }
    isInsideCanvas() {
    ...
    reset() {
        var e;
        for (const t of this.container.particles.updaters)(e = t.reset) === null || e === void 0 || e.call(t, this)
    }
    _calcPosition(e, t, n, s = 0) {
        var o, r, a, l;
        for (const [, y] of e.plugins) {
            const E = y.particlePosition !== void 0 ? y.particlePosition(t, this) : void 0;
        ...
        return h((o = p.left) !== null && o !== void 0 ? o : p.default), h((r = p.right) !== null && r !== void 0 ? r : p.default), v((a = p.top) !== null && a !== void 0 ? a : p.default), v((l = p.bottom) !== null && l !== void 0 ? l : p.default), this._checkOverlap(d, s) ? this._calcPosition(e, void 0, n, s + 1) : d
    }
    _calculateVelocity() {
        const t = kd(this.direction).copy(),
            n = this.options.move;
        ...
        return n.straight || (t.angle += se(H(r.left, r.right))), n.random && typeof n.speed == "number" && (t.length *= U()), t
    }
    _checkOverlap(e, t = 0) {
        ...
        const r = o.retries;
        if (r >= 0 && t > r) throw new Error("Particle is overlapping and can't be placed");
        let a = !1;
    ...
    intersects(e) {
        ...
        if (n.radius !== void 0) {
            ...
            const l = t.size.width,
                u = t.size.height;
            return Math.pow(r.x - l, 2) + Math.pow(r.y - u, 2) <= a ** 2 || r.x <= a + l && r.y <= a + u || r.x <= l || r.y <= u
        }
        return !1
    }
}
...
class Xe {
    ...
    insert(e) {
        var t, n, s, o, r;
        return this.rectangle.contains(e.position) ? this._points.length < this.capacity ? (this._points.push(e), !0) : (this._divided || this.subdivide(), (r = ((t = this._NE) === null || t === void 0 ? void 0 : t.insert(e)) || ((n = this._NW) === null || n === void 0 ? void 0 : n.insert(e)) || ((s = this._SE) === null || s === void 0 ? void 0 : s.insert(e)) || ((o = this._SW) === null || o === void 0 ? void 0 : o.insert(e))) !== null && r !== void 0 ? r : !1) : !1
    }
    query(e, t, n) {
        var s, o, r, a;
        const l = n != null ? n : [];
        if (!e.intersects(this.rectangle)) return [];
        for (const u of this._points) !e.contains(u.position) && oe(e.position, u.position) > u.particle.getRadius() && (!t || t(u.particle)) || l.push(u.particle);
    ...
    subdivide() {
        const e = this.rectangle.position.x,
            ...
            o = this.capacity;
        this._NE = new Xe(new pe(e, t, n / 2, s / 2), o), this._NW = new Xe(new pe(e + n / 2, t, n / 2, s / 2), o), this._SE = new Xe(new pe(e, t + s / 2, n / 2, s / 2), o), this._SW = new Xe(new pe(e + n / 2, t + s / 2, n / 2, s / 2), o), this._divided = !0
    }
}
class K0 {
    constructor(e, t) {
        this.container = t, this._engine = e, this.nextId = 0, this.array = [], this.zArray = [], this.pool = [], this.limit = 0, this.needsSort = !1, this.lastZIndex = 0, this.interactionManager = new X0(this._engine, t);
        const n = this.container.canvas.size;
        this.quadTree = new Xe(new pe(-n.width / 4, -n.height / 4, n.width * 3 / 2, n.height * 3 / 2), 4), this.movers = this._engine.plugins.getMovers(t, !0), this.updaters = this._engine.plugins.getUpdaters(t, !0)
    }
    get count() {
    ...
    addManualParticles() {
        const e = this.container,
            t = e.actualOptions;
        for (const n of t.manualParticles) this.addParticle(Dd({
            size: e.canvas.size,
            position: n.position
        }), n.options)
    }
    ...
    async draw(e) {
        ...
        this.quadTree = new Xe(new pe(-n.width / 4, -n.height / 4, n.width * 3 / 2, n.height * 3 / 2), 4), t.canvas.clear(), await this.update(e), this.needsSort && (this.zArray.sort((s, o) => o.position.z - s.position.z || s.id - o.id), this.lastZIndex = this.zArray[this.zArray.length - 1].position.z, this.needsSort = !1);
    ...
    init() {
        ...
        if (this.addManualParticles(), !s) {
            for (const o in n.particles.groups) {
                ...
                for (let a = this.count, l = 0; l < ((e = r.number) === null || e === void 0 ? void 0 : e.value) && a < n.particles.number.value; a++, l++) this.addParticle(void 0, r, o)
            }
    ...
    push(e, t, n, s) {
        this.pushing = !0;
        for (let o = 0; o < e; o++) this.addParticle(t == null ? void 0 : t.position, n, s);
        this.pushing = !1
    }
    async redraw() {
    ...
    setDensity() {
        const e = this.container.actualOptions;
        for (const t in e.particles.groups) this._applyDensity(e.particles.groups[t], 0, t);
    ...
    async update(e) {
        ...
        for (const [, r] of s.plugins)(t = r.update) === null || t === void 0 || t.call(r, e);
        for (const r of this.array) {
            ...
            this.quadTree.insert(new Z0(r.getPosition(), r))
        }
    ...
    _applyDensity(e, t, n) {
        ...
        this.limit = o.limit * r, c < u ? this.push(Math.abs(u - c), void 0, e, n) : c > u && this.removeQuantity(c - u, n)
    }
    ...
    _pushParticle(e, t, n, s) {
        try {
            let o = this.pool.pop();
            o ? o.init(this.nextId, e, t, n) : o = new Y0(this._engine, this.nextId, this.container, e, t, n);
            let r = !0;
...
class J0 {
    ...
    init() {
        const e = this.container,
            t = e.actualOptions;
        this.pixelRatio = !t.detectRetina || Ze() ? 1 : window.devicePixelRatio, this.reduceFactor = 1;
        const n = this.pixelRatio;
        if (e.canvas.element) {
            const o = e.canvas.element;
            e.canvas.size.width = o.offsetWidth * n, e.canvas.size.height = o.offsetHeight * n
        }
        const s = t.particles;
        this.attractDistance = R(s.move.attract.distance) * n, this.sizeAnimationSpeed = R(s.size.animation.speed) * n, this.maxSpeed = R(s.move.gravity.maxSpeed) * n
    }
    initParticle(e) {
        const t = e.options,
            n = this.pixelRatio,
            s = t.move.distance,
            o = e.retina;
        o.attractDistance = R(t.move.attract.distance) * n, o.moveDrift = R(t.move.drift) * n, o.moveSpeed = R(t.move.speed) * n, o.sizeAnimationSpeed = R(t.size.animation.speed) * n;
        const r = o.maxDistance;
        r.horizontal = s.horizontal !== void 0 ? s.horizontal * n : void 0, r.vertical = s.vertical !== void 0 ? s.vertical * n : void 0, o.maxSpeed = R(t.move.gravity.maxSpeed) * n
    }
}
...
class e2 {
    constructor(e, t, n) {
        this.id = t, this._engine = e, this.fpsLimit = 120, this.smooth = !1, this._delay = 0, this.duration = 0, this.lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this.lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = n, this._initialSourceOptions = n, this.retina = new J0(this), this.canvas = new r0(this), this.particles = new K0(this._engine, this), this.frameManager = new u0(this), this.pathGenerators = new Map, this.interactivity = {
            mouse: {
                clicking: !1,
                inside: !1
            }
        }, this.plugins = new Map, this.drawers = new Map, this._options = lt(this._engine, this), this.actualOptions = lt(this._engine, this), this._eventListeners = new a0(this), typeof IntersectionObserver < "u" && IntersectionObserver && (this._intersectionObserver = new IntersectionObserver(s => this._intersectionManager(s))), this._engine.dispatchEvent("containerBuilt", {
            container: this
        })
    }
    get options() {
    ...
    addClickHandler(e) {
        ...
        const n = (d, f, p) => {
                ...
                const h = this.retina.pixelRatio,
                    ...
                    y = this.particles.quadTree.queryCircle(v, p * h);
                e(d, y)
            },
            s = d => {
                if (!ee(this)) return;
            ...
            a = d => {
                if (!!ee(this)) {
                    if (u && !c) {
                        ...
                        if (!p && (p = f.changedTouches[f.changedTouches.length - 1], !p)) return;
                        const h = this.canvas.element,
                            v = h ? h.getBoundingClientRect() : void 0,
                            y = {
    ...
    addPath(e, t, n = !1) {
        return !ee(this) || !n && this.pathGenerators.has(e) ? !1 : (this.pathGenerators.set(e, t != null ? t : Qi), !0)
    }
    destroy() {
        if (!ee(this)) return;
        ...
        t >= 0 && e.splice(t, 1), this._engine.dispatchEvent("containerDestroyed", {
            container: this
        })
    }
    draw(e) {
        if (!ee(this)) return;
        let t = e;
        this._drawAnimationFrame = Od()(async n => {
            t && (this.lastFrameTime = void 0, t = !1), await this.frameManager.nextFrame(n)
        })
    }
    exportConfiguration() {
    ...
    handleClickMode(e) {
        if (!!ee(this)) {
            ...
            for (const [, t] of this.plugins) t.handleClickMode && t.handleClickMode(e)
        }
    }
    async init() {
        if (!ee(this)) return;
        ...
        this._options = lt(this._engine, this, this._initialSourceOptions, this.sourceOptions), this.actualOptions = lt(this._engine, this, this._options);
        const t = this._engine.plugins.getAvailablePlugins(this);
        for (const [n, s] of t) this.plugins.set(n, s);
        this.retina.init(), this.canvas.init(), this.updateActualOptions(), this.canvas.initBackground(), this.canvas.resize(), this.zLayers = this.actualOptions.zLayers, this.duration = R(this.actualOptions.duration) * 1e3, this._delay = R(this.actualOptions.delay) * 1e3, this.lifeTime = 0, this.fpsLimit = this.actualOptions.fpsLimit > 0 ? this.actualOptions.fpsLimit : 120, this.smooth = this.actualOptions.smooth;
    ...
    pause() {
        if (!!ee(this) && (this._drawAnimationFrame !== void 0 && (Ld()(this._drawAnimationFrame), delete this._drawAnimationFrame), !this._paused)) {
    ...
    async reset() {
        if (!!ee(this)) return this._options = lt(this._engine, this), this.refresh()
    }
    setNoise(e, t, n) {
    ...
    setPath(e, t, n) {
        ...
        if (typeof e == "function") s.generate = e, t && (s.init = t), n && (s.update = n);
        else {
            const o = s;
    ...
    _intersectionManager(e) {
        if (!(!ee(this) || !this.actualOptions.pauseOnOutsideViewport))
            for (const t of e) t.target === this.interactivity.element && (t.isIntersecting ? this.play : this.pause)()
    }
}
...
class n2 {
    ...
    async loadJSON(e, t, n) {
        let s, o;
        return typeof t == "number" || t === void 0 ? s = e : (o = e, s = t), this.loadRemoteOptions({
            tagId: o,
            url: s,
            index: n,
            remote: !0
    ...
    async loadOptions(e) {
        var t, n, s;
        const o = (t = e.tagId) !== null && t !== void 0 ? t : `tsparticles${Math.floor(U()*1e4)}`,
            {
                index: r,
                url: a,
                remote: l
            } = e,
            u = l ? await i2(a, r) : e.options;
        let c = (n = e.element) !== null && n !== void 0 ? n : document.getElementById(o);
        c || (c = document.createElement("div"), c.id = o, (s = document.querySelector("body")) === null || s === void 0 || s.append(c));
        const d = Ee(u, r),
            f = this._engine.dom(),
        ...
        let h;
        if (c.tagName.toLowerCase() === "canvas") h = c, h.dataset[ct] = "false";
        else {
            const y = c.getElementsByTagName("canvas");
            y.length ? (h = y[0], h.dataset[ct] = "false") : (h = document.createElement("canvas"), h.dataset[ct] = "true", c.appendChild(h))
        }
        h.style.width || (h.style.width = "100%"), h.style.height || (h.style.height = "100%");
        const v = new e2(this._engine, o, d);
        return p >= 0 ? f.splice(p, 0, v) : f.push(v), v.canvas.loadCanvas(h), await v.start(), v
    }
    ...
    async set(e, t, n, s) {
        ...
        return typeof e == "string" ? o.tagId = e : o.element = e, t instanceof HTMLElement ? o.element = t : o.options = t, typeof n == "number" ? o.index = n : o.options = n != null ? n : o.options, this.loadOptions(o)
    }
    async setJSON(e, t, n, s) {
        let o, r, a, l;
        return e instanceof HTMLElement ? (l = e, o = t, a = n) : (r = e, l = t, o = n, a = s), this.loadRemoteOptions({
            tagId: r,
            url: o,
            index: a,
            element: l,
...
class s2 {
    ...
    getAvailablePlugins(e) {
        const t = new Map;
        for (const n of this.plugins) !n.needsPlugin(e.actualOptions) || t.set(n.id, n.getPlugin(e));
        return t
    }
    ...
    loadParticlesOptions(e, t, ...n) {
        ...
        if (!!s)
            for (const o of s) o.loadOptions && o.loadOptions(t, ...n)
    }
}
class o2 {
    constructor() {
        this._domArray = [], this._eventDispatcher = new Fd, this._initialized = !1, this._loader = new n2(this), this.plugins = new s2(this)
    }
    addEventListener(e, t) {
    ...
    setOnClickHandler(e) {
        const t = this.dom();
        if (!t.length) throw new Error("Can only set click handlers after calling tsParticles.load() or tsParticles.loadJSON()");
...
class r2 {
    ...
    handleRangeColor(e) {
        ...
        const n = e.value,
            s = (t = n.hsl) !== null && t !== void 0 ? t : e.value;
        if (s.h !== void 0 && s.l !== void 0) return it({
            h: R(s.h),
            l: R(s.l),
            s: R(s.s)
        })
    ...
    parseString(e) {
        ...
        const t = /hsla?\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(,\s*([\d.%]+)\s*)?\)/i,
            n = t.exec(e);
        return n ? Vd({
            a: n.length > 4 ? jn(n[5]) : 1,
            h: parseInt(n[1], 10),
            l: parseInt(n[3], 10),
            s: parseInt(n[2], 10)
        }) : void 0
...
class a2 {
    ...
    parseString(e) {
        ...
        const t = /rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(,\s*([\d.%]+)\s*)?\)/i,
            n = t.exec(e);
        return n ? {
            a: n.length > 4 ? jn(n[5]) : 1,
            b: parseInt(n[3], 10),
...
class f2 extends Fe {
    constructor() {
        super(), this.density = 5, this.value = 50, this.limit = new d2
    }
    load(e) {
...
class St {
    constructor() {
        this.color = new ie, this.color.value = "#000000", this.draggable = !1, this.opacity = 1, this.destroy = !0, this.orbits = !1, this.size = new f2
    }
    load(e) {
        e !== void 0 && (e.color !== void 0 && (this.color = ie.create(this.color, e.color)), e.draggable !== void 0 && (this.draggable = e.draggable), this.name = e.name, e.opacity !== void 0 && (this.opacity = e.opacity), e.position !== void 0 && (this.position = {}, e.position.x !== void 0 && (this.position.x = H(e.position.x)), e.position.y !== void 0 && (this.position.y = H(e.position.y))), e.size !== void 0 && this.size.load(e.size), e.destroy !== void 0 && (this.destroy = e.destroy), e.orbits !== void 0 && (this.orbits = e.orbits))
    }
}
class h2 {
    constructor(e, t, n, s) {
        var o, r, a;
        this.absorbers = e, this.container = t, this.initialPosition = s ? Z.create(s.x, s.y) : void 0, n instanceof St ? this.options = n : (this.options = new St, this.options.load(n)), this.dragging = !1, this.name = this.options.name, this.opacity = this.options.opacity, this.size = R(this.options.size.value) * t.retina.pixelRatio, this.mass = this.size * this.options.size.density * t.retina.reduceFactor;
        const l = this.options.size.limit;
        this.limit = {
            radius: l.radius * t.retina.pixelRatio * t.retina.reduceFactor,
            mass: l.mass
        }, this.color = (o = xe(this.options.color)) !== null && o !== void 0 ? o : {
            b: 0,
            g: 0,
            r: 0
        }, this.position = (a = (r = this.initialPosition) === null || r === void 0 ? void 0 : r.copy()) !== null && a !== void 0 ? a : this.calcPosition()
    }
    attract(e) {
        const t = this.container,
            n = this.options;
        if (n.draggable) {
            ...
            u.clicking && u.downPosition ? oe(this.position, u.downPosition) <= this.size && (this.dragging = !0) : this.dragging = !1, this.dragging && u.position && (this.position.x = u.position.x, this.position.y = u.position.y)
        }
        const s = e.getPosition(),
            ...
            l = Z.create(o, r);
        if (l.length = this.mass / Math.pow(a, 2) * t.retina.reduceFactor, a < this.size + e.getRadius()) {
            const u = e.getRadius() * .033 * t.retina.pixelRatio;
            this.size > e.getRadius() && a < this.size - e.getRadius() || e.absorberOrbit !== void 0 && e.absorberOrbit.length < 0 ? n.destroy ? e.destroy() : (e.needsNewPosition = !0, this.updateParticlePosition(e, l)) : (n.destroy && (e.size.value -= u), this.updateParticlePosition(e, l)), (this.limit.radius <= 0 || this.size < this.limit.radius) && (this.size += u), (this.limit.mass <= 0 || this.mass < this.limit.mass) && (this.mass += u * this.options.size.density * t.retina.reduceFactor)
        } else this.updateParticlePosition(e, l)
    }
    draw(e) {
        e.translate(this.position.x, this.position.y), e.beginPath(), e.arc(0, 0, this.size, 0, Math.PI * 2, !1), e.closePath(), e.fillStyle = ze(this.color, this.opacity), e.fill()
    }
    resize() {
        const e = this.initialPosition;
        this.position = e && mt(e, this.container.canvas.size, Z.origin) ? e : this.calcPosition()
    }
    calcPosition() {
        const e = Un({
    ...
    updateParticlePosition(e, t) {
        ...
        if (this.options.orbits) {
            if (e.absorberOrbit === void 0 && (e.absorberOrbit = Z.create(0, 0), e.absorberOrbit.length = oe(e.getPosition(), this.position), e.absorberOrbit.angle = U() * Math.PI * 2), e.absorberOrbit.length <= this.size && !this.options.destroy) {
                const c = Math.min(o.width, o.height);
                e.absorberOrbit.length = c * (1 + (U() * .2 - .1))
            }
            ...
            e.position.x = this.position.x + r * u.x(a), e.position.y = this.position.y + r * u.y(a), e.absorberOrbit.length -= t.length, e.absorberOrbit.angle += ((n = e.retina.moveSpeed) !== null && n !== void 0 ? n : 0) * s.retina.pixelRatio / 100 * s.retina.reduceFactor
        } else {
            const r = Z.origin;
...
class p2 {
    constructor(e) {
        this.container = e, this.array = [], this.absorbers = [], this.interactivityAbsorbers = [], e.getAbsorber = t => t === void 0 || typeof t == "number" ? this.array[t || 0] : this.array.find(n => n.name === t), e.addAbsorber = (t, n) => this.addAbsorber(t, n)
    }
    addAbsorber(e, t) {
        const n = new h2(this, this.container, e, t);
    ...
    async init() {
        this.absorbers = this.container.actualOptions.absorbers, this.interactivityAbsorbers = this.container.actualOptions.interactivity.modes.absorbers, J(this.absorbers, e => {
            this.addAbsorber(e)
        })
    }
    particleUpdate(e) {
        for (const t of this.array)
            if (t.attract(e), e.destroyed) break
    }
    removeAbsorber(e) {
...
class v2 {
    ...
    loadOptions(e, t) {
        var n, s;
        !this.needsPlugin(e) && !this.needsPlugin(t) || (t != null && t.absorbers && (e.absorbers = J(t.absorbers, o => {
            const r = new St;
            return r.load(o), r
        })), e.interactivity.modes.absorbers = J((s = (n = t == null ? void 0 : t.interactivity) === null || n === void 0 ? void 0 : n.modes) === null || s === void 0 ? void 0 : s.absorbers, o => {
            const r = new St;
            return r.load(o), r
        }))
    }
    needsPlugin(e) {
        ...
        if (!e) return !1;
        const o = e.absorbers;
        return o instanceof Array ? !!o.length : o ? !0 : !!(((s = (n = (t = e.interactivity) === null || t === void 0 ? void 0 : t.events) === null || n === void 0 ? void 0 : n.onClick) === null || s === void 0 ? void 0 : s.mode) && K("absorber", e.interactivity.events.onClick.mode))
    }
}
async function m2(i) {
    const e = new v2;
...
class g2 {
    load(e) {
        !e || (e.bottom !== void 0 && (this.bottom = H(e.bottom)), e.left !== void 0 && (this.left = H(e.left)), e.right !== void 0 && (this.right = H(e.right)), e.top !== void 0 && (this.top = H(e.top)))
    }
}
class C2 extends Fe {
    constructor() {
...
class b2 {
    constructor() {
        this.count = 1, this.factor = new C2, this.rate = new y2, this.sizeOffset = !0
    }
    load(e) {
        !e || (e.count !== void 0 && (this.count = e.count), this.factor.load(e.factor), this.rate.load(e.rate), this.particles = J(e.particles, t => ne({}, t)), e.sizeOffset !== void 0 && (this.sizeOffset = e.sizeOffset))
    }
}
class _2 {
    constructor() {
        this.bounds = new g2, this.mode = "none", this.split = new b2
    }
    load(e) {
...
class w2 {
    ...
    init(e) {
        ...
        e.splitCount = 0;
        const o = s.bounds;
        e.destroyBounds || (e.destroyBounds = {}), o.bottom && (e.destroyBounds.bottom = R(o.bottom) * t.canvas.size.height / 100), o.left && (e.destroyBounds.left = R(o.left) * t.canvas.size.width / 100), o.right && (e.destroyBounds.right = R(o.right) * t.canvas.size.width / 100), o.top && (e.destroyBounds.top = R(o.top) * t.canvas.size.height / 100)
    }
    isEnabled(e) {
        return !e.destroyed
    }
    loadOptions(e, ...t) {
        e.destroy || (e.destroy = new _2);
    ...
    update(e) {
        ...
        const t = e.getPosition(),
            n = e.destroyBounds;
        !n || (n.bottom !== void 0 && t.y >= n.bottom || n.left !== void 0 && t.x <= n.left || n.right !== void 0 && t.x >= n.right || n.top !== void 0 && t.y <= n.top) && e.destroy()
    }
    addSplitParticle(e, t) {
        ...
        }), typeof o.size.value == "number" ? o.size.value /= r : (o.size.value.min /= r, o.size.value.max /= r), o.load(t);
        ...
        return this.container.particles.addParticle(l, o, e.group, u => {
            var c;
            return u.size.value < .5 ? !1 : (u.velocity.length = se(H(e.velocity.length, u.velocity.length)), u.splitCount = ((c = e.splitCount) !== null && c !== void 0 ? c : 0) + 1, u.unbreakable = !0, setTimeout(() => {
                u.unbreakable = !1
            }, 500), !0)
        })
    }
    split(e) {
        ...
        if (!t) return;
        const n = t.split;
        if (n.count >= 0 && (e.splitCount === void 0 || e.splitCount++ > n.count)) return;
        const s = $e(n.rate),
            o = Ee(n.particles);
...
async function E2(i) {
    await i.addParticleUpdater("destroy", e => new w2(i, e))
}
class x2 {
    randomPosition(e, t, n) {
        const s = (d, f) => {
                const p = U() / 4,
                    ...
                    v = U();
                return v < .25 ? h : v < .5 ? Math.PI - h : v < .75 ? Math.PI + h : -h
            },
            o = (d, f, p) => d * f / Math.sqrt((f * Math.cos(p)) ** 2 + (d * Math.sin(p)) ** 2),
...
class S2 {
    ...
    load(e) {
        e !== void 0 && (e.quantity !== void 0 && (this.quantity = H(e.quantity)), e.delay !== void 0 && (this.delay = H(e.delay)))
    }
}
class as {
    constructor() {
...
class Ne {
    constructor() {
        this.autoPlay = !0, this.fill = !0, this.life = new F2, this.rate = new S2, this.shape = "square", this.startCount = 0
    }
    load(e) {
        e !== void 0 && (e.autoPlay !== void 0 && (this.autoPlay = e.autoPlay), e.size !== void 0 && (this.size === void 0 && (this.size = new as), this.size.load(e.size)), e.direction !== void 0 && (this.direction = e.direction), this.domId = e.domId, e.fill !== void 0 && (this.fill = e.fill), this.life.load(e.life), this.name = e.name, this.particles = J(e.particles, t => ne({}, t)), this.rate.load(e.rate), e.shape !== void 0 && (this.shape = e.shape), e.position !== void 0 && (this.position = {}, e.position.x !== void 0 && (this.position.x = H(e.position.x)), e.position.y !== void 0 && (this.position.y = H(e.position.y))), e.spawnColor !== void 0 && (this.spawnColor === void 0 && (this.spawnColor = new st), this.spawnColor.load(e.spawnColor)), e.startCount !== void 0 && (this.startCount = e.startCount))
    }
}
class T2 {
    constructor(e, t, n, s, o) {
        var r, a, l, u, c, d, f, p;
        this.emitters = t, this.container = n, this._engine = e, this._currentDuration = 0, this._currentEmitDelay = 0, this._currentSpawnDelay = 0, this._initialPosition = o, s instanceof Ne ? this.options = s : (this.options = new Ne, this.options.load(s)), this._spawnDelay = ((r = this.options.life.delay) !== null && r !== void 0 ? r : 0) * 1e3 / this.container.retina.reduceFactor, this.position = (a = this._initialPosition) !== null && a !== void 0 ? a : this.calcPosition(), this.name = this.options.name, this._shape = (l = this._engine.emitterShapeManager) === null || l === void 0 ? void 0 : l.getShape(this.options.shape), this.fill = this.options.fill, this._firstSpawn = !this.options.life.wait, this._startParticlesAdded = !1;
        let h = ne({}, this.options.particles);
        h != null || (h = {}), (u = h.move) !== null && u !== void 0 || (h.move = {}), (c = (p = h.move).direction) !== null && c !== void 0 || (p.direction = this.options.direction), this.options.spawnColor && (this.spawnColor = Ue(this.options.spawnColor)), this._paused = !this.options.autoPlay, this._particlesOptions = h, this.size = (d = this.options.size) !== null && d !== void 0 ? d : (() => {
            const v = new as;
            return v.load({
                height: 0,
                mode: "percent",
        ...
        })(), this._lifeCount = (f = this.options.life.count) !== null && f !== void 0 ? f : -1, this._immortal = this._lifeCount <= 0, this._engine.dispatchEvent("emitterCreated", {
            container: n,
            data: {
                emitter: this
            }
    ...
    play() {
        var e;
        if (!this._paused && !!(this.container.retina.reduceFactor && (this._lifeCount > 0 || this._immortal || !this.options.life.count) && (this._firstSpawn || this._currentSpawnDelay >= ((e = this._spawnDelay) !== null && e !== void 0 ? e : 0)))) {
    ...
    update(e) {
        var t, n, s;
        this._paused || (this._firstSpawn && (this._firstSpawn = !1, this._currentSpawnDelay = (t = this._spawnDelay) !== null && t !== void 0 ? t : 0, this._currentEmitDelay = (n = this._emitDelay) !== null && n !== void 0 ? n : 0), this._startParticlesAdded || (this._startParticlesAdded = !0, this.emitParticles(this.options.startCount)), this._duration !== void 0 && (this._currentDuration += e.value, this._currentDuration >= this._duration && (this.pause(), this._spawnDelay !== void 0 && delete this._spawnDelay, this._immortal || this._lifeCount--, this._lifeCount > 0 || this._immortal ? (this.position = this.calcPosition(), this._spawnDelay = ((s = this.options.life.delay) !== null && s !== void 0 ? s : 0) * 1e3 / this.container.retina.reduceFactor) : this.destroy(), this._currentDuration -= this._duration, delete this._duration)), this._spawnDelay !== void 0 && (this._currentSpawnDelay += e.value, this._currentSpawnDelay >= this._spawnDelay && (this._engine.dispatchEvent("emitterPlay", {
            container: this.container
        }), this.play(), this._currentSpawnDelay -= this._currentSpawnDelay, delete this._spawnDelay)), this._emitDelay !== void 0 && (this._currentEmitDelay += e.value, this._currentEmitDelay >= this._emitDelay && (this.emit(), this._currentEmitDelay -= this._emitDelay)))
    }
    calcPosition() {
        return Un({
            size: this.container.canvas.size,
    ...
    emitParticles(e) {
        ...
        const o = this.getPosition(),
            r = this.getSize(),
            a = Ee(this._particlesOptions);
        for (let l = 0; l < e; l++) {
            const u = ne({}, a);
            if (this.spawnColor) {
                const d = (t = this.options.spawnColor) === null || t === void 0 ? void 0 : t.animation;
                d && (this.spawnColor.h = this.setColorAnimation(d.h, this.spawnColor.h, 360), this.spawnColor.s = this.setColorAnimation(d.s, this.spawnColor.s, 100), this.spawnColor.l = this.setColorAnimation(d.l, this.spawnColor.l, 100)), u.color ? u.color.value = this.spawnColor : u.color = {
                    value: this.spawnColor
                }
            }
            if (!o) return;
            const c = (s = (n = this._shape) === null || n === void 0 ? void 0 : n.randomPosition(o, r, this.fill)) !== null && s !== void 0 ? s : o;
    ...
    prepareToDie() {
        var e;
        if (this._paused) return;
        const t = (e = this.options.life) === null || e === void 0 ? void 0 : e.duration;
        this.container.retina.reduceFactor && (this._lifeCount > 0 || this._immortal) && t !== void 0 && t > 0 && (this._duration = t * 1e3)
    }
...
class B2 {
    constructor(e, t) {
        this.container = t, this._engine = e, this.array = [], this.emitters = [], this.interactivityEmitters = {
            random: {
                count: 1,
                enable: !1
            },
            value: []
        }, t.getEmitter = n => n === void 0 || typeof n == "number" ? this.array[n || 0] : this.array.find(s => s.name === n), t.addEmitter = (n, s) => this.addEmitter(n, s), t.removeEmitter = n => {
    ...
    addEmitter(e, t) {
        const n = new Ne;
        n.load(e);
        const s = new T2(this._engine, this, this.container, n, t);
...
class A2 {
    ...
    getPlugin(e) {
        return new B2(this._engine, e)
    }
    loadOptions(e, t) {
        var n, s, o, r, a, l;
        if (!this.needsPlugin(e) && !this.needsPlugin(t)) return;
        t != null && t.emitters && (e.emitters = J(t.emitters, c => {
            const d = new Ne;
            return d.load(c), d
        }));
        const u = (s = (n = t == null ? void 0 : t.interactivity) === null || n === void 0 ? void 0 : n.modes) === null || s === void 0 ? void 0 : s.emitters;
        if (u)
            if (u instanceof Array) e.interactivity.modes.emitters = {
                random: {
                    count: 1,
                    enable: !0
                },
                ...
                const c = u;
                if (c.value !== void 0)
                    if (c.value instanceof Array) e.interactivity.modes.emitters = {
                        random: {
                        ...
                        const d = new Ne;
                        d.load(c.value), e.interactivity.modes.emitters = {
                            random: {
                                count: (a = c.random.count) !== null && a !== void 0 ? a : 1,
                                enable: (l = c.random.enable) !== null && l !== void 0 ? l : !1
                            },
                            value: d
                        }
                    }
    ...
    needsPlugin(e) {
        ...
        if (!e) return !1;
        const o = e.emitters;
        return o instanceof Array && !!o.length || o !== void 0 || !!(!((s = (n = (t = e.interactivity) === null || t === void 0 ? void 0 : t.events) === null || n === void 0 ? void 0 : n.onClick) === null || s === void 0) && s.mode) && K("emitter", e.interactivity.events.onClick.mode)
    }
}
async function M2(i) {
    i.emitterShapeManager || (i.emitterShapeManager = new k2(i)), i.addEmitterShape || (i.addEmitterShape = (t, n) => {
        var s;
        (s = i.emitterShapeManager) === null || s === void 0 || s.addShape(t, n)
    });
    const e = new A2(i);
    await i.addPlugin(e), i.addEmitterShape("circle", new x2), i.addEmitterShape("square", new D2)
}
class P2 {
    constructor() {
    ...
    load(e) {
        !e || (e.delay !== void 0 && (this.delay = e.delay), e.quantity !== void 0 && (this.quantity = e.quantity), e.particles !== void 0 && (this.particles = ne({}, e.particles)), e.pauseOnStop !== void 0 && (this.pauseOnStop = e.pauseOnStop))
    }
}
class O2 extends De {
    constructor(e) {
    ...
    async interact(e) {
        ...
        let c = !0;
        l.pauseOnStop && (r.interactivity.mouse.position === this._lastPosition || ((t = r.interactivity.mouse.position) === null || t === void 0 ? void 0 : t.x) === ((n = this._lastPosition) === null || n === void 0 ? void 0 : n.x) && ((s = r.interactivity.mouse.position) === null || s === void 0 ? void 0 : s.y) === ((o = this._lastPosition) === null || o === void 0 ? void 0 : o.y)) && (c = !1), r.interactivity.mouse.position ? this._lastPosition = {
            x: r.interactivity.mouse.position.x,
            y: r.interactivity.mouse.position.y
        } : delete this._lastPosition, c && r.particles.push(l.quantity, r.interactivity.mouse, l.particles), this._delay -= u
    }
    isEnabled(e) {
        var t;
        const n = this.container,
            ...
            r = ((t = e == null ? void 0 : e.interactivity) !== null && t !== void 0 ? t : s.interactivity).events;
        return o.clicking && o.inside && !!o.position && K("trail", r.onClick.mode) || o.inside && !!o.position && K("trail", r.onHover.mode)
    }
    loadModeOptions(e, ...t) {
        e.trail || (e.trail = new P2);
        for (const n of t) e.trail.load(n == null ? void 0 : n.trail)
    }
    reset() {}
}
async function L2(i) {
    await i.addInteractor("externalTrail", e => new O2(e))
}
class tn {
    constructor() {
    ...
    load(e) {
        !e || (e.enable !== void 0 && (this.enable = e.enable), e.value !== void 0 && (this.value = H(e.value)))
    }
}
class I2 {
    constructor() {
        this.darken = new tn, this.enable = !1, this.enlighten = new tn, this.mode = "vertical", this.speed = 25
    }
    load(e) {
        !e || (e.backColor !== void 0 && (this.backColor = ie.create(this.backColor, e.backColor)), this.darken.load(e.darken), e.enable !== void 0 && (this.enable = e.enable), this.enlighten.load(e.enlighten), e.mode !== void 0 && (this.mode = e.mode), e.speed !== void 0 && (this.speed = H(e.speed)))
    }
}
...
class R2 {
    getTransformValues(e) {
        var t;
        const n = ((t = e.roll) === null || t === void 0 ? void 0 : t.enable) && e.roll,
            s = n && n.horizontal,
            o = n && n.vertical;
        return {
    ...
    init(e) {
        ...
        if (t != null && t.enable)
            if (e.roll = {
                    ...
                    angle: U() * Math.PI * 2,
                    speed: R(t.speed) / 360
                }, t.backColor) e.backColor = Ue(t.backColor);
            else if (t.darken.enable && t.enlighten.enable) {
            const n = U() >= .5 ? "darken" : "enlighten";
            e.roll.alter = {
                type: n,
                value: R(n === "darken" ? t.darken.value : t.enlighten.value)
            }
        } else t.darken.enable ? e.roll.alter = {
            type: "darken",
            value: R(t.darken.value)
        } : t.enlighten.enable && (e.roll.alter = {
            type: "enlighten",
            value: R(t.enlighten.value)
        });
        else e.roll = {
            enable: !1,
            horizontal: !1,
    ...
    loadOptions(e, ...t) {
        e.roll || (e.roll = new I2);
        for (const n of t) e.roll.load(n == null ? void 0 : n.roll)
    }
    update(e, t) {
        !this.isEnabled(e) || z2(e, t)
    }
}
async function $2(i) {
    await i.addParticleUpdater("roll", () => new R2)
}
const N2 = i => {
    const e = (n, s) => i.load(n, s);
    e.load = (n, s, o) => {
        i.loadJSON(n, s).then(r => {
            r && o(r)
        }).catch(() => {
            o(void 0)
        })
...
class H2 {
    ...
    load(e) {
        !e || (e.enable !== void 0 && (this.enable = e.enable), e.speed !== void 0 && (this.speed = H(e.speed)), e.decay !== void 0 && (this.decay = H(e.decay)), e.sync !== void 0 && (this.sync = e.sync))
    }
}
class V2 extends Fe {
    constructor() {
        super(), this.animation = new H2, this.direction = "clockwise", this.path = !1, this.value = 0
    }
    load(e) {
...
class j2 {
    ...
    init(e) {
        ...
        let n = t.direction;
        switch (n === "random" && (n = Math.floor(U() * 2) > 0 ? "counter-clockwise" : "clockwise"), n) {
        ...
        const s = t.animation;
        s.enable && (e.rotate.decay = 1 - R(s.decay), e.rotate.velocity = R(s.speed) / 360 * this.container.retina.reduceFactor, s.sync || (e.rotate.velocity *= U())), e.rotation = e.rotate.value
    }
    isEnabled(e) {
        const t = e.options.rotate;
        return t ? !e.destroyed && !e.spawning && t.animation.enable && !t.path : !1
    }
    loadOptions(e, ...t) {
        e.rotate || (e.rotate = new V2);
        for (const n of t) e.rotate.load(n == null ? void 0 : n.rotate)
    }
    update(e, t) {
        var n, s;
        !this.isEnabled(e) || (U2(e, t), e.rotation = (s = (n = e.rotate) === null || n === void 0 ? void 0 : n.value) !== null && s !== void 0 ? s : 0)
    }
}
async function q2(i) {
    await i.addParticleUpdater("rotate", e => new j2(e))
}
...
function G2(i) {
    ...
    if (!(!r && !a)) {
        if ((r && s >= r || a && o >= a) && !i.misplaced) i.misplaced = !!r && s > r || !!a && o > a, r && (i.velocity.x = i.velocity.y / 2 - i.velocity.x), a && (i.velocity.y = i.velocity.x / 2 - i.velocity.y);
        else if ((!r || s < r) && (!a || o < a) && i.misplaced) i.misplaced = !1;
        else if (i.misplaced) {
            const l = i.position,
                u = i.velocity;
            r && (l.x < e.x && u.x < 0 || l.x > e.x && u.x > 0) && (u.x *= -U()), a && (l.y < e.y && u.y < 0 || l.y > e.y && u.y > 0) && (u.y *= -U())
        }
    }
}
...
function W2(i, e) {
    ...
    i.position.x = i.spin.center.x + i.spin.radius * n.x(i.spin.angle), i.position.y = i.spin.center.y + i.spin.radius * n.y(i.spin.angle), i.spin.radius += i.spin.acceleration;
    const s = Math.max(t.canvas.size.width, t.canvas.size.height);
    i.spin.radius > s / 2 ? (i.spin.radius = s / 2, i.spin.acceleration *= -1) : i.spin.radius < 0 && (i.spin.radius = 0, i.spin.acceleration *= -1), i.spin.angle += e / 100 * (1 - i.spin.radius / s)
}
...
function X2(i, e) {
    ...
    const r = (t = i.pathGenerator) === null || t === void 0 ? void 0 : t.generate(i);
    r && i.velocity.addTo(r), s.clamp && (i.velocity.x = Te(i.velocity.x, -1, 1), i.velocity.y = Te(i.velocity.y, -1, 1)), i.lastPathTime -= i.pathDelay
}
...
class Z2 {
    init(e) {
        ...
        if (e.gravity = {
            ...
            const a = (t = r.position) !== null && t !== void 0 ? t : {
                    x: 50,
                    y: 50
                },
                l = {
                ...
                c = oe(u, l),
                d = R(r.acceleration);
            e.retina.spinAcceleration = d * n.retina.pixelRatio, e.spin = {
                center: l,
    ...
    move(e, t) {
        ...
        const c = e.container,
            d = Y2(e),
            f = ((n = (r = e.retina).moveSpeed) !== null && n !== void 0 ? n : r.moveSpeed = R(u.speed) * c.retina.pixelRatio) * c.retina.reduceFactor,
            p = (s = (a = e.retina).moveDrift) !== null && s !== void 0 ? s : a.moveDrift = R(e.options.move.drift) * c.retina.pixelRatio,
            h = Ie(l.size.value) * c.retina.pixelRatio,
            v = u.size ? e.getRadius() / h : 1,
            y = v * d * (t.factor || 1),
            E = 2,
            C = f * y / E;
        if (u.spin.enable) W2(e, C);
        else {
            X2(e, t);
            const b = e.gravity,
                x = (b == null ? void 0 : b.enable) && b.inverse ? -1 : 1;
            (b == null ? void 0 : b.enable) && C && (e.velocity.y += x * (b.acceleration * t.factor) / (60 * C)), p && C && (e.velocity.x += p * t.factor / (60 * C));
            const w = e.moveDecay;
            w != 1 && e.velocity.multTo(w);
            const _ = e.velocity.mult(C),
                S = (o = e.retina.maxSpeed) !== null && o !== void 0 ? o : c.retina.maxSpeed;
            (b == null ? void 0 : b.enable) && S > 0 && (!b.inverse && _.y >= 0 && _.y >= S || b.inverse && _.y <= 0 && _.y <= -S) && (_.y = x * S, C && (e.velocity.y = _.y / C));
            const F = e.options.zIndex,
                T = (1 - e.zIndexFactor) ** F.velocityRate;
            T != 1 && _.multTo(T), e.position.addTo(_), u.vibrate && (e.position.x += Math.sin(e.position.x * Math.cos(e.position.y)), e.position.y += Math.cos(e.position.y * Math.sin(e.position.x)))
        }
        G2(e)
    }
}
async function K2(i) {
    i.addMover("base", () => new Z2)
}
class J2 {
    draw(e, t, n) {
...
async function Q2(i) {
    await i.addShape("circle", new J2)
}
...
function Qt(i, e, t, n, s) {
    ...
    const l = se(t.offset),
        u = ((o = e.velocity) !== null && o !== void 0 ? o : 0) * i.factor + l * 3.6,
        c = (r = e.decay) !== null && r !== void 0 ? r : 1;
    !s || a.status === 0 ? (a.value += u, s && a.value > n && (a.status = 1, a.value -= a.value % n)) : (a.value -= u, a.value < 0 && (a.status = 0, a.value += a.value)), a.velocity && c !== 1 && (a.velocity *= c), a.value > n && (a.value %= n)
}

function ef(i, e) {
    var t, n, s;
    const o = i.options.color.animation;
    ((t = i.color) === null || t === void 0 ? void 0 : t.h) !== void 0 && Qt(e, i.color.h, o.h, 360, !1), ((n = i.color) === null || n === void 0 ? void 0 : n.s) !== void 0 && Qt(e, i.color.s, o.s, 100, !0), ((s = i.color) === null || s === void 0 ? void 0 : s.l) !== void 0 && Qt(e, i.color.l, o.l, 100, !0)
}
class tf {
    constructor(e) {
        this.container = e
    ...
    init(e) {
        const t = Ue(e.options.color, e.id, e.options.reduceDuplicates);
        t && (e.color = ts(t, e.options.color.animation, this.container.retina.reduceFactor))
    }
    isEnabled(e) {
        var t, n, s;
        const o = e.options.color.animation;
        return !e.destroyed && !e.spawning && (((t = e.color) === null || t === void 0 ? void 0 : t.h.value) !== void 0 && o.h.enable || ((n = e.color) === null || n === void 0 ? void 0 : n.s.value) !== void 0 && o.s.enable || ((s = e.color) === null || s === void 0 ? void 0 : s.l.value) !== void 0 && o.l.enable)
    }
    update(e, t) {
        ef(e, t)
    }
...
async function nf(i) {
    await i.addParticleUpdater("color", e => new tf(e))
}
class sf {
    constructor() {
...
class of extends De {
    constructor(e, t) {
        super(t), this._engine = e, t.attract || (t.attract = {
            particles: []
            ...
            if (!(!o || n !== "attract")) {
                ...
                for (const r of t.attract.particles) !this.isEnabled(r) || r.velocity.setTo(r.initialVelocity);
    ...
    async interact() {
        const e = this.container,
            t = e.actualOptions,
            n = e.interactivity.status === Ke,
            s = t.interactivity.events,
            o = s.onHover.enable,
            r = s.onHover.mode,
            a = s.onClick.enable,
            l = s.onClick.mode;
        n && o && K("attract", r) ? this.hoverAttract() : a && K("attract", l) && this.clickAttract()
    }
    isEnabled(e) {
        var t;
        const n = this.container,
            ...
            o = n.interactivity.mouse,
            r = ((t = e == null ? void 0 : e.interactivity) !== null && t !== void 0 ? t : s.interactivity).events;
        if ((!o.position || !r.onHover.enable) && (!o.clickPosition || !r.onClick.enable)) return !1;
        const a = r.onHover.mode,
            l = r.onClick.mode;
        return K("attract", a) || K("attract", l)
    }
    loadModeOptions(e, ...t) {
        e.attract || (e.attract = new sf);
    ...
    processAttract(e, t, n) {
        ...
        for (const a of r) {
            const {
                ...
                dy: u,
                distance: c
            } = de(a.position, e), d = o.speed * o.factor, f = Te(Hn(o.easing)(1 - c / t) * d, 0, o.maxSpeed), p = Z.create(c === 0 ? d : l / c * f, c === 0 ? d : u / c * f);
            a.position.subFrom(p)
        }
    }
}
async function rf(i) {
    await i.addInteractor("externalAttract", e => new of (i, e))
}
class af {
    constructor() {
        this.distance = 200
...
class lf extends De {
    ...
    async interact() {
        const e = this.container,
            ...
            s = e.interactivity.status === Ke,
            o = n.onHover.enable,
            r = n.onHover.mode,
            a = n.onDiv;
        s && o && K("bounce", r) ? this.processMouseBounce() : Ci("bounce", a, (l, u) => this.singleSelectorBounce(l, u))
    }
    isEnabled(e) {
        var t;
        const n = this.container,
            ...
            r = ((t = e == null ? void 0 : e.interactivity) !== null && t !== void 0 ? t : s.interactivity).events,
            a = r.onDiv;
        return o.position && r.onHover.enable && K("bounce", r.onHover.mode) || gi("bounce", a)
    }
    loadModeOptions(e, ...t) {
        e.bounce || (e.bounce = new af);
        for (const n of t) e.bounce.load(n == null ? void 0 : n.bounce)
    }
    reset() {}
    processBounce(e, t, n) {
        const s = this.container.particles.quadTree.query(n, o => this.isEnabled(o));
        for (const o of s) n instanceof ve ? Xn(si(o), {
            position: e,
            radius: t,
            mass: t ** 2 * Math.PI / 2,
            velocity: Z.origin,
            factor: Z.origin
        }) : n instanceof pe && $d(o, gt(e, t))
    }
    processMouseBounce() {
        const e = this.container,
            t = e.retina.pixelRatio,
    ...
    singleSelectorBounce(e, t) {
        ...
        !s.length || s.forEach(o => {
            const r = o,
                ...
                u = r.offsetWidth / 2 * a,
                c = 10 * a,
                d = t.type === "circle" ? new ve(l.x, l.y, u + c) : new pe(r.offsetLeft * a - c, r.offsetTop * a - c, r.offsetWidth * a + c * 2, r.offsetHeight * a + c * 2);
            this.processBounce(l, u, d)
        })
    }
}
async function uf(i) {
    await i.addInteractor("externalBounce", e => new lf(e))
}
class ls {
    constructor() {
...
class df extends ls {
    load(e) {
        super.load(e), e && (this.divs = J(e.divs, t => {
            const n = new cf;
            return n.load(t), n
        }))
    }
...
class ff extends De {
    constructor(e) {
        super(e), e.bubble || (e.bubble = {}), this.handleClickMode = t => {
            t === "bubble" && (e.bubble || (e.bubble = {}), e.bubble.clicking = !0)
        }
    }
    clear(e, t, n) {
    ...
    async interact(e) {
        const t = this.container.actualOptions,
            ...
            u = o.mode,
            c = n.onDiv;
        r && K("bubble", a) ? this.hoverBubble(e) : l && K("bubble", u) ? this.clickBubble(e) : Ci("bubble", c, (d, f) => this.singleSelectorHover(e, d, f))
    }
    isEnabled(e) {
        var t;
        const n = this.container,
            ...
            a = r.onDiv,
            l = gi("bubble", a);
        if (!(l || r.onHover.enable && o.position || r.onClick.enable && o.clickPosition)) return !1;
        const u = r.onHover.mode,
            c = r.onClick.mode;
        return K("bubble", u) || K("bubble", c) || l
    }
    loadModeOptions(e, ...t) {
        e.bubble || (e.bubble = new df);
    ...
    clickBubble(e) {
        ...
        for (const c of u) {
            ...
            const d = c.getPosition(),
                f = oe(d, r),
                p = (new Date().getTime() - (s.interactivity.mouse.clickTime || 0)) / 1e3;
            p > a.duration && (s.bubble.durationEnd = !0), p > a.duration * 2 && (s.bubble.clicking = !1, s.bubble.durationEnd = !1);
            const h = {
                bubbleObj: {
                ...
                particlesObj: {
                    optValue: Ie(c.options.size.value) * s.retina.pixelRatio,
                    value: c.size.value
                },
                type: "size"
            };
            ...
            const v = {
                ...
                particlesObj: {
                    optValue: Ie(c.options.opacity.value),
                    value: (n = (t = c.opacity) === null || t === void 0 ? void 0 : t.value) !== null && n !== void 0 ? n : 1
                },
                type: "opacity"
            };
            this.process(c, f, p, v), s.bubble.durationEnd ? delete c.bubble.color : f <= l ? this.hoverBubbleColor(c, f) : delete c.bubble.color
        }
    }
    hoverBubble(e) {
        const t = this.container,
        ...
        for (const r of o) {
            ...
            const a = r.getPosition(),
                l = oe(a, n),
                u = 1 - l / s;
            l <= s ? u >= 0 && t.interactivity.status === Ke && (this.hoverBubbleSize(r, u), this.hoverBubbleOpacity(r, u), this.hoverBubbleColor(r, u)) : this.reset(r), t.interactivity.status === ri && this.reset(r)
        }
    }
    hoverBubbleColor(e, t, n) {
        ...
        if (!!o) {
            if (!e.bubble.finalColor) {
                ...
                if (!r) return;
                const a = Ee(r);
                e.bubble.finalColor = Ue(a)
            }
            if (!!e.bubble.finalColor)
                if (o.mix) {
                    e.bubble.color = void 0;
                    const r = e.getFillColor();
                    e.bubble.color = r ? Jn(yi(r, e.bubble.finalColor, 1 - t, t)) : e.bubble.finalColor
    ...
    hoverBubbleOpacity(e, t, n) {
        ...
        const l = this.container,
            u = l.actualOptions,
            c = (s = n == null ? void 0 : n.opacity) !== null && s !== void 0 ? s : (o = u.interactivity.modes.bubble) === null || o === void 0 ? void 0 : o.opacity;
        if (!c) return;
        const d = e.options.opacity.value,
            f = (a = (r = e.opacity) === null || r === void 0 ? void 0 : r.value) !== null && a !== void 0 ? a : 1,
            p = nn(f, c, Ie(d), t);
    ...
    hoverBubbleSize(e, t, n) {
        ...
        if (o === void 0) return;
        const r = Ie(e.options.size.value) * s.retina.pixelRatio,
            a = e.size.value,
            l = nn(a, o, r, t);
    ...
    process(e, t, n, s) {
        ...
        const u = l.duration,
            ...
            h = s.type;
        if (!(!c || c < 0 || r === d))
            if (o.bubble || (o.bubble = {}), o.bubble.durationEnd) f && (h === "size" && delete e.bubble.radius, h === "opacity" && delete e.bubble.opacity);
            else if (t <= c) {
            if ((f != null ? f : p) !== r) {
                const y = p - n * (p - r) / u;
                h === "size" && (e.bubble.radius = y), h === "opacity" && (e.bubble.opacity = y)
            }
        } else h === "size" && delete e.bubble.radius, h === "opacity" && delete e.bubble.opacity
    }
    singleSelectorHover(e, t, n) {
        const s = this.container,
            o = document.querySelectorAll(t),
            r = s.actualOptions.interactivity.modes.bubble;
        !r || !o.length || o.forEach(a => {
            const l = a,
                ...
                d = l.offsetWidth / 2 * u,
                f = n.type === "circle" ? new ve(c.x, c.y, d) : new pe(l.offsetLeft * u, l.offsetTop * u, l.offsetWidth * u, l.offsetHeight * u),
            ...
            for (const h of p) {
                ...
                const v = r.divs,
                    y = Wn(v, l);
                (!h.bubble.div || h.bubble.div !== l) && (this.clear(h, e, !0), h.bubble.div = l), this.hoverBubbleSize(h, 1, y), this.hoverBubbleOpacity(h, 1, y), this.hoverBubbleColor(h, 1, y)
            }
        })
    }
}
async function hf(i) {
    await i.addInteractor("externalBubble", e => new ff(e))
}
class pf {
    constructor() {
        this.opacity = .5
...
class vf {
    constructor() {
        this.distance = 80, this.links = new pf, this.radius = 60
    }
    get lineLinked() {
        return this.links
    }
    ...
    load(e) {
        var t, n;
        !e || (e.distance !== void 0 && (this.distance = e.distance), this.links.load((n = (t = e.links) !== null && t !== void 0 ? t : e.lineLinked) !== null && n !== void 0 ? n : e.line_linked), e.radius !== void 0 && (this.radius = e.radius))
    }
}
...
function mf(i, e, t, n) {
    ...
    const a = e.getPosition(),
        l = t.getPosition(),
        u = yi(o, r, e.getRadius(), t.getRadius()),
        c = i.createLinearGradient(a.x, a.y, l.x, l.y);
    return c.addColorStop(0, nt(o, n)), c.addColorStop(s > 1 ? 1 : s, ze(u, n)), c.addColorStop(1, nt(r, n)), c
}
...
function Cf(i, e, t, n) {
    ...
    if (!!o) return mf(e, t, n, o.links.opacity)
}
...
function yf(i, e, t) {
    i.canvas.draw(n => {
        ...
        const r = e.getPosition(),
            a = t.getPosition();
        gf(n, (s = e.retina.linksWidth) !== null && s !== void 0 ? s : 0, o, r, a)
    })
}
class bf extends De {
    constructor(e) {
    ...
    async interact() {
        ...
        if (e.actualOptions.interactivity.events.onHover.enable && e.interactivity.status === "pointermove") {
            ...
            if (!e.retina.connectModeDistance || e.retina.connectModeDistance < 0 || !e.retina.connectModeRadius || e.retina.connectModeRadius < 0 || !n) return;
    ...
    isEnabled(e) {
        ...
        const n = this.container,
            ...
            o = ((t = e == null ? void 0 : e.interactivity) !== null && t !== void 0 ? t : n.actualOptions.interactivity).events;
        return o.onHover.enable && s.position ? K("connect", o.onHover.mode) : !1
    }
    loadModeOptions(e, ...t) {
        e.connect || (e.connect = new vf);
        for (const n of t) e.connect.load(n == null ? void 0 : n.connect)
    }
    reset() {}
}
async function _f(i) {
    await i.addInteractor("externalConnect", e => new bf(e))
}
class wf {
    constructor() {
    ...
    load(e) {
        !e || (e.blink !== void 0 && (this.blink = e.blink), e.color !== void 0 && (this.color = ie.create(this.color, e.color)), e.consent !== void 0 && (this.consent = e.consent), e.opacity !== void 0 && (this.opacity = e.opacity))
    }
}
class Ef {
    constructor() {
        this.distance = 100, this.links = new wf
    }
    get lineLinked() {
        return this.links
    }
    ...
    load(e) {
        var t, n;
        !e || (e.distance !== void 0 && (this.distance = e.distance), this.links.load((n = (t = e.links) !== null && t !== void 0 ? t : e.lineLinked) !== null && n !== void 0 ? n : e.line_linked))
    }
}

function xf(i, e, t, n, s, o) {
    ut(i, t, n), i.strokeStyle = ze(s, o), i.lineWidth = e, i.stroke()
}

function Ff(i, e, t, n, s) {
    i.canvas.draw(o => {
        var r;
        const a = e.getPosition();
        xf(o, (r = e.retina.linksWidth) !== null && r !== void 0 ? r : 0, a, s, t, n)
    })
}
class Sf extends De {
    constructor(e) {
    ...
    async interact() {
        ...
        const n = this.container,
            s = n.actualOptions,
            o = s.interactivity;
        if (!o.modes.grab || !o.events.onHover.enable || n.interactivity.status !== Ke) return;
        ...
        for (const u of l) {
            ...
            const f = o.modes.grab.links,
                ...
                h = p - d * p / a;
            if (h <= 0) continue;
            const v = (e = f.color) !== null && e !== void 0 ? e : (t = u.options.links) === null || t === void 0 ? void 0 : t.color;
            if (!n.particles.grabLineColor && v) {
                const E = o.modes.grab.links;
                n.particles.grabLineColor = es(v, E.blink, E.consent)
            }
    ...
    loadModeOptions(e, ...t) {
        e.grab || (e.grab = new Ef);
        for (const n of t) e.grab.load(n == null ? void 0 : n.grab)
    }
    reset() {}
}
async function Tf(i) {
    await i.addInteractor("externalGrab", e => new Sf(e))
}
class Bf extends De {
    constructor(e) {
        super(e), this.handleClickMode = t => {
            if (t !== "pause") return;
            const n = this.container;
...
function kf(i) {
    i.addInteractor("externalPause", e => new Bf(e))
}
class Df {
    constructor() {
...
class Af extends De {
    ...
    loadModeOptions(e, ...t) {
        e.push || (e.push = new Df);
        for (const n of t) e.push.load(n == null ? void 0 : n.push)
    }
    reset() {}
}
async function Mf(i) {
    await i.addInteractor("externalPush", e => new Af(e))
}
class Pf {
    constructor() {
        this.quantity = 2
...
function Lf(i) {
    i.addInteractor("externalRemove", e => new Of(e))
}
class us {
    constructor() {
...
class Rf extends De {
    constructor(e, t) {
        super(t), this._engine = e, t.repulse || (t.repulse = {
            particles: []
        }), this.handleClickMode = n => {
            const s = this.container.actualOptions,
            ...
            if (!(!o || n !== "repulse")) {
                ...
                for (const r of t.repulse.particles) !this.isEnabled(r) || r.velocity.setTo(r.initialVelocity);
    ...
    async interact() {
        const e = this.container,
            ...
            l = s.onClick.mode,
            u = s.onDiv;
        n && o && K("repulse", r) ? this.hoverRepulse() : a && K("repulse", l) ? this.clickRepulse() : Ci("repulse", u, (c, d) => this.singleSelectorRepulse(c, d))
    }
    isEnabled(e) {
        var t;
        const n = this.container,
            ...
            if (e.repulse || (e.repulse = {
                ...
                for (const l of a) {
                    const {
                        ...
                        dy: c,
                        distance: d
                    } = de(o, l.position), f = d ** 2, p = t.speed, h = -s * p / f;
                    if (f <= s) {
                        e.repulse.particles.push(l);
                        const v = Z.create(u, c);
                        v.length = h, l.velocity.setTo(v)
                    }
                }
            } else if (e.repulse.clicking === !1) {
                for (const n of e.repulse.particles) n.velocity.setTo(n.initialVelocity);
                e.repulse.particles = []
            }
        }
    }
        ...
        if (!!l)
            for (const u of a) {
                const {
                    ...
                    dy: d,
                    distance: f
                } = de(u.position, e), p = ((o = s == null ? void 0 : s.speed) !== null && o !== void 0 ? o : l.speed) * l.factor, h = Te(Hn(l.easing)(1 - f / t) * p, 0, l.maxSpeed), v = Z.create(f === 0 ? p : c / f * h, f === 0 ? p : d / f * h);
                u.position.addTo(v)
            }
    }
    singleSelectorRepulse(e, t) {
        ...
        !o.length || o.forEach(r => {
            const a = r,
                ...
                c = a.offsetWidth / 2 * l,
                d = t.type === "circle" ? new ve(u.x, u.y, c) : new pe(a.offsetLeft * l, a.offsetTop * l, a.offsetWidth * l, a.offsetHeight * l),
                f = s.divs,
                p = Wn(f, a);
...
async function $f(i) {
    await i.addInteractor("externalRepulse", e => new Rf(i, e))
}
class Nf {
    constructor() {
...
async function Vf(i) {
    await i.addInteractor("externalSlow", e => new Hf(e))
}
const Uf = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d.]+%?\))|currentcolor/gi;
...
function jf(i, e, t) {
    ...
    if (!n) return "";
    const s = nt(e, t);
    if (n.includes("fill")) return n.replace(Uf, () => s);
    const o = n.indexOf(">");
...
async function wi(i) {
    return new Promise(e => {
        i.loading = !0;
        const t = new Image;
        i.element = t, t.addEventListener("load", () => {
            i.loading = !1, e()
        }), t.addEventListener("error", () => {
            i.element = void 0, i.error = !0, i.loading = !1, console.error(`Error tsParticles - loading image: ${i.source}`), e()
        }), t.src = i.source
    })
}
async function qf(i) {
    ...
    e.ok || (console.error("Error tsParticles - Image not found"), i.error = !0), i.error || (i.svgData = await e.text()), i.loading = !1
}

function Gf(i, e, t, n) {
    var s, o, r;
    const a = jf(i, t, (o = (s = n.opacity) === null || s === void 0 ? void 0 : s.value) !== null && o !== void 0 ? o : 1),
        l = {
            color: t,
...
class Wf {
    ...
    draw(e, t, n, s) {
        ...
        if (!a) return;
        const l = (o = r == null ? void 0 : r.ratio) !== null && o !== void 0 ? o : 1,
            u = {
                x: -n,
                y: -n
            };
        e.globalAlpha = s, e.drawImage(a, u.x, u.y, n * 2, n * 2 / l), e.globalAlpha = 1
    }
    getImages(e) {
        const t = this._images.find(n => n.id === e.id);
        return t || (this._images.push({
            id: e.id,
            images: []
        }), this.getImages(e))
    }
    ...
    loadShape(e) {
        ...
        const t = e.container,
            ...
            s = e.shapeData;
        n.find(r => r.source === s.src) || this.loadImageShape(t, s).then(() => {
            this.loadShape(e)
        })
    }
    particleInit(e, t) {
        ...
        if (!!l) {
            if (l.loading) {
                ...
                var u, c;
                let d;
                l.svgData && r ? d = await Gf(l, o, r, t) : d = {
                    color: r,
                    data: l,
                    element: l.element,
                    loaded: !0,
    ...
    async loadImageShape(e, t) {
        ...
        try {
            ...
            this.addImage(e, o), await (((n = t.replaceColor) !== null && n !== void 0 ? n : t.replace_color) ? qf : wi)(o)
        } catch {
...
class Kf {
    constructor() {
        this.count = 0, this.delay = new Yf, this.duration = new Zf
    }
    load(e) {
...
class Jf {
    ...
    init(e) {
        const t = this.container,
            ...
            s = n.life;
        !s || (e.life = {
            delay: t.retina.reduceFactor ? R(s.delay.value) * (s.delay.sync ? 1 : U()) / t.retina.reduceFactor * 1e3 : 0,
            delayTime: 0,
            duration: t.retina.reduceFactor ? R(s.duration.value) * (s.duration.sync ? 1 : U()) / t.retina.reduceFactor * 1e3 : 0,
            time: 0,
            count: s.count
    ...
    update(e, t) {
        ...
        let s = !1;
        if (e.spawning)
            if (n.delayTime += t.value, n.delayTime >= e.life.delay) s = !0, e.spawning = !1, n.delayTime = 0, n.time = 0;
            else return;
        if (n.duration === -1 || e.spawning || (s ? n.time = 0 : n.time += t.value, n.time < n.duration)) return;
        ...
        const o = this.container.canvas.size,
            r = H(0, o.width),
            a = H(0, o.width);
        e.position.x = se(r), e.position.y = se(a), e.spawning = !0, n.delayTime = 0, n.time = 0, e.reset();
        const l = e.options.life;
        l && (n.delay = R(l.delay.value) * 1e3, n.duration = R(l.duration.value) * 1e3)
    }
}
async function Qf(i) {
    await i.addParticleUpdater("life", e => new Jf(e))
}
class eh {
    draw(e, t, n) {
...
function nh(i, e) {
    ...
    if (!(i.destroyed || !i.opacity.enable || ((n = i.opacity.maxLoops) !== null && n !== void 0 ? n : 0) > 0 && ((s = i.opacity.loops) !== null && s !== void 0 ? s : 0) > ((o = i.opacity.maxLoops) !== null && o !== void 0 ? o : 0))) {
        switch (i.opacity.status) {
            case 0:
                i.opacity.value >= u ? (i.opacity.status = 1, i.opacity.loops || (i.opacity.loops = 0), i.opacity.loops++) : i.opacity.value += ((r = i.opacity.velocity) !== null && r !== void 0 ? r : 0) * e.factor;
                break;
            case 1:
                i.opacity.value <= l ? (i.opacity.status = 0, i.opacity.loops || (i.opacity.loops = 0), i.opacity.loops++) : i.opacity.value -= ((a = i.opacity.velocity) !== null && a !== void 0 ? a : 0) * e.factor;
                break
        }
        i.opacity.velocity && i.opacity.decay !== 1 && (i.opacity.velocity *= c), ih(i, i.opacity.value, l, u), i.destroyed || (i.opacity.value = Te(i.opacity.value, l, u))
    }
}
class sh {
    constructor(e) {
    ...
    init(e) {
        ...
        if (n.enable) {
            ...
            const s = t.value;
            switch (e.opacity.min = ft(s), e.opacity.max = Ie(s), n.startValue) {
                case "min":
                    e.opacity.value = e.opacity.min, e.opacity.status = 0;
                    break;
                case "random":
                    e.opacity.value = se(e.opacity), e.opacity.status = U() >= .5 ? 0 : 1;
                    break;
                case "max":
                default:
            ...
            e.opacity.velocity = R(n.speed) / 100 * this.container.retina.reduceFactor, n.sync || (e.opacity.velocity *= U())
        }
    }
    isEnabled(e) {
        var t, n, s, o;
        return !e.destroyed && !e.spawning && !!e.opacity && e.opacity.enable && (((t = e.opacity.maxLoops) !== null && t !== void 0 ? t : 0) <= 0 || ((n = e.opacity.maxLoops) !== null && n !== void 0 ? n : 0) > 0 && ((s = e.opacity.loops) !== null && s !== void 0 ? s : 0) < ((o = e.opacity.maxLoops) !== null && o !== void 0 ? o : 0))
    }
    reset(e) {
        e.opacity && (e.opacity.loops = 0)
    }
    update(e, t) {
        !this.isEnabled(e) || nh(e, t)
    }
}
async function oh(i) {
    await i.addParticleUpdater("opacity", e => new sh(e))
}
...
function rh(i) {
    ...
    let t = !1;
    if (i.direction === "right" && i.bounds.right >= i.canvasSize.width && e > 0 || i.direction === "left" && i.bounds.left <= 0 && e < 0) {
        const s = $e(i.particle.options.bounce.horizontal);
        i.particle.velocity.x *= -s, t = !0
    }
    if (!t) return;
    const n = i.offset.x + i.size;
    i.bounds.right >= i.canvasSize.width ? i.particle.position.x = i.canvasSize.width - n : i.bounds.left <= 0 && (i.particle.position.x = n), i.outMode === "split" && i.particle.destroy()
}
...
function ah(i) {
    ...
    let t = !1;
    if (i.direction === "bottom" && i.bounds.bottom >= i.canvasSize.height && e > 0 || i.direction === "top" && i.bounds.top <= 0 && e < 0) {
        const s = $e(i.particle.options.bounce.vertical);
        i.particle.velocity.y *= -s, t = !0
    }
    if (!t) return;
    const n = i.offset.y + i.size;
    i.bounds.bottom >= i.canvasSize.height ? i.particle.position.y = i.canvasSize.height - n : i.bounds.top <= 0 && (i.particle.position.y = n), i.outMode === "split" && i.particle.destroy()
}
class lh {
    constructor(e) {
    ...
    update(e, t, n, s) {
        ...
        for (const [, f] of o.plugins)
            if (f.particleBounce !== void 0 && (r = f.particleBounce(e, n, t)), r) break;
        if (r) return;
        const a = e.getPosition(),
            l = e.offset,
            u = e.getRadius(),
        ...
        switch (e.outType) {
            ...
            case "inside": {
                const {
                    dx: r,
                    dy: a
                } = de(e.position, e.moveCenter), {
                    x: l,
                    y: u
                } = e.velocity;
                if (l < 0 && r > e.moveCenter.radius || u < 0 && a > e.moveCenter.radius || l >= 0 && r < -e.moveCenter.radius || u >= 0 && a < -e.moveCenter.radius) return;
                break
            }
        }
...
class ch {
    ...
    update(e, t, n, s) {
        if (!this.modes.includes(s) || e.options.move.distance.horizontal && (t === "left" || t === "right") || e.options.move.distance.vertical && (t === "top" || t === "bottom")) return;
        ...
        if (o.enable) {
            const u = e.position;
            (!o.inverse && u.y > a.height + l && t === "bottom" || o.inverse && u.y < -l && t === "top") && r.particles.remove(e)
        } else {
        ...
        switch (e.outType) {
            case "inside": {
                const {
                    x: r,
                    y: a
                } = e.velocity, l = Z.origin;
                l.length = e.moveCenter.radius, l.angle = e.velocity.angle + Math.PI, l.addTo(Z.create(e.moveCenter));
                const {
                    dx: u,
                    dy: c
                } = de(e.position, l);
                if (r <= 0 && u >= 0 || a <= 0 && c >= 0 || r >= 0 && u <= 0 || a >= 0 && c <= 0) return;
                e.position.x = Math.floor(se({
                    min: 0,
                    max: o.canvas.size.width
                })), e.position.y = Math.floor(se({
                    min: 0,
            ...
            default: {
                ...
                switch (e.outType) {
                    case "outside": {
                        ...
                        })) + e.moveCenter.x, e.position.y = Math.floor(se({
                            min: -e.moveCenter.radius,
                            max: e.moveCenter.radius
                        })) + e.moveCenter.y;
                        const {
                    ...
                    case "normal": {
                        const r = e.options.move.warp,
                            ...
                            u = e.getRadius(),
                            c = gt(e.position, u);
                        t === "right" && c.left > a.width + e.offset.x ? (e.position.x = l.left, e.initialPosition.x = e.position.x, r || (e.position.y = U() * a.height, e.initialPosition.y = e.position.y)) : t === "left" && c.right < -e.offset.x && (e.position.x = l.right, e.initialPosition.x = e.position.x, r || (e.position.y = U() * a.height, e.initialPosition.y = e.position.y)), t === "bottom" && c.top > a.height + e.offset.y ? (r || (e.position.x = U() * a.width, e.initialPosition.x = e.position.x), e.position.y = l.top, e.initialPosition.y = e.position.y) : t === "top" && c.bottom < -e.offset.y && (r || (e.position.x = U() * a.width, e.initialPosition.x = e.position.x), e.position.y = l.bottom, e.initialPosition.y = e.position.y);
                        break
                    }
                }
                break
...
class fh {
    constructor(e) {
        this.container = e, this.updaters = [new lh(e), new uh(e), new dh(e), new ch(e)]
    }
    init() {}
    isEnabled(e) {
    ...
    update(e, t) {
        ...
        this.updateOutMode(e, t, (n = a.bottom) !== null && n !== void 0 ? n : a.default, "bottom"), this.updateOutMode(e, t, (s = a.left) !== null && s !== void 0 ? s : a.default, "left"), this.updateOutMode(e, t, (o = a.right) !== null && o !== void 0 ? o : a.default, "right"), this.updateOutMode(e, t, (r = a.top) !== null && r !== void 0 ? r : a.default, "top")
    }
...
async function hh(i) {
    await i.addParticleUpdater("outModes", e => new fh(e))
}
class ph {
    init() {}
    isEnabled(e) {
        return !Ze() && !e.destroyed && e.container.actualOptions.interactivity.events.onHover.parallax.enable
    }
    move(e) {
        const t = e.container,
            n = t.actualOptions;
        if (Ze() || !n.interactivity.events.onHover.parallax.enable) return;
        ...
        e.offset.x += (u.x - e.offset.x) / a, e.offset.y += (u.y - e.offset.y) / a
    }
}
async function vh(i) {
    i.addMover("parallax", () => new ph)
}
class mh extends _i {
    constructor(e) {
        super(e)
    ...
    async interact(e) {
        var t;
        const n = this.container,
            s = (t = e.retina.attractDistance) !== null && t !== void 0 ? t : n.retina.attractDistance,
            o = e.getPosition(),
            r = n.particles.quadTree.queryCircle(o, s);
        for (const a of r) {
            if (e === a || !a.options.move.attract.enable || a.destroyed || a.spawning) continue;
            const l = a.getPosition(),
                {
                    dx: u,
                    dy: c
                ...
                v = 1 / h;
            e.velocity.x -= f * h, e.velocity.y -= p * h, a.velocity.x += f * v, a.velocity.y += p * v
        }
    }
    isEnabled(e) {
...
async function gh(i) {
    await i.addInteractor("particlesAttract", e => new mh(e))
}

function sn(i, e, t, n, s, o) {
    const r = Te(i.options.collisions.absorb.speed * s.factor / 10, 0, n);
    i.size.value += r / 2, t.size.value -= r, n <= o && (t.size.value = 0, t.destroy())
}

function Ch(i, e, t, n) {
    const s = i.getRadius(),
        o = e.getRadius();
    s === void 0 && o !== void 0 ? i.destroy() : s !== void 0 && o === void 0 ? e.destroy() : s !== void 0 && o !== void 0 && (s >= o ? sn(i, s, e, o, t, n) : sn(e, o, i, s, t, n))
}
...
function yh(i, e) {
    !i.unbreakable && !e.unbreakable && cs(i, e), i.getRadius() === void 0 && e.getRadius() !== void 0 ? i.destroy() : i.getRadius() !== void 0 && e.getRadius() === void 0 ? e.destroy() : i.getRadius() !== void 0 && e.getRadius() !== void 0 && (i.getRadius() >= e.getRadius() ? i : e).destroy()
}
...
class _h extends _i {
    ...
    async interact(e, t) {
        ...
        for (const a of r) {
            ...
            const c = oe(s, l),
                d = o + u;
            c > d || bh(e, a, t, n.retina.pixelRatio)
        }
    }
    isEnabled(e) {
...
async function wh(i) {
    await i.addInteractor("particlesCollisions", e => new _h(e))
}
class Eh extends ve {
    constructor(e, t, n, s) {
        super(e, t, n), this.canvasSize = s, this.canvasSize = Object.assign({}, s)
    }
    contains(e) {
...
class xh {
    ...
    load(e) {
        !e || (e.blur !== void 0 && (this.blur = e.blur), this.color = ie.create(this.color, e.color), e.enable !== void 0 && (this.enable = e.enable))
    }
}
class Fh {
    constructor() {
    ...
    load(e) {
        !e || (e.color !== void 0 && (this.color = ie.create(this.color, e.color)), e.enable !== void 0 && (this.enable = e.enable), e.frequency !== void 0 && (this.frequency = e.frequency), e.opacity !== void 0 && (this.opacity = e.opacity))
    }
}
class Sh {
    constructor() {
        this.blink = !1, this.color = new ie, this.color.value = "#fff", this.consent = !1, this.distance = 100, this.enable = !1, this.frequency = 1, this.opacity = 1, this.shadow = new xh, this.triangles = new Fh, this.width = 1, this.warp = !1
    }
    load(e) {
...
class Bh extends _i {
    ...
    async interact(e) {
        ...
        const r = e.options.links,
            ...
            u = r.warp,
            c = u ? new Eh(n.x, n.y, l, o) : new ve(n.x, n.y, l),
            d = s.particles.quadTree.query(c);
        for (const f of d) {
            const p = f.options.links;
            if (e === f || !(p != null && p.enable) || r.id !== p.id || f.spawning || f.destroyed || !f.links || e.links.map(E => E.destination).indexOf(f) !== -1 || f.links.map(E => E.destination).indexOf(e) !== -1) continue;
            const h = f.getPosition();
            if (h.x < 0 || h.y < 0 || h.x > o.width || h.y > o.height) continue;
            const v = Th(n, h, l, o, u && p.warp);
            if (v > l) return;
            const y = (1 - v / l) * a;
    ...
    loadParticlesOptions(e, ...t) {
        var n, s;
        e.links || (e.links = new Sh);
        for (const o of t) e.links.load((s = (n = o == null ? void 0 : o.links) !== null && n !== void 0 ? n : o == null ? void 0 : o.lineLinked) !== null && s !== void 0 ? s : o == null ? void 0 : o.line_linked)
    }
    reset() {}
    setColor(e) {
        if (!e.options.links) return;
        const t = this.linkContainer,
            n = e.options.links;
        let s = n.id === void 0 ? t.particles.linksColor : t.particles.linksColors.get(n.id);
        if (s) return;
        const o = n.color;
        s = es(o, n.blink, n.consent), n.id === void 0 ? t.particles.linksColor = s : t.particles.linksColors.set(n.id, s)
    }
}
async function kh(i) {
    await i.addInteractor("particlesLinks", e => new Bh(e))
}

function Dh(i, e, t, n, s, o, r, a, l, u, c, d) {
    let f = !1;
    if (oe(t, n) <= s) ut(i, t, n), f = !0;
        ...
        if (y.distance <= s) {
            ...
            const E = {
                ...
                C = de(t, E);
            if (C.distance <= s) {
                const x = -(t.y - C.dy / C.dx * t.x) / (C.dy / C.dx);
                p = {
                    x,
                    y: 0
                }, h = {
    ...
    if (!!f) {
        if (i.lineWidth = e, a && (i.globalCompositeOperation = l), i.strokeStyle = ze(u, c), d.enable) {
            const p = xe(d.color);
            p && (i.shadowBlur = d.blur, i.shadowColor = ze(p))
        }
        i.stroke()
    }
}

function Ah(i, e, t, n, s, o, r, a) {
    Ud(i, e, t, n), s && (i.globalCompositeOperation = o), i.fillStyle = ze(r, a), i.fill()
}
...
function on(i, e) {
    const t = Mh(i.map(s => s.id));
    let n = e.get(t);
    return n === void 0 && (n = U(), e.set(t, n)), n
}
class Ph {
    constructor(e) {
        this.container = e, this._freqs = {
            links: new Map,
            triangles: new Map
        }
    }
    drawParticle(e, t) {
        ...
        const r = t.links.filter(a => o.links && this.getLinkFrequency(t, a.destination) <= o.links.frequency);
        for (const a of r) this.drawTriangles(s, o, t, a, r), a.opacity > 0 && ((n = t.retina.linksWidth) !== null && n !== void 0 ? n : 0) > 0 && this.drawLinkLine(t, a)
    }
    async init() {
    ...
    particleCreated(e) {
        ...
        e.retina.linksDistance = e.options.links.distance * t, e.retina.linksWidth = e.options.links.width * t
    }
    particleDestroyed(e) {
        e.links = []
    }
    drawLinkLine(e, t) {
        ...
        n.canvas.draw(u => {
            ...
            if (!e.options.links) return;
            let p;
            const h = (c = e.options.twinkle) === null || c === void 0 ? void 0 : c.lines;
            if (h != null && h.enable) {
                const E = h.frequency,
                    C = xe(h.color);
                U() < E && C && (p = C, l = R(h.opacity))
            }
            if (!p) {
                const E = e.options.links,
                    C = (E == null ? void 0 : E.id) !== void 0 ? n.particles.linksColors.get(E.id) : n.particles.linksColor;
                p = oi(e, o, C)
            }
            if (!p) return;
            const v = (d = e.retina.linksWidth) !== null && d !== void 0 ? d : 0,
                y = (f = e.retina.linksDistance) !== null && f !== void 0 ? f : 0;
            Dh(u, v, r, a, y, n.canvas.size, e.options.links.warp, s.backgroundMask.enable, s.backgroundMask.composite, p, l, e.options.links.shadow)
        })
    }
    drawLinkTriangle(e, t, n) {
        ...
        const o = this.container,
            ...
            c = (s = u.opacity) !== null && s !== void 0 ? s : (t.opacity + n.opacity) / 2;
        c <= 0 || o.canvas.draw(d => {
            var f;
            const p = e.getPosition(),
                ...
                v = l.getPosition(),
                y = (f = e.retina.linksDistance) !== null && f !== void 0 ? f : 0;
            if (oe(p, h) > y || oe(v, h) > y || oe(v, p) > y) return;
            let E = xe(u.color);
            if (!E) {
                const C = e.options.links,
                    b = (C == null ? void 0 : C.id) !== void 0 ? o.particles.linksColors.get(C.id) : o.particles.linksColor;
                E = oi(e, a, b)
            }!E || Ah(d, p, h, v, r.backgroundMask.enable, r.backgroundMask.composite, E, c)
        })
    }
    drawTriangles(e, t, n, s, o) {
        var r, a, l;
        const u = s.destination;
        if (!(((r = t.links) === null || r === void 0 ? void 0 : r.triangles.enable) && ((a = u.options.links) === null || a === void 0 ? void 0 : a.triangles.enable))) return;
        const c = (l = u.links) === null || l === void 0 ? void 0 : l.filter(d => {
            const f = this.getLinkFrequency(u, d.destination);
            return u.options.links && f <= u.options.links.frequency && o.findIndex(p => p.destination === d.destination) >= 0
        });
        if (!!(c != null && c.length))
            for (const d of c) {
                const f = d.destination;
                this.getTriangleFrequency(n, u, f) > t.links.triangles.frequency || this.drawLinkTriangle(n, s, d)
            }
    }
...
class ds {
    draw(e, t, n) {
        ...
        if (!!e) {
            ...
            for (let c = 0; c < r; c++) e.lineTo(o.length, 0), e.translate(o.length, 0), e.rotate(u)
        }
    }
    getSidesCount(e) {
        var t, n;
        const s = e.shapeData;
        return (n = (t = s == null ? void 0 : s.sides) !== null && t !== void 0 ? t : s == null ? void 0 : s.nb_sides) !== null && n !== void 0 ? n : 5
    }
}
class zh extends ds {
    getCenter(e, t) {
...
async function $h(i) {
    await i.addShape("polygon", new zh)
}
async function Nh(i) {
    await i.addShape("triangle", new Rh)
}
async function Hh(i) {
    await $h(i), await Nh(i)
}
...
function Uh(i, e) {
    ...
    if (!(i.destroyed || !i.size.enable || ((s = i.size.maxLoops) !== null && s !== void 0 ? s : 0) > 0 && ((o = i.size.loops) !== null && o !== void 0 ? o : 0) > ((r = i.size.maxLoops) !== null && r !== void 0 ? r : 0))) {
        switch (i.size.status) {
            case 0:
                i.size.value >= u ? (i.size.status = 1, i.size.loops || (i.size.loops = 0), i.size.loops++) : i.size.value += a;
                break;
            case 1:
                i.size.value <= l ? (i.size.status = 0, i.size.loops || (i.size.loops = 0), i.size.loops++) : i.size.value -= a
        }
        i.size.velocity && c !== 1 && (i.size.velocity *= c), Vh(i, i.size.value, l, u), i.destroyed || (i.size.value = Te(i.size.value, l, u))
    }
}
class jh {
    init(e) {
        ...
        const n = e.container,
            s = e.options.size,
            o = s.animation;
        o.enable && (e.size.velocity = ((t = e.retina.sizeAnimationSpeed) !== null && t !== void 0 ? t : n.retina.sizeAnimationSpeed) / 100 * n.retina.reduceFactor, o.sync || (e.size.velocity *= U()))
    }
    isEnabled(e) {
        var t, n, s, o;
        return !e.destroyed && !e.spawning && e.size.enable && (((t = e.size.maxLoops) !== null && t !== void 0 ? t : 0) <= 0 || ((n = e.size.maxLoops) !== null && n !== void 0 ? n : 0) > 0 && ((s = e.size.loops) !== null && s !== void 0 ? s : 0) < ((o = e.size.maxLoops) !== null && o !== void 0 ? o : 0))
    }
    reset(e) {
        e.size.loops = 0
    }
    update(e, t) {
        !this.isEnabled(e) || Uh(e, t)
    }
}
async function qh(i) {
    await i.addParticleUpdater("size", () => new jh)
}
...
class Xh {
    draw(e, t, n) {
        ...
        e.moveTo(0, 0 - n);
        for (let l = 0; l < r; l++) e.rotate(Math.PI / r), e.lineTo(0, 0 - n * a), e.rotate(Math.PI / r), e.lineTo(0, 0 - n)
    }
    getSidesCount(e) {
        var t, n;
        const s = e.shapeData;
...
function Zh(i, e) {
    ...
    const f = i.stroke.color.animation,
        p = (s = (n = i.strokeColor) === null || n === void 0 ? void 0 : n.h) !== null && s !== void 0 ? s : (o = i.color) === null || o === void 0 ? void 0 : o.h;
    p && ei(e, p, f.h, 360, !1);
    const h = (a = (r = i.strokeColor) === null || r === void 0 ? void 0 : r.s) !== null && a !== void 0 ? a : (l = i.color) === null || l === void 0 ? void 0 : l.s;
    h && ei(e, h, f.s, 100, !0);
    const v = (c = (u = i.strokeColor) === null || u === void 0 ? void 0 : u.l) !== null && c !== void 0 ? c : (d = i.color) === null || d === void 0 ? void 0 : d.l;
    v && ei(e, v, f.l, 100, !0)
}
class Kh {
    constructor(e) {
    ...
    init(e) {
        var t, n;
        const s = this.container;
        e.stroke = Ee(e.options.stroke, e.id, e.options.reduceDuplicates), e.strokeWidth = e.stroke.width * s.retina.pixelRatio;
        const o = (t = Ue(e.stroke.color)) !== null && t !== void 0 ? t : e.getFillColor();
        o && (e.strokeColor = ts(o, (n = e.stroke.color) === null || n === void 0 ? void 0 : n.animation, s.retina.reduceFactor))
    }
    isEnabled(e) {
        var t, n, s, o;
    ...
    update(e, t) {
        !this.isEnabled(e) || Zh(e, t)
    }
}
async function Jh(i) {
    await i.addParticleUpdater("strokeColor", e => new Kh(e))
}
...
class Qh {
    draw(e, t, n, s) {
        ...
        if (u === void 0) return;
        const c = t;
        c.text === void 0 && (c.text = Ee(u, t.randomIndexData));
        const d = c.text,
            f = (o = l.style) !== null && o !== void 0 ? o : "",
            p = (r = l.weight) !== null && r !== void 0 ? r : "400",
            h = Math.round(n) * 2,
            v = (a = l.font) !== null && a !== void 0 ? a : "Verdana",
            y = t.fill,
            E = d.length * n / 2;
        e.font = `${f} ${p} ${h}px "${v}"`;
        const C = {
        ...
        e.globalAlpha = s, y ? e.fillText(d, C.x, C.y) : e.strokeText(d, C.x, C.y), e.globalAlpha = 1
    }
    getSidesCount() {
        return 12
    }
...
async function t5(i) {
    await K2(i), await vh(i), await rf(i), await uf(i), await hf(i), await _f(i), await Tf(i), await kf(i), await Mf(i), await Lf(i), await $f(i), await Vf(i), await gh(i), await wh(i), await Ih(i), await Q2(i), await Xf(i), await th(i), await Hh(i), await Wh(i), await Yh(i), await e5(i), await Qf(i), await oh(i), await qh(i), await q2(i), await nf(i), await Jh(i), await hh(i), await N2(i)
}
class i5 {
    constructor() {
        this.enable = !1, this.speed = 0, this.decay = 0, this.sync = !1
...
class n5 extends Fe {
    constructor() {
        super(), this.animation = new i5, this.direction = "clockwise", this.enable = !1, this.value = 0
    }
    load(e) {
...
class o5 {
    ...
    getTransformValues(e) {
        var t;
        const n = ((t = e.tilt) === null || t === void 0 ? void 0 : t.enable) && e.tilt;
        return {
    ...
    init(e) {
        ...
        e.tilt = {
            ...
            sinDirection: U() >= .5 ? 1 : -1,
            cosDirection: U() >= .5 ? 1 : -1
        };
        let s = n.direction;
        switch (s === "random" && (s = Math.floor(U() * 2) > 0 ? "counter-clockwise" : "clockwise"), s) {
            case "counter-clockwise":
            case "counterClockwise":
                e.tilt.status = 1;
                break;
        ...
        const o = (t = e.options.tilt) === null || t === void 0 ? void 0 : t.animation;
        o != null && o.enable && (e.tilt.decay = 1 - R(o.decay), e.tilt.velocity = R(o.speed) / 360 * this.container.retina.reduceFactor, o.sync || (e.tilt.velocity *= U()))
    }
    isEnabled(e) {
        var t;
        const n = (t = e.options.tilt) === null || t === void 0 ? void 0 : t.animation;
        return !e.destroyed && !e.spawning && !!(n != null && n.enable)
    }
    loadOptions(e, ...t) {
        e.tilt || (e.tilt = new n5);
        for (const n of t) e.tilt.load(n == null ? void 0 : n.tilt)
    }
    update(e, t) {
        !this.isEnabled(e) || s5(e, t)
    }
}
async function r5(i) {
    await i.addParticleUpdater("tilt", e => new o5(e))
}
class rn {
    constructor() {
    ...
    load(e) {
        !e || (e.color !== void 0 && (this.color = ie.create(this.color, e.color)), e.enable !== void 0 && (this.enable = e.enable), e.frequency !== void 0 && (this.frequency = e.frequency), e.opacity !== void 0 && (this.opacity = H(e.opacity)))
    }
}
class a5 {
    constructor() {
...
class l5 {
    getColorStyles(e, t, n, s) {
        ...
        const a = r.particles,
            ...
            h = {},
            v = l && p;
        return h.fill = v ? p : void 0, h.stroke = v ? p : void 0, h
    }
    init() {}
    isEnabled(e) {
        const t = e.options,
    ...
    loadOptions(e, ...t) {
        e.twinkle || (e.twinkle = new a5);
        for (const n of t) e.twinkle.load(n == null ? void 0 : n.twinkle)
    }
    update() {}
}
async function u5(i) {
    await i.addParticleUpdater("twinkle", () => new l5)
}
class c5 {
    constructor() {
    ...
    load(e) {
        !e || (e.angle !== void 0 && (this.angle = H(e.angle)), e.move !== void 0 && (this.move = H(e.move)))
    }
}
class d5 {
    constructor() {
        this.distance = 5, this.enable = !1, this.speed = new c5
    }
    load(e) {
        if (!!e && (e.distance !== void 0 && (this.distance = H(e.distance)), e.enable !== void 0 && (this.enable = e.enable), e.speed !== void 0))
            if (typeof e.speed == "number") this.speed.load({
                angle: e.speed
            });
            else {
                const t = e.speed;
                t.min !== void 0 ? this.speed.load({
                    angle: t
...
function f5(i, e) {
    ...
    const s = i.wobble.angleSpeed * e.factor,
        ...
        r = o * (((t = i.retina.wobbleDistance) !== null && t !== void 0 ? t : 0) * e.factor) / (1e3 / 60),
        a = 2 * Math.PI;
    i.wobble.angle += s, i.wobble.angle > a && (i.wobble.angle -= a), i.position.x += r * Math.cos(i.wobble.angle), i.position.y += r * Math.abs(Math.sin(i.wobble.angle))
}
class h5 {
    constructor(e) {
        this.container = e
    ...
    init(e) {
        ...
        n != null && n.enable ? e.wobble = {
            ...
            angleSpeed: 0,
            moveSpeed: 0
        }, e.retina.wobbleDistance = R((t = n == null ? void 0 : n.distance) !== null && t !== void 0 ? t : 0) * this.container.retina.pixelRatio
    }
    isEnabled(e) {
        var t;
        return !e.destroyed && !e.spawning && !!(!((t = e.options.wobble) === null || t === void 0) && t.enable)
    }
    loadOptions(e, ...t) {
        e.wobble || (e.wobble = new d5);
...
async function p5(i) {
    await i.addParticleUpdater("wobble", e => new h5(e))
}
async function v5(i) {
    await t5(i), await E2(i), await $2(i), await r5(i), await u5(i), await p5(i), await L2(i), await m2(i), await M2(i)
}
const m5 = {
        particles: {
            number: {
    ...
    C5 = ae({
        ...
        async setup(i) {
            ...
            const s = kt(),
                o = h => {
                    h === 1 ? s.$patch(v => {
                        v.TwoParticlesLogo = !1
                    }) : s.$patch(v => {
                        v.TwoParticlesLogo = !0
                    }), h === 2 ? s.$patch(v => {
                        v.ThreeParticlesLogo = !1
                    }) : s.$patch(v => {
                        v.ThreeParticlesLogo = !0
                    }), h === 3 ? s.$patch(v => {
                        v.FourParticlesLogo = !1
                    }) : s.$patch(v => {
                        v.FourParticlesLogo = !0
                    })
                };
            let r = L(),
                a = q({
            ...
            const u = h => {
                ...
                c = h => {
                    r.value.NavList.forEach(v => {
                        v.actions = !1
                    }), r.value.NavList[h.activeIndex].actions = !0, l.SlideNum = h.activeIndex, localStorage.setItem("SlideNum", h.activeIndex), s.ParticlesOff = h.activeIndex, o(h.activeIndex)
                },
                d = [bn],
                f = m5;
            async function p(h) {
            ...
            return Be(() => {
                l.SlideNum = +localStorage.getItem("SlideNum"), setTimeout(() => {
                ...
                return P(), Re(m(Tn), {
                    ...
                    default: j(() => [N(y, {
                        ...
                        default: j(() => [m(n) ? (P(), Re(E, {
                            key: "1"
                        })) : X("", !0), fe(N(C, {
                            swiper: m(a).api,
                            PagintionNum: m(l).SlideNum,
                            ref_key: "navlist",
                            ref: r,
                            key: "2"
                        }, null, 8, ["swiper", "PagintionNum"]), [
                            [he, m(n)]
                        ])]),
                        _: 1
                    }), N(m(Qe), {
